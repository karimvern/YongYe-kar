...
import { xinxhuaijiuCharacter as character } from "./character.js";
...
export let info = {
	...
	characterSort: {
		'xinxhuaijiu': {
			...
			'xinxxianxia': ['xinxhj_guigu', 'xinxhjylyg_xuhuang', 'xinxhj_sxrm_lusu', 'xinxhj_sxrm_sunshangxiang', 'xinxhj_sxrm_jiahua'],
		}
	},
	...
	translate: {
		...
		xinxhjclanshixi: "拾昔",
		xinxhjclanshixi_info: "你可以将一种花色的所有牌置入弃牌堆，视为使用你本局游戏首次使用的此花色单目标普通锦囊牌。",
		xinxhjclanjianbai: "坚白",
		xinxhjclanjianbai_info: "锁定技，当你每回合首次使用一种类别的牌后，你选择一种花色的所有牌，然后重铸所有其余花色的牌；当前回合结束时，你可以交给一名角色一张牌，然后摸X张牌（X为此牌本回合被选择的次数）。",
		xinxhj_sxrm_jiahua: "改嗔贾华",
		xinxhj_sxrm_jiahua_prefix: "改嗔",
		xinxhjsxrmfubei: "伏备",
		xinxhjsxrmfubei_info: "出牌阶段限一次，你可以将手牌摸至体力上限，然后可将两张牌正面朝上置于牌堆顶前十张的任意位置（对其他角色可见）；每名角色回合结束时，若牌堆顶的牌正面朝上，你可以对其造成1点伤害。",
		xinxhjsxrmdancui: "殚瘁",
		xinxhjsxrmdancui_info: `${get.poptip("sxrm_qidingSkill")}。当你造成伤害时，你可以弃置两张牌（无牌则不弃，不足则全弃），令此伤害+1。`,
		xinxhj_sxrm_sunshangxiang: "改嗔孙尚香",
		xinxhj_sxrm_sunshangxiang_prefix: "改嗔",
		xinxhjsxrmjiaozong: "骄纵",
		xinxhjsxrmjiaozong_info: "准备阶段或当你成为【杀】的目标后，你可以移动场上一张牌（替换原装备），以此法区域被置入牌的其他角色本回合不能使用与之颜色相同的牌且受到的伤害+1。",
		xinxhjsxrmfusui: "妇随",
		...
		xinxhj_sxrm_lusu_prefix: "改嗔",
		xinxhjsxrmwanli: "万利",
		xinxhjsxrmwanli_info: "①首轮开始时，你可以交给一名其他角色任意张牌并摸两张牌，若如此做，第四轮结束时，其交给你三倍数量的牌（不足则全给并失去所有技能）。②摸牌阶段，若你因〖万利①〗选择的角色已还牌或死亡，你多摸三张牌。",
		xinxhjsxrmlishui: "理说",
		xinxhjsxrmlishui_info: `当你成为黑色牌的目标后，你可以摸一张牌并与一名未还牌的因〖万利①〗选择的角色拼点：若你赢，其提前一轮还牌，若〖万利①〗轮数小于当前轮数，其执行〖万利①〗的还牌效果。`,
		xinxhj_v_dongzhuo: "改威董卓",
		xinxhj_v_dongzhuo_prefix: "改",
		xinxhjguangyong: "犷勇",
		xinxhjguangyong_info: "锁定技。当你使用牌指定第一个目标后，若目标：包含你，你摸一张牌并增加1点体力上限；包含其他角色，你获得其中一名目标角色一张牌，然后若你已受伤，你减少1点体力上限（至多减至1）。",
		xinxhjjuchui: "据陲",
		xinxhjjuchui_info: "连招技（装备牌+锦囊牌）。你可以选择其中一个目标角色，若其体力上限不大于你，则你令其失去或回复1点体力；若其体力上限大于你，则你选择一个类别，从牌堆中获得一张此类别的牌，其本回合不能使用此类别的牌。",
		xinxhj_xukun: "改徐琨",
		xinxhj_xukun_prefix: "改",
		xinxhjfazhu: "筏铸",
		xinxhjfazhu_info: "准备阶段，你可以重铸你的区域内至多三张牌并摸等量张牌，然后将重铸的牌交给至多等量名角色各一张，这些角色可以依次视为使用一张无距离限制的【杀】。",
		xinxhj_pot_zhouyu: "改势周瑜",
		xinxhj_pot_zhouyu_prefix: "改势",
		xinxhjchiyun: "炽沄",
		xinxhjchiyun_info: "你每阶段首次获得牌后，可交给一名其他角色任意张手牌，其选择一项：1.其展示所有与这些牌颜色相同的手牌，你对其造成1点火焰伤害；2.你摸两张牌，其进入连环状态。",
		xinxhjyanhui: "焰洄",
		xinxhjyanhui_info: "你使用牌指定目标后，可展示一名目标角色的一张手牌，若此牌本回合已被展示过，你弃置之。此阶段结束时（不可叠加），你获得本回合因此弃置过的牌并选择一项：1.对一名本阶段因此被弃置过牌的角色造成1点火焰伤害；2，摸X张牌（X为本回合被展示过牌的角色数）。",
		xinxhjfentao: "焚涛",
		xinxhjfentao_info: "锁定技，有连环状态的其他角色受到火焰伤害时，其选择一项：1.此次传导中的伤害+1；2.其弃置一半牌（向上取整），此伤害结算后其进入连环状态。",
		xinxhjxiongzi: "雄姿",
		xinxhjxiongzi_info: `限定技，准备阶段，你可令${get.poptip("xinxhjchiyun")}、${get.poptip("xinxhjfentao")}的选项由你选择，并摸两张牌。`,
		xinxhj_dc_shen_caopi: "改新杀神曹丕",
		xinxhj_dc_shen_caopi_prefix: "改新杀|神",
		xinxhjyinzhi: "阴鸷",
		xinxhjyinzhi_info: "出牌阶段限一次，你可以选择一名其他角色并摸X张牌，该角色所有非锁定技失效直至其出牌阶段开始，且在此期间，其每次使用或打出手牌后你摸X张牌（X为本局游戏你对其发动〖阴鸷〗的次数且至多为3）。然后其回合内只能使用或打出本回合获得的牌，若其于回合内对你造成伤害，则此效果消失。",
		xinxhjkeming: "刻名",
		xinxhjkeming_info: "当你受到其他角色造成的伤害后，若其武将牌上有此时机触发的技能，则你可以触发此技能，若没有，则你可随机触发一个此时机的技能。当你对其他角色造成伤害后，该角色下次发动准备阶段、结束阶段或出牌阶段内发动的技能后，若该角色因此技能摸牌或使用了牌，你可以摸等量同名牌（至多为5）。",
		xinxhj_pot_xinxianying: "改势辛宪英",
		xinxhj_pot_xinxianying_prefix: "改势",
		xinxhjpotjiejie: "诫节",
		xinxhjpotjiejie_info: `每名角色的出牌阶段限一次，当前回合角色可以令你观看其手牌，然后你可以选择一种花色，若其手牌：1.包含此花色，其本回合使用此花色的牌无次数限制，然后弃置其余花色的手牌；2.不包含此花色，其获得此花色的一张牌。若其本轮以此法向你展示牌所包含的花色为唯一最多，你对其发动一次${get.poptip("xinxhjpotqingshi")}。`,
		xinxhjpotqingshi: "清识",
		xinxhjpotqingshi_info: "当你受到伤害后，你可选择一名角色，然后若你与其阵营：相同：你与其各摸一张牌；不同：你弃置其一张牌。",
		xinxhj_xurong: '改徐荣',
		xinxhj_xurong_prefix: '改',
		xinxhjxionghuo: '凶镬',
		...
		xinxhjsbqinqiang: "勤强",
		xinxhjsbqinqiang_info: "每回合每项限一次，你使用手牌时，可选择一项：1.令此牌伤害+X；2.摸X张牌。（X为你本回合此前与此牌连续使用同颜色的牌数+1）",
		xinxhjsbyizhen: "疑阵",
		xinxhjsbyizhen_info: "当你受到伤害后，你可以与伤害来源同时观看的对方手牌并弃置其中一张牌，若这两张牌颜色或类型相同，则你获得之。",
		xinxhj_caobuxing: "改曹不兴",
		xinxhj_caobuxing_prefix: "改",
		xinxhjmoying: "墨影",
		xinxhjmoying_info: "每回合限一次，当你于回合外不因使用而失去单一一张牌后，你可以选择一个花色和与此牌点数差绝对值不超过2的点数，然后获得牌堆中所有与此牌花色点数相同的牌。",
		xinxhjjuanhui: "绢绘",
		xinxhjjuanhui2: "绢绘",
		xinxhjjuanhui2_backup: "绢绘",
		xinxhjjuanhui_info: '结束阶段，你可以选择一名其他角色。记录该角色下回合的出牌阶段里使用的基本牌和普通锦囊牌（每种牌名限记一次），你的下回合出牌阶段，可将一张手牌当这些牌里的任意一张牌使用（每张限使用一次，且【杀】不计次数）。当"绢绘"的牌全部用完时，你回复1点体力并摸三张牌。',
		xinxhj_mazhong: "改马忠",
		...
		xinxhjzuyin: "祖荫",
		xinxhjzuyin_info: "锁定技，你成为其他角色使用【杀】或普通锦囊牌的目标后，若你有与此牌同名的“研作”牌，令此牌无效并弃置所有同名“研作”牌；否则令〖研作〗发动次数+1（至多为3），然后从牌堆或弃牌堆中将一张同名牌作为“研作”牌置于武将牌上。",
		xinxhjpijian: "辟剑",
		...
		xinxhjclananran: "岸然",
		xinxhjclananran_info: "准备阶段或当你受到伤害后，你可以选择一项：①摸X张牌；②令一名其他角色摸X张牌。以此法获得牌的角色本回合使用的下一张牌不能为这些牌。（X为此技能发动次数且至多为5）",
		xinxhjclangaobian: "告变",
		xinxhjclangaobian_info: "锁定技，其他角色的回合结束时，若本回合仅有一名角色受伤，则令其选择一项：①使用本回合进入弃牌堆的一张黑色【杀】；②失去1点体力。",
		xinxhj_sb_zhuran: "改谋朱然",
		xinxhj_sb_zhuran_prefix: "改谋",
		xinxhjsbzhenwei: "镇围",
		xinxhjsbzhenwei_info: "出牌阶段限一次，你可以选择一名其他角色，与其同时选择是否弃置任意张牌。然后你可以选择至多X项执行（X为你弃置牌对比其弃置牌不小于的条件数：1.牌数；2.花色数）：1.对其造成1点伤害；2.摸三张牌。",
		xinxhjsbheyuan: "合援",
		xinxhjsbheyuan_info: `结束阶段，你可以选择一名角色并弃置X张牌（X为你上次发动${get.poptip("xinxhjsbzhenwei")}时弃置的牌数），令其执行${get.poptip("xinxhjsbzhenwei")}最后执行的一项，且此后你对除其以外的角色发动${get.poptip("xinxhjsbzhenwei")}时，该角色可以同时弃置牌（这些牌在“镇围”比较条件时算作你弃置的牌）。`,
		xinxhj_clan_lujing: "改族陆景",
		xinxhj_clan_lujing_prefix: "改族",
		xinxhjclantanfeng: "探锋",
		xinxhjclantanfeng_info: "出牌阶段限一次，你可以视为对一名角色使用一张无视防具且不计次数的【杀】。若此【杀】造成伤害，你摸X张牌（X为你与其装备区牌数之和）；否则其可对你使用一张【杀】。",
		xinxhjclanjuewei: "绝围",
		xinxhjclanjuewei_info: "你不因本技能使用伤害牌指定目标后，或你成为伤害牌的目标后，你可选择一项：1.重铸一张牌，于此牌结算完成后视为对一名不为你的目标角色使用此牌；2.收回一张装备牌，令此牌无效。",
		xinxhj_star_sunshangxiang: "改星孙尚香",
		xinxhj_star_sunshangxiang_prefix: "改星",
		xinxhjsaying: "飒影",
		xinxhjsaying_info: "每回合每种牌名限一次，当你需要使用【杀】或【闪】时，你可以使用一张装备牌，视为使用之；你需要使用【桃】或【酒】时，你可以收回装备区里的一张牌，视为使用之。",
		xinxhjjiaohao: "骄豪",
		xinxhjjiaohao_info: "出牌阶段限一次，你可以从牌堆或弃牌堆中获得一张装备牌并拼点，然后你可令赢的角色获得拼点牌或令其视为使用一张【杀】。",
		xinxhjylyg_xuhuang: "改雁翎徐晃",
		xinxhjylyg_xuhuang_prefix: "改雁翎",
		xinxhjyl_duanliang: "断粮",
		xinxhjyl_duanliang_info: "你可以将一张黑色牌当无距离限制的【兵粮寸断】使用并摸一张牌。",
		xinxhjyl_zier: "辎饵",
		xinxhjyl_zier_info: "当一名角色跳过一个阶段后，你可以记录此阶段。每轮限一次，一名角色回合开始时，你可以将其本回合的一个阶段改为你记录过的阶段，然后清除对应记录阶段。",
		xinxhj_guigu: "改眭固",
		xinxhj_guigu_prefix: "改",
		xinxhj_tuntian: "屯犬",
		xinxhj_tuntian_info: `锁定技，准备阶段，你令你摸牌数、手牌上限+1直到你发动${get.poptip("xinxhj_qianjun")}。`,
		xinxhj_qianjun: "迁军",
		xinxhj_qianjun_info: `限定技，出牌阶段，你可以与一名其他角色交换座次，然后你回复1点体力并获得${get.poptip("sbluanji")}。`,
		xinxhj_xushao: "改许劭",
		...
		xinxhjjunxi: "峻袭",
		xinxhjjunxi_info: "出牌阶段开始时，你可选择一名其他角色并记录你的手牌数；此阶段结束时，该角色须弃置任意张牌并失去任意点体力（弃置牌数与体力值之和为X），若X大于0，你摸两张牌（X为你当前手牌数与记录值的差值）。",
		xinxhjjixian: "机先",
		xinxhjjixian_info: "若你回合的第一个出牌阶段没有使用基本和锦囊牌，则出牌阶段结束后你可以执行一个额外的出牌阶段，此阶段你不能使用装备牌。",
		xinxhj_clan_xunchen: "改族荀谌",
		xinxhj_clan_xunchen_prefix: "改族",
		xinxhjsankuang: "三恇",
		xinxhjsankuang_info: "当你每回合第一次使用一种类别的牌后，你可以令一名其他角色交给你至少X张牌，然后其于处理区内获得你使用的牌对应的所有实体牌（X为以下条件中其满足的项数：场上有牌、已受伤、体力值不大于手牌数）。",
		xinxhjbeishi: "卑势",
		xinxhjbeishi_info: `锁定技。当一名角色失去最后的手牌后，若你对其发动过${get.poptip("clansankuang")}，你回复1点体力或摸两张牌。`,
		xinxhj_sb_pangtong: "改新杀谋庞统",
		xinxhj_sb_pangtong_prefix: "改新杀谋",
		xinxhjsbyinmou: "寅谋",
		xinxhjsbyinmou_info: "转换技，①游戏开始时，你可以转换此技能状态；②回合结束时，若本回合有角色失去手牌数不小于其当前手牌数，你可观看牌堆顶三张牌并交给其中一名角色其中一张，此牌离开其手牌区时，阳：摸体力值张牌（至多摸五）；阴：其弃置体力值张手牌。",
		xinxhjsbyinmou_shadow: "<span style='text-shadow:rgba(0, 183, 255, 1) 0 0 2px, rgba(0, 183, 255, 1) 0 0 2px, rgba(0, 183, 255, 1) 0 0 2px, rgba(0, 183, 255, 1) 0 0 2px, black 0 0 1px'>寅谋</span>",
		xinxhjsbhongce: "宏策",
		xinxhjsbhongce_info: "①每轮开始时，你令一名角色选择一项执行：1.弃置半数手牌（向上取整）并获得等量张伤害牌，视为使用一张【杀】；2.重铸一张手牌，视为使用一张单目标普通锦囊牌；3.摸三张牌且这些牌不计入手牌上限。②出牌阶段限一次，你可令一名角色执行你〖宏策①〗最近选择的项。",
		xinxhj_dc_caoshuang: "改新杀谋曹爽",
		xinxhj_dc_caoshuang_prefix: "改新杀谋",
		xinxhjjianzhuan: "渐专",
		xinxhjjianzhuan_info: "锁定技。①当你使用牌时，你选择此阶段未执行过的一项执行：⒈令一名其他角色弃置X张牌；⒉摸X张牌；⒊重铸X张牌；⒋弃置X张牌（X为此技能于本阶段的发动次数）。②出牌阶段结束时，若你本阶段执行过〖渐专①〗的所有选项且〖渐专①〗剩余选项数大于1，则你随机移除〖渐专①〗的一项。",
		xinxhjjianzhuanre: "渐专·改",
		xinxhjjianzhuanre_info: "锁定技。①当你使用牌时，你选择此阶段未执行过的一项执行：⒈令一名其他角色弃置X张牌；⒉摸X张牌；⒊重铸X张牌；⒋弃置X张牌（X为此技能于本阶段的发动次数）。",
		xinxhjjianzhuan_faq: "渐专概率",
		xinxhjjianzhuan_faq_info: "<br>当系统随机选择要删除的选项时，“弃置X张牌”的选项概率固定为90%；剩余选项平分剩余的10%概率。<br>如第一次删除时，删除弃牌选项概率为90%，其余三个选项被删除的概率均为3.33%，若删除了非弃牌选项，第二次删除时，删除弃牌选项的概率依旧是90%，其余两个选项被删除的概率均为5%。",
		xinxhjfanshi: "返势",
		xinxhjfanshi_info: `觉醒技，结束阶段，若〖渐专①〗剩余选项数小于3，则你执行三次X视为1的剩余选项，然后增加2点体力上限并回复2点体力，修改${get.poptip("xinxhjjianzhuan")}并获得${get.poptip("xinxhjfudou")}。`,
		xinxhjfudou: "覆斗",
		xinxhjfudou_info: "当你使用黑色牌/红色牌指定唯一目标后，若该角色不为你，且其于本局游戏对你/未对你造成过伤害，则你可以与其各失去1点体力/各摸一张牌。",
		...
		xinxhjquanfeng_info: "每局每项各限一次。①其他角色进入濒死状态时，你可获得其武将牌上的所有非主公技，非隐匿技和非Charlotte技，加1点体力上限并回复1点体力。②当你处于濒死状态时，你可以回复1点体力。",
		...
		xinxhjgaigong: "概公",
		xinxhjgaigong_info: "你不因本技能对其他角色造成伤害/受到其他角色造成的伤害后，你可以展示你或其的至多三张手牌，然后交换这些牌与牌堆底等量张牌。若此交换流程中的牌包含至少三种花色，你可使用其中一张牌（无次数限制）。",
		xinxhj_wupu: "改吴普",
	...
	dynamicTranslate: {
		...
		xinxhjjianzhuan(player) {
			if (player.storage.xinxhjfanshi) {
				return lib.translate["xinxhjjianzhuanre_info"];
			}
			return lib.translate["xinxhjjianzhuan_info"];
		},
		xinxhjsbyinmou(player) {
			const bool = player.storage.xinxhjsbyinmou;
			...
			const start = `转换技，①游戏开始时，你可以转换此技能状态；②回合结束时，若本回合有角色失去手牌数不小于其当前手牌数，你可观看牌堆顶三张牌并交给其中一名角色其中一张，此牌离开其手牌区时，`,
				end = "。";
			return `${start}阳：${yang}；阴：${yin}${end}`;
		},
		xinxhjjunmou(player) {
		...
		xinxhjchiyun(player, skill) {
			let s3 = player.storage[skill + "3"],
				t1 = "1.其展示所有与这些牌颜色相同的手牌，你对其造成1点火焰伤害；",
				t3 = '其',
				t2 = "2.你摸两张牌，其进入连环状态";
			if (s3) {
				t3 = '你';
			}
			return `你每阶段首次获得牌后，可交给一名其他角色任意张手牌，${t3}选择一项：${t1}${t2}。`;
		},
		xinxhjfentao(player, skill) {
			let s3 = player.storage[skill + "3"],
				t1 = "1.此次传导中的伤害+1；",
				t3 = '其',
				t2 = "2.其弃置一半牌（向上取整），此伤害结算后其进入连环状态";
			if (s3) {
				t3 = '你';
			}
			return `锁定技，有连环状态的其他角色受到火焰伤害时，${t3}选择一项：${t1}${t2}。`;
		},
		xinxhjsxrmbiyi(player, skill) {
			const storage = player.storage[skill];
			const skills = player.getStorage("xinxhjsxrmbiyi_skill");
	...
	characterSubstitute: {//皮肤切换
		...
		xinxhj_pot_zhouyu: [["pot_zhouyu_shadow", ["tempname:pot_zhouyu_shadow"]]],
	},
	//武将姓名
	pinyins: {
	...
	skill: {
		...
		xinxhjpotheyun: {
			...
			filter(event, player) {
				...
				return skills.length && game.hasPlayer(current => get.info("xinxhjpotheyun").filterTarget(null, player, current));
			},
				...
				result: {
					player(player, target) {
						...
						return skills.some(skill => {
							if (player.additionalSkills?.xinxhjpotyinhui?.includes(skill)) return true;
		...
		xinxhjpotyinhui: {
			...
			async content(event, trigger, player) {
				...
				if (player.additionalSkills?.['xinxhjpotyinhui']?.length) {
					get.info("xinxhjpotyinhui").refreshSkill(player, player.additionalSkills['xinxhjpotyinhui']);
					await player.removeAdditionalSkills('xinxhjpotyinhui');
				}
				const skills = target
				...
				if (skills.length) {
					...
					const result =
						skills.length > 1
							? await player
								.chooseButton({
									createDialog: ["音洄：请获得至多两个技能", [list, "textbutton"]],
									selectButton: [1, 2],
									forced: true,
									ai(button) {
					...
					if (result?.bool && result.links?.length) {
						const skills = result.links;
						player.logSkill('potyinhui', null, null, null, [get.rand(3, 12)]);
						for (let skill of skills) {
							get.info("xinxhjpotyinhui").refreshSkill(player, skill);
							await player.addAdditionalSkills('xinxhjpotyinhui', skill, true);
						}
		...
		xinxhjclanshixi: {
			...
			onChooseToUse(event) {
				if (!game.online && !event.xinxhjclanshixi) {
					const player = event.player;
					const storage = player.getStorage("xinxhjclanshixi", {});
					const list = Object.entries(storage).filter(([suit, name]) => {
						...
						if (!lib.skill.xinxhjclanshixi.filterx(card) || !event.filterCard(card, player, event)) {
							return false;
						}
						return true;
					});
					event.set("xinxhjclanshixi", list);
				}
			},
			...
			enable: "chooseToUse",
			filter(event, player) {
				return event.xinxhjclanshixi?.length > 0;
			},
			filterx(card) {
			...
			chooseButton: {
				...
				filter(button, player) {
					...
					return evt.xinxhjclanshixi.some(([suit, name]) => suit === button.link);
				},
				check(button) {
					const player = get.player();
					const evt = get.event().getParent();
					const { xinxhjclanshixi } = evt;
					const name = xinxhjclanshixi.find(([suit, name]) => suit === button.link)[1];
				...
				backup(links, player) {
					return {
						...
						popname: true,
						viewAs: {
							name: player.storage.xinxhjclanshixi[links[0]],
							cards: [],
							isCard: true,
						},
						ignoreMod: true,
						...
						async precontent(event, trigger, player) {
							player.logSkill("xinxhjclanshixi");
				...
				prompt(links, player) {
					...
					const card = { name: player.storage.xinxhjclanshixi[suit] };
			...
			subSkill: {
				mark: {
					init(player, skill) {
						const history = player.getAllHistory("useCard", evt => get.suit(evt.card) !== "none" && lib.skill.xinxhjclanshixi.filterx(evt.card));
						if (history.length) {
							player.storage.xinxhjclanshixi ??= {};
							const storage = player.storage.xinxhjclanshixi;
							for (const evt of history) {
								...
								if (!(suit in storage)) {
									player.storage.xinxhjclanshixi[suit] = name;
								}
							}
							player.markSkill("xinxhjclanshixi");
						}
					},
					onremove(player, skill) {
						player.setStorage("xinxhjclanshixi", null, true);
					},
					audio: "xinxhjclanshixi",
					trigger: { player: "useCard1" },
					filter(event, player) {
						const card = event.card;
						if (!lib.skill.xinxhjclanshixi.filterx(card)) {
							return false;
						}
						const suit = get.suit(card);
						if (suit === "none") {
		...
		xinxhjclanjianbai: {
			...
			async content(event, trigger, player) {
				player.addTempSkill("xinxhjclanjianbai_effect");
				...
				for (const card of keepCards) {
					const skill = "xinxhjclanjianbai_effect";
				...
				mark: {
					...
					init(player, skill) {
						const types = player
							...
							.toUniqued();
						if (types.length) {
							player.markAuto("xinxhjclanjianbai", types);
						}
					},
					onremove(player, skill) {
						player.setStorage("xinxhjclanjianbai", null, true);
					},
					...
					filter(event, player) {
						...
						const type = get.type2(event.card);
						return !player.getStorage("xinxhjclanjianbai").includes(type);
					},
					forced: true,
					silent: true,
					async content(event, trigger, player) {
						if (trigger.name == "phase") {
							...
							player.markAuto("xinxhjclanjianbai", [type]);
						}
					},
				},
				effect: {
					audio: "xinxhjclanjianbai",
					charlotte: true,
					onremove(player, skill) {
						...
						if (player.hasCards("he") && player.hasCards("he") && game.hasPlayer(current => current != player)) {
							const result = await player
								.chooseCardTarget({
									...
									//forced: true,
									ai1(card) {
										let tag = card.gaintag?.find(tag => tag.startsWith("xinxhjclanjianbai_effect"));
										let count = 0;
										if (tag) {
											count = parseInt(tag.slice("xinxhjclanjianbai_effect".length)) || 0;
										}
			...
			subSkill: {
				damage: {
					...
					prompt2(event, player) {
						return `对${get.translation(event.player)}造成1点伤害？`;
					},
					async content(event, trigger, player) {
		...
		//嗔孙尚香
		xinxhjsxrmjiaozong: {
			audio: ["ext:永夜之境/audio/xinxnigong3.mp3", "ext:永夜之境/audio/xinxnigong4.mp3"],
			trigger: {
			...
			direct: true,
			async content(event, trigger, player) {
				let result = await player.moveCard(get.prompt2(event.name), "canReplace").set("logSkill", event.name).forResult();
				if (!result?.bool) {
					return;
				}
				...
				ban: {
					...
					mod: {
						cardEnabled(card, player) {
							if (player.getStorage("xinxhjsxrmjiaozong_ban").includes(get.color(card))) {
								return false;
							}
						},
		...
		xinxhjsxrmfusui: {
			...
			enable: "phaseUse",
			filter(event, player) {
				return game.hasPlayer(current => get.info("xinxhjsxrmfusui").filterTarget(null, player, current));
			},
			filterTarget(card, player, target) {
				const skills = target.getSkills(null, false, false).filter(skill => {
				...
				return target !== player && skills.length > 0;// && target.hasSex("male") 
			},
			async content(event, trigger, player) {
				const target = event.targets[0];
				...
				for (const current of [player, target]) {
					current.setStorage("xinxhjsxrmbiyi_skill", [skill], true);
					await current.changeSkills(["xinxhjsxrmbiyi"], []).set("$handle", (player, addSkills, removeSkills) => {
						if (addSkills.length) {
							player.addSkillLog(addSkills);
							// 单独处理因【妇随】失去的技能init，（不失去【比翼】情况再次【妇随】，如【中流】刷新，是不会二次触发init的，详见player.addSkill）
							if (addSkills.includes("xinxhjsxrmbiyi")) {
								lib.skill.xinxhjsxrmbiyi.init(player, "xinxhjsxrmbiyi");
							}
						}
					});
		...
		xinxhjsxrmbiyi: {
			audio: ["ext:永夜之境/audio/xinxnigong1.mp3", "ext:永夜之境/audio/xinxnigong2.mp3"],
			mark: true,
			marktext: "☯",
			init(player, skill) {
				player.removeAdditionalSkill(skill);
				const skills = !player.storage[skill] ? player.getStorage("xinxhjsxrmbiyi_skill") : ["xinxhjxiaoji"];
				if (skills.length) {
			...
			onremove(player, skill) {
				player.removeAdditionalSkill(skill);
				delete player.storage.xinxhjsxrmbiyi_skill;
			},
			...
			intro: {
				content(storage, player) {
					if (!storage) {
						...
						return `当前状态：阴（${get.poptip("xinxhjxiaoji")}）`;
					}
				},
			},
			...
			filter(event, player) {
				...
				const skills = !player.storage.xinxhjsxrmbiyi ? player.getStorage("xinxhjsxrmbiyi_skill") : ["xinxhjxiaoji"];
			...
			derivation: ["xinxhjxiaoji"],
			ai: { combo: "xinxhjsxrmfusui" },
		},
		xinxhjxiaoji: {
			audio: 'dcshuren_v_sunshangxiang_shadow',
			inherit: 'xiaoji',
		},
		//嗔鲁肃
		xinxhjsxrmwanli: {
			...
			subSkill: {
				effect: {
					...
					audio: "dcsbmingshi_dc_sb_lusu_shadow",
					trigger: { global: "roundEnd" },
					filter(event, player) {
						return get.info("xinxhjsxrmwanli_effect").logTarget(event, player).length > 0;
					},
					forced: true,
					logTarget(event, player) {
						return game
							.filterPlayer(current => {
								const storage = player.getStorage("xinxhjsxrmwanli_effect", new Map());
		...
		xinxhjsxrmlishui: {
			...
			async content(event, trigger, player) {
				...
				if (result?.winner == player) {
					const map = player.getStorage("xinxhjsxrmwanli_effect", new Map());
					if (!map.size) {
						return;
					}
					player.say("还钱！");
					map.get(target).roundNumber--;
					player.setStorage("xinxhjsxrmwanli_effect", map, true);
					game.log(target, "的“还钱”时间被提前一轮");

					const storage = player.getStorage("xinxhjsxrmwanli_effect", new Map());
					if (game.roundNumber > storage.get(target).roundNumber) {
						if (!target.isIn() || !storage.has(target)) {
							return;
						}
						game.log(target, "期限已到，提前还钱");
						player.say("拿来吧你！");
						const num = storage.get(target).giveNum;
						const map = player.getStorage("xinxhjsxrmwanli_effect", new Map());
						map.get(target).huanqian = true;
		...
		xinxhjjuchui: {
			...
			filter(event, player) {
				...
				return evt && get.type(evt.card) === "equip" && !evt.xinxhjjuchui;
			},
			async cost(event, trigger, player) {
				event.result = await player
			...
			async content(event, trigger, player) {
				...
				if (target.maxHp <= player.maxHp) {
					...
					target.addTempSkill("xinxhjjuchui_ban");
					target.markAuto("xinxhjjuchui_ban", [choice]);
				}
			},
			locked: false,
			mod: {
			...
			subSkill: {
				mark: {
					init(player, skill) {
						const evt = get.info("dcjianying").getLastUsed(player);
						if (evt && get.type(evt.card) === "equip" && !evt.xinxhjjuchui) {
					...
					firstDo: true,
					async content(event, trigger, player) {
						if (get.type(trigger.card) == "equip" && !trigger.xinxhjjuchui) {
				...
				ban: {
					...
					mod: {
						cardEnabled(card, player) {
							if (player.getStorage("xinxhjjuchui_ban").includes(get.type2(card))) {
								return false;
							}
						},
						cardSavable(card, player) {
		...
		xinxhjfazhu: {
			...
			filter(event, player) {
				return player.hasCard(card => player.canRecast(card), "hej");
			},
			async cost(event, trigger, player) {
				event.result = await player
					.choosePlayerCard(get.prompt2('xinxhjfazhu'), player, "hej", [1, 3], "allowChooseAll")
					.set("ai", button => {
			...
			async content(event, trigger, player) {
				...
				while (num - list.length > 0 && cards.some(i => get.owner(i) == player && get.position(i) == "h" && !i.hasGaintag("olsujian_given"))) {//get.owner(i) == player && get.position(i) == "h" &&
					const result = await player
						.chooseCardTarget({
		...
		xinxhjchiyun: {
			...
			logAudio2: {
				pot_zhouyu_shadow: (event, player) => "potchiyun_pot_zhouyu_shadow" + (player.storage.xinxhjchiyun3 ? get.rand(3, 4) : get.rand(1, 2)) + ".mp3",
			},
			trigger: {
				player: "gainAfter",
			...
			async cost(event, trigger, player) {
				event.result = await player
					.chooseCardTarget({
						...
						ai2(target) {
							const player = get.player();
							if (player.storage.xinxhjchiyun1 && game.hasPlayer(current => get.attitude(player, current) > 0 && player != current)) {
								return get.attitude(player, target);
							} else {
								return -get.attitude(player, target);
							}
			...
			async content(event, trigger, player) {
				...
				await player.give(cards, target);
				const list = [],
					choiceList = ["令" + get.translation(target) + "展示所有" + get.translation(colors) + "手牌并受到来自你的一点火焰伤害", "" + get.translation(player) + "摸两张牌，然后" + get.translation(target) + "进入连环状态"];
				...
				let target2 = player.storage[event.name + "3"] ? player : target;
				const result =
					list.length > 1
						? await target2
							.chooseControl(list)
				...
				if (typeof result?.control == "string") {
					if (result.control == "选项一") {
						...
						player.changeSkin({ characterName: "xinxhj_pot_zhouyu" }, "xinxhj_pot_zhouyu");
						await target.damage("fire");
					} else {
						player.changeSkin({ characterName: "xinxhj_pot_zhouyu" }, "pot_zhouyu_shadow");
						target.line(player);
		...
		xinxhjyanhui: {
			...
			logAudio: (player, indexedData) => "pot_yanhui" + (lib.skill.xinxhjyanhui.audioname.includes(player.skin.name) ? "_pot_zhouyu_shadow" : "") + (indexedData ? indexedData : get.rand(1, 2)) + ".mp3",
			popup: false,
			trigger: { player: "useCardToPlayered" },
			filter(event, player) {
			...
			async content(event, trigger, player) {
				...
				player.logSkill('potyanhui', [target], null, null, [player]);
				const result = await player
					.choosePlayerCard({
						forced: true,
						position: "h",
				...
				if (result?.bool && result.links?.length) {
					...
					if (shown.includes(cards[0])) {
						player.addTempSkill("xinxhjyanhui_add");
						player.markAuto('xinxhjyanhui_add', cards);
						await target.modedDiscard({ cards, discarder: player });
					}
				}
				if (!player.hasSkill(event.name + "_used")) {
					player.addTempSkill("xinxhjyanhui_used", "phaseAnyAfter");
					player.when({ global: "phaseAnyEnd" }).step(async (event, trigger, player) => {
						...
						const targets = game.filterPlayer(current => {
							return current.hasHistory("lose", evt => evt.type == "discard" && evt.getParent(2).name == "xinxhjyanhui" && evt.getParent(trigger.name) == event.getParent(trigger.name));
						});
						let cards2 = player.getStorage('xinxhjyanhui_add').filterInD("ejsxhcod");
						target.removeGaintag("xinxhjyanhui");
					...
					async content(event, trigger, player) {
						...
						if (trigger.name == "phase") {
							...
							game.broadcastAll(cards => {
								cards.forEach(card => card.addGaintag("xinxhjyanhui"));
							}, cards);
						} else {
							...
							if (cards.length) {
								target.addGaintag(cards, "xinxhjyanhui");
							}
						}
					},
				},
		...
		xinxhjfentao: {
			...
			logAudio2: {
				pot_zhouyu_shadow: (event, player) => "potfentao_pot_zhouyu_shadow" + (player.storage.xinxhjfentao3 ? get.rand(3, 4) : get.rand(1, 2)) + ".mp3",
			},
			...
			async content(event, trigger, player) {
				...
				if (target?.isIn()) {
					let target2 = player.storage[event.name + "3"] ? player : target;
					let list = [["ban", `令本次传导伤害+1`]];
					if (target.hasDiscardableCards(target, "he")) {
						target2 == player ? list.push(["discard", `令${get.translation(target)}弃置一半牌`]) : list.push(["discard", "弃置一半牌"]);
					}
					...
					if (result.bool && result.links?.length) {
						...
						await target
							.chooseToDiscard({
								forced,
								prompt: `${get.translation(player)}对你发动了焚涛：请选择弃置一半牌`,
								position: "he",
						...
						target
							...
							.step(async (event, trigger, player2) => {
								player.logSkill("xinxhjfentao", target, null, null, [event, player]);
		...
		xinxhjxiongzi: {
			...
			animationColor: "fire",
			filter(event, player) {
				return ["xinxhjchiyun", "xinxhjyanhui", "xinxhjfentao"].some(skill => player.hasSkill(skill, null, null, false));
			},
			async content(event, trigger, player) {
				//const { cost_data: link } = event;
				player.awakenSkill(event.name);
				player.changeSkin({ characterName: "xinxhj_pot_zhouyu" }, "pot_zhouyu_shadow");
				for (const skill of ["xinxhjchiyun", "xinxhjyanhui", "xinxhjfentao"]) {
					player.setStorage(skill + ("3"), true, true);
				}
		...
		xinxhjyinzhi: {
				...
				content(storage, player, skill) {
					...
					for (const id in storage) {
						...
						if (target) {
							...
							str += `${get.translation(target)}：${storage[id]}`;
						}
					}
					return str;
				},
			...
			async content(event, trigger, player) {
				...
				player.addTempSkill(`${name}_clear`, { player: "dieAfter" });
				...
				target.markAuto(`${name}_reset`, player);
			},
			ai: {
				order: 10,
				result: {
					target(player, target) {
						if (target.hasSkill("xinxhjyinzhi_debuff")) {
							return -1;
						}
						return -2;
					},
				...
				clear: {
					...
					onremove(player, skill) {
						game.filterPlayer2(() => true, void 0, true).forEach(target => {
							target.removeAdditionalSkill(`xinxhjyinzhi_debuff_${player.playerid}`);
							const storage = target.getStorage("xinxhjyinzhi_reset");
							if (storage.length == 1 && storage[0] == player) {
								target.removeSkill("xinxhjyinzhi_reset");
							}
						});
					},
					trigger: {
					...
					async content(event, trigger, player) {
						trigger.player.removeAdditionalSkill(`xinxhjyinzhi_debuff_${player.playerid}`);
					},
				},
				debuff: {
					charlotte: true,
					...
					getIndex(event, player) {
						return player
							.getStorage("xinxhjyinzhi_debuff")
							.filter(i => i.isIn())
							.sortBySeat();
					},
					filter(event, player, name, target) {
						return target.isIn() && target.getStorage("xinxhjyinzhi", {})[player.playerid] > 0;
					},
					forced: true,
					popup: false,
					async content(event, trigger, player) {
						const source = event.indexedData;
						source.logSkill("xinxhjyinzhi", player);
						await source.draw(source.getStorage("xinxhjyinzhi", {})[player.playerid]);
					},
				},
				reset: {
					charlotte: true,
					...
					intro: {
						content: "<li>回合内只能使用或打出本回合获得的牌<br>",
					},
					mod: {
						cardEnabled(card, player) {
							...
							if (cards.some(card => !card.hasGaintag("xinxhjyinzhi_reset"))) {
								return false;
							}
						},
					...
					filter(event, player) {
						...
						if (event.name != "damage") {
							return !event.gaintag.includes("xinxhjyinzhi_reset");
						}
						return player.getStorage("xinxhjyinzhi_reset").includes(event.player);
					},
					async content(event, trigger, player) {
						if (trigger.name == "phase") {
		...
		xinxhjkeming: {
			...
			filter(event, player, name) {
				return name == "damageEnd" ? event.source?.isIn() && event.source != player : event.player?.isIn() && event.player != player;
			},
			async cost(event, trigger, player) {
				...
				if (event.triggername == "damageSource") {
					...
					const checkTrigger = skill => {
						...
						for (const i of list) {
							...
							const triggers = [...toArray(info.trigger?.player), ...toArray(info.trigger?.global)];
					...
					if (!skills.length) {
						...
						const list = _status.characterlist.filter(name => get.character(name).skills.some(skill => checkTrigger(skill)));//get.characterSurname(name).some(j => j[0] == "曹") &&
						if (!list.length) {
							player.chat("无将可用");
							return;
						}
						skills = get
							.character(list.randomGet())
					...
					const next = game.createEvent(`${event.name}_check`, false, trigger);
					next.player = player;
					next.skills = skills;
					...
					next.setContent(async (event, trigger, player) => {
						...
						player.removeSkill("xinxhjkeming_check");
					});
				}
			},
			subSkill: {
				check: {
					...
					filter(event, player) {
						...
						const skill = get.sourceSkillFor(event);
						return player.getStorage("xinxhjkeming_check").includes(skill);
					},
					async content(event, trigger, player) {
				...
				effect: {
					...
					forced: true,
					filter(event, player) {
						if (["global", "equip"].includes(event.type) || !player.getStorage("xinxhjkeming_effect").includes(event.player)) {
							return false;
						}
						...
						for (const i of list) {
							const info = get.info(i);
							if (!info || (!info.trigger && !info.enable) || info.silent) {
								return false;
							}
							const toArray = arr => {
								return Array.isArray(arr) ? arr : !arr ? [] : [arr];
							};
							const triggers = [...toArray(info.trigger?.player), ...toArray(info.trigger?.global), ...toArray(info.enable)];
							if (triggers.some(i => ["phaseZhunbei", "phaseJieshu", "phaseUse", "chooseToUse"].some(j => i.startsWith(j)))) {
								...
								for (const evt of history) {
									...
									if (evt.name == "useCard") {
										if (evt == evtx) {
											return true;
										} else if (evt.getParent(evtx.name) == evtx) {
											return true;
										}
									}
									if (evt.name == "gain" && evt.getParent().name == "draw") {
										if (evt.getParent(evtx.name) == evtx) {
											return true;
										}
									}
									if (evt == evtx) {
					...
					async content(event, trigger, player) {
						...
						const evtx = trigger.log_event || trigger;
						const cards = [];
						const skill = get.sourceSkillFor(trigger);
						const history = _status.globalHistory[_status.globalHistory.length - 1]["everything"].slice().reverse();
						for (const evt of history) {
							...
							if (evt.name == "useCard") {
								if (evt == evtx || (game.findSkill(evt) == skill && evt.getParent(evtx.name) == evtx)) {
									cards.push(evt.card);
								}
							}
							if (evt.name == "gain" && evt.getParent().name == "draw") {
								if (game.findSkill(evt) == skill && evt.getParent(evtx.name) == evtx) {
									cards.push(...evt.cards);
								}
							}
							if (evt == evtx) {
								break;
			...
			subSkill: {
				global: {
					...
					filter(event, player) {
						...
						if (!player.countCards("h") || player.hasSkill("xinxhjpotjiejie_used")) {
							return false;
						}
						return game.hasPlayer(current => current.hasSkill("xinxhjpotjiejie"));
					},
					filterTarget(card, player, target) {
						return target.hasSkill("xinxhjpotjiejie");
					},
					selectTarget() {
						if (
							game.countPlayer(current => {
								return current.hasSkill("xinxhjpotjiejie");
							}) > 1
						) {
							return 1;
						}
					...
					prepare(cards, player, targets) {
						targets[0].logSkill("xinxhjpotjiejie", [player]);
					},
					log: false,
					manualConfirm: true,
					async content(event, trigger, player) {
						const target = event.target;
						player.addTempSkill("xinxhjpotjiejie_used", "phaseUseAfter");
						//await target.viewHandcards(player);
						game.addCardKnower(player.getCards("h"), target);
						player.getHistory("custom").push({
							xinxhjpotjiejie: true,
							suits: player
								.getCards("h")
						...
						if (result?.links?.length) {
							...
							if (player.hasCard(card => get.suit(card, player) == choice, "h")) {
								const skill = "xinxhjpotjiejie_effect";
						...
						/* if (target.countMark("xinxhjpotjiejie_blocker") >= 2) {
							return;
						} */
						let getSuits = current =>
							current
								.getRoundHistory("custom", evt => {
									return evt?.xinxhjpotjiejie && evt.target == target;
								})
						...
						if (!game.hasPlayer(current => current != player && getSuits(current).length >= num)) {
							target.addTempSkill("xinxhjpotjiejie_blocker", { global: "roundStart" });
							target.addMark("xinxhjpotjiejie_blocker", 1, false);
							await target.useSkill("xinxhjpotqingshi", [player]);
						}
					},
					ai: {
						order: 5,
				...
				effect: {
					...
					mod: {
						cardUsable(card, player) {
							const list = player.getStorage("xinxhjpotjiejie_effect");
							const suit = get.suit(card);
		...
		xinxhjxionghuo: {
			...
			filterTarget: lib.filter.notMe,
			prompt: '交给一名其他角色至多3枚“暴戾”标记',
			async content(event, trigger, player) {
				const target = event.target, str = `${get.translation(event.name)}：请选择交给${get.translation(target)}的“暴戾”标记数`;
				const markNum = player.countMark('xinfu_xionghuo');
				const options = ['1枚', '2枚', '3枚'].slice(0, Math.min(markNum, 3));
				const result = options.length > 1 ? await player.chooseControl(...options).set('prompt', str).forResult() : { index: 0 };
			...
			group: ['xinfu_xionghuo_init', 'xinxhjxionghuo_damage', 'xinxhjxionghuo_effect'],
			subSkill: {
				effect: {
					audio: 'xinfu_xionghuo',
					...
					async content(event, trigger, player) {
						...
						const result = await player
							.chooseButton(
								[
									`###凶镬###对${get.translation(target)}执行至多${num}项，并令其移去等量“暴戾”标记`,
									[
										[
											["damage", `令其受到1点火焰伤害且本回合不能使用【杀】`],
											["lose", "令其失去1点体力且本回合手牌上限-1"],
											["gain", "获得其区域内两张牌"],
										],
										"textbutton",
									],
							...
							.set("ai", button => {
								...
								switch (button.link) {
									...
									case "lose":
										return get.damageEffect(targetx, player, player);
									case "gain":
										return get.effect(target, { name: "shunshou" }, player, player) * 2;
								}
							})
							.forResult();
						if (result?.bool && result.links?.length) {
							const { links } = result;
							const num1 = links.length;
							target.removeMark('xinfu_xionghuo', num1);
							player.line(target, 'fire');
							for (const link of links) {
								switch (link) {
									case "gain": {
										if (target.countGainableCards(player, 'hej')) {
											await player.gainPlayerCard(target, 'hej', 2, true);
										}
										break;
									}
									case "damage": {
										await target.damage('fire');
										target.addTempSkill('xinxhjxionghuo_disable');
										target.markAuto('xinxhjxionghuo_disable', [player]);
										break;
									}
									case "lose": {
										await target.loseHp();
				...
				disable: {
					mod: {
						playerEnabled(card, player, target) {
							if (card.name == "sha") {//&& player.getStorage("xinfu_xionghuo_disable").includes(target)
								return false;
							}
						},
					},
		...
		xinxhjsbqinqiang: {
			locked: false,
			aiOrder(player, card, num) {
				if (typeof card !== "object" || player.getStorage("xinxhjsbqinqiang_used").length > 1) {
					return;
				}
			...
			filter(event, player) {
				...
				const num = get.info("xinxhjsbqinqiang").getNum(event, player);
				if (!num) {
					return false;
				}
				return player.getStorage("xinxhjsbqinqiang_used").length < 2;
			},
			async cost(event, trigger, player) {
				const num = get.info(event.skill).getNum(trigger, player);
				const choices = [];
				const choiceList = [`令${get.translation(trigger.card)}伤害+${num}`, `摸${get.cnNumber(num)}张牌`];
				if (get.is.damageCard(trigger.card) && !player.getStorage("xinxhjsbqinqiang_used").includes("选项一")) {
					choices.push("选项一");
				} else {
					choiceList[0] = '<span style="opacity:0.5">' + choiceList[0] + "</span>";
				}
				if (!player.getStorage("xinxhjsbqinqiang_used").includes("选项二")) {
					choices.push("选项二");
				} else {
					choiceList[1] = '<span style="opacity:0.5">' + choiceList[1] + "</span>";
				}
				...
				const result = await player
					.chooseControl({
						...
						choiceList,
						ai() {
							const { controls, numx, player } = get.event();
							const evt = get.event().getTrigger();
							if (!controls.includes("选项二")) {
								if (controls.includes("选项一") && evt.targets?.some(target => get.effect(target, evt.card, player, player) > 0)) {
									return "选项一";
								}
								return "cancel2";
							} else {
								if (!player.hasCards("h", card => get.color(card) == get.color(evt.card) && player.hasValueTarget(card, null, true))) {
									return "选项二";
								}
								return "cancel2";
							}
		...
		xinxhjsbyizhen: {
			...
			filter(event, player) {
				return event.source?.isIn() && event.source !== player && event.source.hasCards("h") && player.hasCards("h");
			},
			check(event, player) {
			...
			async content(event, trigger, player) {
				...
				const map = await game.chooseAnyOL(targets, get.info(event.name).discardPlayerCard, [targets]).forResult();
				const cards1 = [];
				const cards2 = [];
				...
				if (cards1.length > 0 && cards2.length > 0 && (get.color(cards1[0]) == get.color(cards2[0]) || get.type2(cards1[0]) == get.type2(cards2[0]))) {
					const cards = [...cards1, ...cards2].filterInD("d");
					if (cards.length) {
						await player.gain({
							cards,
							animate: "gain2",
			...
			discardPlayerCard(player, targets, eventId) {
				const target = targets[0] == player ? targets[1] : targets[0];
				return player
					.discardPlayerCard(`疑阵：观看${get.translation(target)}的手牌并弃置其中一张`, "h", "visible", true, target)
					.set("chooseonly", true)
					.set("ai", button => {
						const { player, target } = get.event();
		...
		xinxhjmoying: {
			...
			filter(event, player) {
				...
				return evt && evt.cards2 && evt.cards2.length == 1
					;//["equip", "trick",'basic'].includes(get.type2(evt.cards2[0], evt.type == "discard" && evt.hs.includes(evt.cards2[0]) ? player : false))
			},
			usable: 1,
			async cost(event, trigger, player) {
				...
				const result = await player
					.chooseButton([get.prompt2("xinxhjmoying"), `<div class="text center">花色</div>`, [suits.map(suit => [suit, get.translation(suit)]), "tdnodes"], `<div class="text center">点数</div>`, [numbers, "tdnodes"]], 2)
					.set("filterButton", button => {
		...
		xinxhjjuanhui: {
			...
			async cost(event, trigger, player) {
				event.result = await player
					.chooseTarget(get.prompt("xinxhjjuanhui"), lib.filter.notMe, "选择记录一名其他角色使用过的牌")
			...
			async content(event, trigger, player) {
				const [target] = event.targets;
				//player.storage.xinxhjjuanhui2 = target;
				player.setStorage('xinxhjjuanhui2', target);
				player.storage.xinxhjjuanhui3 = [];
				player.addSkill("xinxhjjuanhui2");
			},
		},
		xinxhjjuanhui2: {
			charlotte: true,
			...
			mod: {
				cardUsable(card) {
					if (card.name == "sha" && _status.event.skill == "xinxhjjuanhui2_backup") {
						return Infinity;
					}
				},
			},
			intro: {
				markcount(storage, player) {
					return player.getStorage("xinxhjjuanhui3").length;
				},
				mark(dialog, storage, player) {
					dialog.addText("记录目标");
					dialog.addSmall([storage]);
					var vcard = player.getStorage("xinxhjjuanhui3");
					if (vcard.length) {
						dialog.addText("记录卡牌");
			...
			onremove(player) {
				delete player.storage.xinxhjjuanhui2;
				delete player.storage.xinxhjjuanhui3;
			},
			group: "xinxhjjuanhui3",
			enable: "phaseUse",
			sourceSkill: "xinxhjjuanhui",
			filter(event, player) {
				return player.getStorage("xinxhjjuanhui3").length > 0 && player.countCards("hs") > 0;
			},
			chooseButton: {
				dialog(event, player) {
					return ui.create.dialog("绢绘", [player.getStorage("xinxhjjuanhui3"), "vcard"], "hidden");
				},
				filter(button, player) {
				...
				backup(links, player) {
					return {
						...
						precontent() {
							...
							var vcard = player.storage.xinxhjjuanhui3;
							...
							if (vcard.length) {
								player.markSkill("xinxhjjuanhui2");
							} else {
								player.unmarkSkill("xinxhjjuanhui2");
								event.getParent().xinxhjjuanhui = true;
							}
						},
					};
				},
			...
			ai: {
				order(item, player) {
					var muniu = player.getStorage("xinxhjjuanhui3");
					var order = 0;
		...
		xinxhjjuanhui3: {
			...
			filter(event, player, name) {
				if (event.name == "phaseUse") {
					...
					return event.getParent().xinxhjjuanhui;
				}
				return (
					event.player == player.storage.xinxhjjuanhui2 &&
					event.player.isPhaseUsing() &&
					["basic", "trick"].includes(get.type(event.card)) &&
					player.getStorage("xinxhjjuanhui3").filter(function (vcard) {
			...
			async content(event, trigger, player) {
				if (trigger.name == "phaseUse") {
					player.removeSkill("xinxhjjuanhui2");
					...
					player.storage.xinxhjjuanhui3.push(vcard);
					player.markSkill("xinxhjjuanhui2");
				}
			},
		},
		...
		xinxhjzuyin: {
			...
			async content(event, trigger, player) {
				...
				if (cards.some(card => card.name == trigger.card.name)) {
					...
					if (player.countMark("xinxhjyanzuo_add") < 3 && player.hasSkill("xinxhjyanzuo", null, null, false)) {
		...
		xinxhjclananran: {
			...
			async cost(event, trigger, player) {
				const count = Math.min(5, player.countMark("xinxhjclananran_used") + 1);
				const result = await player
					.chooseButton([
						...
						[
							[
								...
								["asyncDraw", `令一名其他角色摸${get.cnNumber(count)}张牌`],
							],
							"textbutton",
						],
					])
					.set("ai", button => {
						const player = get.player(),
							count = Math.min(4, player.countMark("xinxhjclananran_used") + 1);
						if (button.link === "draw") {
			...
			async content(event, trigger, player) {
				const tag = "xinxhjclananran_tag",
					mark = "xinxhjclananran_used";
				player.addSkill(mark);
				if (player.countMark(mark) < 5) {
				...
				if (cost_data == "draw") {
					...
					if (result.targets?.length) {
						...
						await game.delayx();*/
						result.targets[0].addTempSkill(tag, map);
						await result.targets[0].draw(count).set("gaintag", [tag]);
					}
				}
			},
			subSkill: {
				...
				tag: {
					...
					mod: {
						cardEnabled(card) {
							if ([card].concat(card.cards || []).some(c => get.itemtype(c) === "card" && c.hasGaintag("xinxhjclananran_tag"))) {
								return false;
							}
						},
						cardSavable(card) {
		...
		xinxhjclangaobian: {
			...
			async content(event, trigger, player) {
				...
				const discarded = _status.discarded.filter(c => c.name == "sha" && get.color(c) == 'black');
				...
				if (result.links[0] == "sha") {
					const result2 = await target
						.chooseCardButton("告变：请选择其中一张黑色【杀】使用", discarded, true)
						.set("filterButton", button => {
		...
		xinxhjsbheyuan: {
			...
			trigger: { player: "phaseJieshuBegin" },
			filter(event, player) {
				const storage = player.getStorage("xinxhjsbzhenwei_last", []);
				const num = storage[0] || 0;
				return player.countCards("he") >= num;//game.hasPlayer(target => target.isDamaged()&&!player.getStorage("xinxhjsbheyuan").includes(target) ) && 
			},
			async cost(event, trigger, player) {
				const storage = player.getStorage("xinxhjsbzhenwei_last", []);
				const map = get.info("xinxhjsbzhenwei").map;
				event.result = await player
					.chooseCardTarget({
						prompt: get.prompt2(event.skill) + `<br><span class=bluetext>上次弃牌数：${storage[0] || 0}<br>最后执行选项：${map[storage[1]]?.[0] || "无"}</span>`,
						filterTarget: (card, player, target) => {
							return true;//!player.getStorage("xinxhjsbheyuan").includes(target) && target.isDamaged()
						},
			...
			async content(event, trigger, player) {
				...
				const storage = player.getStorage("xinxhjsbzhenwei_last", []);
				await player.discard(cards);
				player.markAuto("xinxhjsbzhenwei", target);
				const map = get.info("xinxhjsbzhenwei").map;
				const choice = storage[1];
				if (choice) {
					...
					.step(async (event, trigger, player) => {
						if (player.getHistory("sourceDamage", evt => evt.card == trigger.card).length) {
							...
							/* const { bool } = await target
								.chooseBool("探锋", `是否对${get.translation(player)}使用一张【杀】？`)
							...
							await target
								.chooseToUse(
									...
									"探锋：是否对" + get.translation(player) + "使用一张杀？"
								)
								.set("targetRequired", true)
		...
		xinxhjclanjuewei: {
			...
			filter(event, player, name) {
				...
				return !event.card.storage?.xinxhjclanjuewei && player.countCards("he", card => {
					/* if (get.type(card, player) != "equip") {
						return false;
					} */
					return lib.filter.cardDiscardable(card, player, "xinxhjclanjuewei") || lib.filter.cardRecastable(card, player);
				});
			},
			//usable: 1,
			async cost(event, trigger, player) {
				const prompt1 = `重铸一张牌，于${get.translation(trigger.card)}结算完成后视为对一名不为你的角色使用此牌`,
					prompt2 = `收回一张装备牌，令${get.translation(trigger.card)}无效`;
				const result = await player
					.chooseButton([
					...
					.set("filterButton", button => {
						const player = get.player(),
							source = button.link == "Recast" ? null : "xinxhjclanjuewei";
					...
					.chooseCard(
						...
						card => {
							const { player, actType: type } = get.event(),
								source = type == "Recast" ? null : "xinxhjclanjuewei";//get.type(card, player) == "equip" &&
							return link == "Recast" ? lib.filter[type](card, player, source) : get.position(card) == 'e';
						},
						"hej"
					)
					.set("actType", type)
						...
						.step(async (event, trigger, player) => {
							...
							if (targets?.length) {
								let card = {
									...
									isCard: true,
									storage: { xinxhjclanjuewei: true },
								};
								await player.chooseUseTarget(card, false, true, targets, 1);
							}
						});
				} else {
		...
		xinxhjsaying: {
			...
			enable: "chooseToUse",
			hiddenCard(player, name) {
				if (player.getStorage("xinxhjsaying").includes(name)) {
					return false;
				}
			...
			filter(event, player) {
				...
				return false;
				/* return get.inpileVCardList(info => ['basic'].includes(get.type(info[2]))).some(card => {
					const name = info[2];
			...
			chooseButton: {
				...
				check(button) {
					...
					let card = { name: button.link[2], isCard: true };
					return player.getUseValue(card);
				},
				backup(links, player) {
					return {
						...
						async precontent(event, trigger, player) {
							...
							event.result.card = viewAs;
							event.result.cards = [];
							if (!player.storage.xinxhjsaying) {
								player.when('phaseAfter').step(async () => {
									delete player.storage.xinxhjsaying;
								});
							}
							player.markAuto("xinxhjsaying", viewAs.name);
						},
					};
				},
				prompt(links, player) {
					let str = ["sha", "shan"].includes(links[0][2]) ? "使用一张装备牌" : "获得装备区里的一张牌";
		...
		xinxhjjiaohao: {
			...
			usable: 1,
			filter(event, player) {
				return player.countCards("h") && game.hasPlayer(current => lib.skill.xinxhjjiaohao.filterTarget(null, player, current));
			},
			filterTarget(card, player, target) {
				return player.canCompare(target);
			},
			async content(event, trigger, player) {
				let card = get.cardPile(card => get.type(card, null, false) == "equip");
				if (card) {
					await player.gain(card, "gain2");
				}
				const target = event.target;
				...
				if (result.winner) {
					...
					const result2 = await player
						...
						.set("choiceList", ["令" + get.translation(result.winner) + "获得" + (cards.length ? get.translation(cards) : "空气"), "令" + get.translation(result.winner) + "视为使用一张【杀】"])
						.set("ai", function () {
							...
							(function () {
								...
								if (
									!game.hasPlayer(current => {
										...
										return result.winner.hasUseTarget(get.autoViewAs({ name: "sha", isCard: true }), void 0, false);
									}) ||
									!cards.length
								) {
									return "选项一";
					...
					switch (result2.control) {
						case "选项二": {
							/* const next = result.winner
								...
								.set("addCount", false);
							await next; */
							await result.winner.chooseUseTarget({
								card: get.autoViewAs({ name: "sha", isCard: true }),
								//nodistance: true,
								addCount: false,
								forced: true,
		...
		xinxhjyl_duanliang: {
			...
			subSkill: {
				draw: {
					...
					filter(event, player) {
						return event.skill == "xinxhjyl_duanliang";//&& event.targets[0].countCards("h") > player.countCards("h")
					},
					async content(event, trigger, player) {
						await player.draw();
					},
		...
		xinxhjyl_zier: {
			...
			round: 1,
			filter(event, player) {
				return event.phaseList?.length && player.getStorage("xinxhjyl_zier").length > 0;
			},
			async cost(event, trigger, player) {
				const target = trigger.player;
				const result = await player
			...
			async content(event, trigger, player) {
				...
				player.unmarkAuto("xinxhjyl_zier", cur[2]);
			...
			subSkill: {
				record: {
					...
					filter(event, player) {
						return !player.getStorage("xinxhjyl_zier").includes(event.name);
					},
					prompt2(event, player) {
						return `记录${get.translation(event.name)}`;
					},
					async content(event, trigger, player) {
						player.markAuto("xinxhjyl_zier", trigger.name);
						//player.addTempSkill("xinxhjyl_zier_clear", "roundStart");
						player.addSkill("xinxhjyl_zier_clear");
					},
				},
				clear: {
					charlotte: true,
					onremove(player, skill) {
						player.setStorage("xinxhjyl_zier", [], true);
					},
				},
			},
		},
		...
		xinxhj_tuntian: {
			...
			forced: true,
			async content(event, trigger, player) {
				player.addTempSkill("xinxhj_tuntian_temp", { player: "xinxhj_qianjunAfter" });
				player.addMark("xinxhj_tuntian_temp", 1, false);
			},
			subSkill: {
				temp: {
					charlotte: true,
					mod: {
						maxHandcard(player, num) {
							return num + player.countMark("xinxhj_tuntian_temp");
						},
					},
					trigger: {
		...
		xinxhj_qianjun: {
			...
			async content(event, trigger, player) {
				...
				await player.recover();
				await player.addSkills("sbluanji");
			},
			ai: {
				order: 13,
				result: {
		...
		xinxhjpingjian: {
			...
			init(player) {
				player.addSkill("xinxhjpingjian_check");
				if (!player.storage.xinxhjpingjian_check) {
			...
			async content(event, trigger, player) {
				...
				if (Object.keys(player.storage.xinxhjpingjian_check)?.length) {
					Object.keys(player.storage.xinxhjpingjian_check).forEach(skill => {
						...
						delete player.storage.xinxhjpingjian_check[skill];
					});
				}
				...
				const result = await player.chooseControl(skills)
					...
					.forResult();
				if (result.control) {
					player.markAuto("xinxhjpingjian", [result.control]);
					player.addTempSkill(result.control);
					player.storage.xinxhjpingjian_check[result.control] = trigger.name === "damage" ? trigger : trigger.name;
					const selectedName = event.list.find(name => lib.character[name][3].includes(result.control));
			...
			async content(event, trigger, player) {
				...
				const map = {};
				allList.randomSort();
				const currentTriggerName = event.triggername;
				//统一转化为数组比对
				const checkT = (t) => Array.isArray(t) ? t : (t ? [t] : []);
				...
				for (let i = 0; i < allList.length; i++) {
					...
					const skills2 = lib.character[name][3];
					for (let j = 0; j < skills2.length; j++) {
						const skillName = skills2[j];
						if (player.hasSkill(skillName, null, null, false)) continue;

						const list2 = [skillName];
						game.expandSkills(list2);
						for (let k = 0; k < list2.length; k++) {
							const innerSkill = list2[k];
							...
							if (checkT(info.trigger.global).includes(currentTriggerName)) matchTrigger = true;
							...
							if (matchTrigger) {
								...
								if (info.filter) {
									try {
										if (!info.filter(trigger, player, currentTriggerName)) continue;
									} catch (e) {
										continue;
									}
								}
				...
				const result = await player.chooseControl(skills)
					...
					.forResult();
				if (result.control) {
					const chosenSkill = result.control;
					...
					next.setContent(async (event, trigger, player) => {
						...
						if (names && names.length > 0) {
							get.nameList(player).forEach(name => {
								const { tempname } = get.character(name);
								if (tempname && Array.isArray(tempname)) names.removeArray(tempname);
							});
							game.broadcastAll((player, names) => player.tempname.removeArray(names), player, names);
						}
					});
			...
			subSkill: {
				/* check: {
					...
					filter(event, player) {
						...
						const skill = get.sourceSkillFor(event);
						return player.getStorage("xinxhjpingjian_check").includes(skill);
					},
					async content(event, trigger, player) {
						const skill = get.sourceSkillFor(trigger);
						
						player.removeSkill(skill);
						player.unmarkAuto("xinxhjpingjian_check", [skill]);
						...
						if (!player.getStorage("xinxhjpingjian_check").length) {
							player.removeSkill("xinxhjpingjian_check");
						}
					},
					sub: true,
					forced: true,
				...
				/* use: {
					...
					enable: "phaseUse",
					usable: 1,
					sourceSkill: "xinxhjpingjian",
					prompt: () => lib.translate.xinxhjpingjian_info,
					async content(event, trigger, player) {
						if (!_status.characterlist) {
							game.initCharacterList();
						}
						...
						const evt = event.getParent("phaseUse") || event.getParent(2);
						allList.randomSort();
						...
						for (let i = 0; i < allList.length; i++) {
							...
							for (let j = 0; j < skills2.length; j++) {
								const skillName = skills2[j];
								if (player.hasSkill(skillName, null, null, false)) continue;
								if (get.is.locked(skillName, player)) continue;
		
								const infoText = get.plainText(lib.translate[skillName + "_info"] || "");
								if (skills.includes(skillName) || (infoText.includes("当你于出牌阶段") && !infoText.includes("当你于出牌阶段外"))) {
									list.add(name);
									map[name] = map[name] || [];
									map[name].push(skillName);
								...
								for (let k = 0; k < list2.length; k++) {
									const innerSkill = list2[k];
									const info = lib.skill[innerSkill];
									...
									const enables = Array.isArray(info.enable) ? info.enable : [info.enable];
									if (enables.includes("phaseUse") || enables.includes("chooseToUse")) {
										if (info.ai && (info.ai.combo || info.ai.notemp || info.ai.neg)) continue;
										if (info.init || info.onChooseToUse) continue;
		
										if (info.filter) {
											try {
												if (!info.filter(evt, player)) continue;
											} catch (e) {
												continue;
											}
						...
						if (result.control) {
							const chosenSkill = result.control;
							player.addTempSkills(chosenSkill,'phaseUseAfter');
							//player.addTempSkill("xinxhjpingjian_check");
							//player.markAuto("xinxhjpingjian_check", [chosenSkill]);
							const selectedName = event.list.find(name => lib.character[name][3].includes(chosenSkill));
							if (selectedName) {
			...
			async content(event, trigger, player) {
				...
				for (let i = 0; i < allList.length; i++) {
					...
					for (let j = 0; j < skills2.length; j++) {
						...
						const infoText = get.plainText(lib.translate[skills2[j] + "_info"] || "");
						if (skills.includes(skills2[j]) || (infoText.includes("当你于出牌阶段") && !infoText.includes("当你于出牌阶段外"))) {
							list.add(name);
							map[name] ??= [];
							map[name].push(skills2[j]);
							skills.add(skills2[j]);
				...
				if (result.control) {
					player.markAuto("xinxhjpingjian", [result.control]);
					player.addTempSkill(result.control);
					player.storage.xinxhjpingjian_check[result.control] = "phaseUse";
					const selectedName = event.list.find(name => lib.character[name][3].includes(result.control));
					if (selectedName) {
						game.broadcastAll((player, name) => player.tempname.add(name), player, selectedName);
					}
		...
		xinxhjpingjian_check: {
			...
			filter(event, player) {
				...
				const skill = get.sourceSkillFor(event);
				return player.storage.xinxhjpingjian_check[skill];
			},
			direct: true,
			firstDo: true,
			priority: Infinity,
			...
			group: "xinxhjpingjian_check2",
		},
		xinxhjpingjian_check2: {
			charlotte: true,
			trigger: {
				player: ["phaseZhunbeiEnd", "phaseUseEnd", "damageEnd", "phaseJieshuBegin", 'phaseEnd', 'phaseBegin']
			},
			sourceSkill: "xinxhjpingjian",
			filter(event, player) {
				return Object.keys(player.storage.xinxhjpingjian_check).find(function (skill) {
					if (event.name != "damage") {
						return player.storage.xinxhjpingjian_check[skill] == event.name;
					}
					return player.storage.xinxhjpingjian_check[skill] == event;
				});
			},
			direct: true,
			lastDo: true,
			priority: -Infinity,
			async content(event, trigger, player) {
				const skills = Object.keys(player.storage.xinxhjpingjian_check).filter(function (skill) {
					if (trigger.name != "damage") {
						return player.storage.xinxhjpingjian_check[skill] == trigger.name;
					}
					return player.storage.xinxhjpingjian_check[skill] == trigger;
				});
		...
		xinxhjjunxi: {
			...
			getIndex(event, player, name) {
				if (name == "phaseUseEnd") {
					return player.getStorage("xinxhjjunxi");
				}
				return 1;
			},
			async cost(event, trigger, player) {
			...
			async content(event, trigger, player) {
				...
				if (event.triggername == "phaseUseBegin") {
					player.markAuto('xinxhjjunxi', [[target, num]]);
					return;
				}
				const list = player.getStorage('xinxhjjunxi'),
					index = list.findIndex(info => info[0] == target);
				if (index < 0) {
					return;
				}
				const num2 = list.splice(index, 1)[0][1];
				player.setStorage('xinxhjjunxi', list, true);
			...
			async content(event, trigger, player) {
				...
				if (evt) {
					...
					player
						...
						.step(async (event, trigger, player) => {
							player.addTempSkill(`xinxhjjixian_limit`, "phaseChange");
						});
				}
			},
			subSkill: {
		...
		xinxhjsankuang: {
			...
			filter(event, player) {
				...
				const type = get.type2(event.card);
				return player.getHistory("useCard", evt => get.type2(evt.card) == type).indexOf(event) == 0;//getRoundHistory
			},
			getNum(player) {
			...
			async cost(event, trigger, player) {
				...
				event.result = await player
					.chooseTarget("三恇：选择一名其他角色", "令其交给你至少X张牌" + (cards.length ? "，然后其获得" + get.translation(cards) : "") + "（X为以下条件中其满足的项数：场上有牌、已受伤、体力值小于手牌数）", lib.filter.notMe)
					.set("ai", target => {
						const { player, goon } = get.event();
						const att = get.attitude(player, target),
							num = lib.skill.xinxhjsankuang.getNum(target);
						if (num == 0) {
							return att;
						}
						if (goon) {
						...
						return -Math.sqrt(Math.abs(att)) - lib.skill.xinxhjsankuang.getNum(target);
					})
					.set(
						"goon",
						Math.max.apply(
						...
						) <= 5 || trigger.cards.filterInD("o").length == 0
					)
					.forResult();
			},
			async content(event, trigger, player) {
				...
				const num = lib.skill.xinxhjsankuang.getNum(target),
		...
		xinxhjbeishi: {
			init(player, skill) {
				...
				player.addSkill(skill + "_mark");
				const history = player.getAllHistory("useSkill", evt => evt.skill == "xinxhjsankuang");
				if (history.length) {
			...
			filter(event, player) {
				...
				return game.hasPlayer((current) => {
					...
					if (!player.getStorage('xinxhjbeishi').includes(current)) {
						return false;
					}
			...
			derivation: "xinxhjsankuang",
			ai: { combo: "xinxhjsankuang" },
			intro: {
				mark(dialog, storage, player) {
					dialog.addText(`每当${storage.map(key => get.translation(key.name)).join("、")}失去最后的手牌，你回复1点体力或摸两张牌`);
			...
			subSkill: {
				mark: {
					...
					filter(event, player) {
						...
						return event.skill == "xinxhjsankuang";
					},
					async content(event, trigger, player) {
						player.markAuto("xinxhjbeishi", trigger.targets);
					},
				},
			},
		},
		...
		xinxhjsbyinmou: {
			...
			filter(event, player) {
				return get.info("xinxhjsbyinmou").getTargets().length > 0;
			},
			getTargets() {
			...
			prompt2(event, player) {
				const targets = get.info("xinxhjsbyinmou").getTargets();
				return `${get.skillInfoTranslation("xinxhjsbyinmou", player, false)}<br><span class=bluetext>可选目标：${get.translation(targets)}</span>`;
			},
			check(event, player) {
				const targets = get.info("xinxhjsbyinmou").getTargets();
				let sgn = 1;
				if (player.getStorage("xinxhjsbyinmou", false)) {
					sgn = -1;
				}
			...
			subSkill: {
				effect: {
					...
					filter(event, player, name, card) {
						...
						if (Array.isArray(gaintag)) {
							if (gaintag.includes("xinxhjsbyinmou")) {
								return player.getHp() > 0;
							}
							if (gaintag.includes("xinxhjsbyinmou_shadow")) {
				...
				change: {
					...
					prompt2(event, player) {
						return "切换【寅谋】为状态" + (player.storage.xinxhjsbyinmou ? "阳" : "阴");
					},
					check: () => Math.random() > 0.5,
					async content(event, trigger, player) {
						player.changeZhuanhuanji("xinxhjsbyinmou");
					},
				},
			},
		},
		xinxhjsbhongce: {
			...
			onChooseToUse(event) {
				...
				const evts = event.player.getAllHistory("custom", evt => evt.skill == "xinxhjsbhongce");
			...
			filter(event, player) {
				...
				return !player.hasSkill("xinxhjsbhongce_used") && event.hongceEvts?.length;
			},
			filterTarget(card, player, target) {
			...
			prompt(event, player) {
				...
				if (event.name == "phase") {
					return get.prompt("xinxhjsbhongce", null, player);
				}
				//const link = event.hongceEvts?.[0]?.link;
				const link = event.hongceEvts?.at(-1)?.link;
				switch (link) {
					case "sha": {
			...
			logAudio(event, player) {
				if (event.name == "phase") {
					...
					const evts = player.getAllHistory("custom", evt => evt.skill == "xinxhjsbhongce");
					if (evts.length) {
						//const link = evts[0].link;
						const link = evts.at(-1).link;
						switch (link) {
							case "sha":
								return player.storage.xinxhjsbyinmou ? "dcsbhongce_dc_sb_pangtong_shadow3.mp3" : "dcsbhongce3.mp3";
							case "recast":
								return player.storage.xinxhjsbyinmou ? "dcsbhongce_dc_sb_pangtong_shadow4.mp3" : "dcsbhongce4.mp3";
							default:
								return player.storage.xinxhjsbyinmou ? "dcsbhongce_dc_sb_pangtong_shadow5.mp3" : "dcsbhongce5.mp3";
						}
					}
				}
			},
			async content(event, trigger, player) {
				...
				if (trigger?.name == "phase") {
					...
					player.addTempSkill("xinxhjsbhongce_used", { global: "phaseAnyAfter" });
					const evts = player.getAllHistory("custom", evt => evt.skill == event.name);
					if (evts.length) {
						//link = evts[0].link;
						link = evts[evts.length - 1].link;
					}
				}
				if (!link) {
					return;
				...
				switch (link) {
					...
					default: {
						target.addSkill("xinxhjsbhongce_limit");
						const next = target.draw(3);
						next.gaintag.add("xinxhjsbhongce");
						await next;
						break;
					}
				}
			...
			subSkill: {
				...
				limit: {
					charlotte: true,
					onremove(player, skill) {
						player.removeGaintag("xinxhjsbhongce");
					},
					mod: {
						ignoredHandcard(card, player) {
							if (card.hasGaintag("xinxhjsbhongce")) {
								return true;
							}
						},
						cardDiscardable(card, player, name) {
							if (name == "phaseDiscard" && card.hasGaintag("xinxhjsbhongce")) {
								return false;
							}
						},
					},
		...
		xinxhjjianzhuan: {
			...
			filter(event, player) {
				...
				return (
					player.getHistory("useSkill", evt => {
						return evt.skill == "xinxhjjianzhuan";//&& evt.event.getParent("phaseUse") == evtx
					}).length <
					4 - player.getStorage("xinxhjjianzhuan").length
				);
			},
			forced: true,
			derivation: "xinxhjjianzhuan_faq",
			async content(event, trigger, player) {
				const evtx = event.getParent("phaseUse"),
					num = player.getHistory("useSkill", evt => {
						return evt.skill == "xinxhjjianzhuan";//&& evt.event.getParent("phaseUse") == evtx
					}).length,
					info = get.info("xinxhjjianzhuan").choices;
				let choices = [],
					choiceList = [],
					map = {};
				for (const i in info) {
					map[info[i].intro] = i;
					if (player.getStorage("xinxhjjianzhuan").includes(i) || player.getStorage("xinxhjjianzhuan_used").includes(i)) {
						continue;
					}
				...
				const { control } = await player
					...
					.forResult();
				if (control) {
					if (!player.storage.xinxhjjianzhuan_used) {
						player.when({ global: "phaseChange" }).step(async () => delete player.storage.xinxhjjianzhuan_used);
					}
					player.markAuto("xinxhjjianzhuan_used", [map[control]]);
			...
			group: "xinxhjjianzhuan_remove",
			subSkill: {
				remove: {
					audio: "dcjianzhuan",
					trigger: { player: "phaseUseEnd" },
					filter(event, player) {
						if (player.getStorage("xinxhjjianzhuan").length >= 3) {
							return false;
						}
						return player.getStorage("xinxhjjianzhuan_used").length >= 4 - player.getStorage("xinxhjjianzhuan").length;
					},
					forced: true,
					async content(event, trigger, player) {
						const info = get.info("xinxhjjianzhuan").choices;
						let map = {};
						...
						for (const i in info) {
							const infox = info[i];
							map[infox.intro] = i;
							if (player.getStorage("xinxhjjianzhuan").includes(i)) {
								continue;
							}
						...
						player.markAuto("xinxhjjianzhuan", [map[removeChoice]]);
		...
		xinxhjfanshi: {
			...
			trigger: { player: "phaseJieshuBegin" },
			filter(event, player) {
				return 4 - player.getStorage("xinxhjjianzhuan").length < 3;
			},
			forced: true,
			juexingji: true,
			skillAnimation: true,
			...
			async content(event, trigger, player) {
				...
				//await player.changeSkills(["xinxhjfudou"], ["xinxhjjianzhuan"]);
				player.unmarkSkill("xinxhjjianzhuan");
				delete player.storage.xinxhjjianzhuan;
				player.removeSkill("xinxhjjianzhuan_remove");
				await player.addSkills("xinxhjfudou");
			},
			derivation: ["xinxhjfudou", 'xinxhjjianzhuanre'],
			ai: { combo: "xinxhjjianzhuan" },
		},
		xinxhjfudou: {
			audio: 'dcfudou',
			trigger: { player: "useCardToPlayered" },
		...
		xinxhjgaigong: {
			...
			filter(event, player) {
				...
				if (event.getParent(4).name === 'xinxhjgaigong') return false;
				return [event.player, event.source].some(current => {
					if (!current?.isIn()) {
						return false;
					}
			...
			async content(event, trigger, player) {
				...
				let result = await player
					.choosePlayerCard(target, [1, 3], true, "h", `展示${get.translation(target)}的至多三张手牌并令其与牌堆底的等量牌交换`)
					.set("ai", button => {
						const { player, target } = get.event();
						const card = button.link;
						const att = get.attitude(player, target);
