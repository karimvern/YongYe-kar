...
export let info = {
    ...
    characterSort: {
        xinx2: {
            'liechexinghe': ['xinx_liuying', 'xinx_ren', 'xinx_qiong', 'xinx_kafuka', 'xinx_sanyueqi', 'xinx_yinglang', 'xinx_danheng',
                'xinx_xing', 'xinxnew_liuying', 'xinx_yinlang999', 'xinxhy_qiong', 'xinx_qianyeren', 'xinx_jiziqixing', 'xinxzhu_sanyueqi'],
            ...
            'xianzhou': ['xinx_jingliu', 'xinx_hanya', 'xinx_yinyuejun', 'xinx_guinaifen', 'xinx_wangguiren', 'xinx_feixiao', 'xinx_fuxuan', 'xinx_luocha', 'xinx_yunli'],
            ...
            'yishilvren': ['xinx_sikeke', 'xinx_yeshunguang', 'xinx_laite', 'xinx_aimisi', 'xinx_yixuan'],
            'gongsi': ['xinx_tuopa'],
            'xinxxugou': ['xinx_xiao'],
    ...
    characterTitle: {
        ...
        xinx_xilian: '<font color=#FCACD4>明日已成昨日</font>',
        ...
        xinx_aimisi: '<font color=#EFB8EA>飞行雪绒</font>',
        xinx_zhigengniao: '<font color=#85BCD5>明日为谁而歌</font>',
        xinx_huahuo: '<font color=#D25163>游戏人间</font>',//EAB3BC
        xinx_yixuan: '<font color=#F3D77C>宗师</font>',
        xinx_dalihua: '<font color=#FA577F>于是我们重生</font>',
        xinx_kelvdela: '<font color=#94BBFF>设计：杏、黄袍爱音</font>',
        ...
        xinxhy_qiong: '<font color=#57FFFF>设计：一吨白糖、杏</font>',
        xinx_qianyeren: '<font color=#F55529>我身即刃</font>',
        xinx_jiziqixing: '<font color=#E53C39>拓星启明</font>',
        xinxzhu_sanyueqi: '<font color=#FEA4CD>芳华待灼</font>',
        xinx_yunli: '<font color=#FA8642>刃惊天宗</font>',
        xinx_nakexia: '<font color=#66DBB4>月掩星夜</font>',
    ...
    translate: {
        xinx_nakexia: '杏那刻夏',
        xinx_nakexia_prefix: '杏',
        xinx_yunli: '杏云璃',
        xinx_yunli_prefix: '杏',
        xinx_jiziqixing: '杏姬子·启行',
        xinx_jiziqixing_prefix: '杏',
        xinxnewmeng_liuying: '华流萤',
        xinxnewmeng_liuying_prefix: '华',
        xinx_qianyeren: '杏千冶·刃',
        xinx_qianyeren_prefix: '杏',
        xinxnew_changyeyue: '杏长夜月',
        xinxnew_changyeyue_prefix: '杏',
        xinxhy_qiong: '欢穹',
        xinxhy_qiong_prefix: '欢',
        xinx_feiying: '杏绯英',
        xinx_feiying_prefix: '杏',
        xinx_yaoguang: '杏爻光',
        xinx_yaoguang_prefix: '杏',
        xinx_huohua: '杏火花',
        xinx_huohua_prefix: '杏',
        xinx_yinlang999: '杏银狼LV.999',
        xinx_yinlang999_prefix: '杏',
        xinx_luka: '杏卢卡',
        xinx_luka_prefix: '杏',
        xinxzhu_sanyueqi: '逐三月七',
        xinxzhu_sanyueqi_prefix: '逐',
        xinx_saifeier: '杏赛飞儿',
        xinx_saifeier_prefix: '杏',
        xinx_heitiane: '杏黑天鹅',
        xinx_heitiane_prefix: '杏',
        xinx_dalihua: '杏大丽花',
        xinx_dalihua_prefix: '杏',
        xinx_yixuan: '杏仪玄',
        xinx_yixuan_prefix: '杏',
        ...
        xinxmeng_liuying: '旧华流萤',
        xinxmeng_liuying_prefix: '旧华',
        ...
        xinx_changyeyue: '旧杏长夜月',
        xinx_changyeyue_prefix: '旧杏',
        xinx_kelvdela: '杏刻律德菈',
        ...
        xinxxialang: '侠浪',
        xinxxialang_info: `蓄力技（2/4）。出牌阶段，你可以摸当前蓄力点数张牌，然后消耗1点蓄力点，因此获得的牌不计入手牌上限且可于每个回合开始时使用其中目标不含自己的牌。若你未以此法令一名角色获得过本技能，你可令一名其他角色获得之。`,
        xinxlinglong: '玲珑',
        ...
        xinxqianduan: '千锻',
        xinxqianduan_info: `你使用位于${get.poptip("xinxcuixin_card")}右侧的牌无次数限制，使用位于${get.poptip("xinxcuixin_card")}左侧的牌后摸一张牌。${get.poptip("xinxcuixin_card")}于你使用牌后向左移动一张，若其无法移动，你弃置之。`,
        xinxnewbuli: `不离`,
        xinxnewbuli_info: `你不因本技能获得牌时改为获得【影】。你每失去一张【影】，摸两张牌。`,
        xinxnewyiyu: '呓语',
        xinxnewyiyu_info: `锁定技，你于回合外失去牌后，你${get.poptip("sxrm_connect")}你与当前回合角色A一张手牌。有${get.poptip("sxrm_connect")}牌失去时，你依次使用这些牌，若有A无法使用的牌，A失去1点体力。`,
        xinxshuangjian: '双剑',
        xinxshuangjian_info: `你使用牌结算后，若结算期间有角色受到过伤害/获得过牌/弃置过牌/回复过体力，你可以选择其中一项，令一名角色执行等量数值的对应效果。`,
        xinxtongxing: '同行',
        xinxtongxing_info: `其他角色使用牌结算后，若你至目标角色距离为1，你发动一次不造成伤害的${get.poptip('xinxshuangjian')}。`,
        xinxkuanghuan: '狂欢',
        ...
        xinxzunlin: '尊临',
        xinxzunlin_info: `①你造成伤害时，随机获得一张因${get.poptip('xinxcaidan')}合成而消耗过的牌。②你每三次失去所有手牌后，将一名其他角色武将牌上的一个技能的${get.poptip('xinx_zyjinengshiji')}添加至本技能的①中，若无时机可添加，你将${get.poptip('xinxcaidan')}触发的标签数值改为最大值。`,
        xinxcaidan_directHit: "<span style='text-shadow:rgba(255, 0, 0, 1) 0 0 2px, rgba(255, 0, 0, 1) 0 0 2px, rgba(255, 0, 0, 1) 0 0 2px, rgba(255, 0, 0, 1) 0 0 2px, black 0 0 1px; color: white;'>不可响应</span>",
        xinxcaidan_baseDamage: '增伤',
        xinxcaidan_effectCount: "<span style='text-shadow:rgba(245, 85, 41, 1) 0 0 2px, rgba(245, 85, 41, 1) 0 0 2px, rgba(245, 85, 41, 1) 0 0 2px,rgba(245, 85, 41, 1) 0 0 2px, black 0 0 1px'>额外结算</span>",
        xinxcaidan_draw: "<span style='text-shadow:rgba(87, 255, 255, 1) 0 0 2px, rgba(182, 12, 131, 1)  0 0 2px, rgba(182, 12, 131, 1)  0 0 2px, rgba(182, 12, 131, 1)  0 0 2px, black 0 0 1px'>摸牌</span>",
        xinxcaidan_maxHp: "<span style='text-shadow:rgba(130, 224, 170, 1) 0 0 2px, rgba(130, 224, 170, 1) 0 0 2px, rgba(130, 224, 170, 1) 0 0 2px, rgba(130, 224, 170, 1) 0 0 2px, black 0 0 1px'>体力</span>",
        xinxcaidan_use: "<span style='text-shadow:rgba(0, 183, 255, 1) 0 0 2px, rgba(0, 183, 255, 1) 0 0 2px, rgba(0, 183, 255, 1) 0 0 2px, rgba(0, 183, 255, 1) 0 0 2px, black 0 0 1px'>使用</span>",
        xinxanliu: '暗流',
        ...
        xinxzhengfu: '征服',
        xinxzhengfu_info: `每回合限一次，一名角色使用伤害牌结算后，若未造成伤害，你可以将此牌交给一名角色并令此牌不计入次数限制，且其下次使用牌的结算方式改为此牌的结算方式。`,
        xinxjiaotu: '狡兔',
        xinxjiaotu_info: `其他角色于其回合外获得的牌无法对你使用，其失去这些牌时，你获得之。`,
        xinxhuanri: '换日',
        xinxhuanri_info: `每回合限一次，你使用牌时，可以重铸你与目标角色各两张牌，因此获得的牌的目标视为被重铸牌的目标。`,
        xinxfenshen: '焚身',
        xinxfenshen_info: `每轮结束时，①你可以对一名角色造成1点火焰伤害。②此后其不因本技能回复体力时，你选择一项：1.[你与其各摸一张牌]；2.[改为令其视为使用一张【洞烛先机】]。③其造成伤害时，[其回复1点体力]。`,
        xinxlianxin: '恋新',
        ...
        mingtu_tongxie: "同谐",
        mingtu_tongxie_info: "可获得的技能：<br/>「即奏」：当你获得此技能时，你可以观看一名其他角色的手牌，将其中一种花色的牌替换为牌堆中的等量红色牌，然后你获得被替换的牌。你或其失去以此法获得的牌时，从弃牌堆获得等量张红色牌。<br/>「梦醒」：一名角色的回合开始时，若当前回合为额外回合（发动来源须为穹势力角色），你可以令其的当前手牌不计入手牌上限。",
        mingtu_jiyi: "记忆",
        ...
        xinxjizou: "即奏",
        xinxjizou_info: "当你获得此技能时，你可以观看一名其他角色的手牌，将其中一种花色的牌替换为牌堆中的等量红色牌，然后你获得被替换的牌。你或其失去以此法获得的牌时，从弃牌堆获得等量张红色牌。",
        xinxmengxing: "梦醒",
        xinxmengxing_info: "一名角色的回合开始时，若当前回合为额外回合（发动来源须为穹势力角色），你可以令其的当前手牌不计入手牌上限。",
        xinxmengxing_tag: "梦醒",
        xinxjizou_tag: "即奏 上限",
        xinxzhupo: "筑珀",
        ...
        xinxleizhix: "雷止",
        xinxleizhix_info: "锁定技。当你使用牌指定其他角色为目标后，或成为其他角色使用牌的目标后，你令其中一名目标角色明置一张手牌，且本回合内，其无法使用明置的牌。",
        ...
        xinxjizhen: "集真",
        xinxjizhen_info: "一名角色的结束阶段，若场上至少有一名没有暗置牌的角色，你摸两张牌并入幻。",
        xinxliaoduan: "缭断",
        ...
        xinxqiongguan: "穷观",
        xinxqiongguan_info: "每回合限一次，一名角色体力值减少时，你可以使用X张于本轮进入过处理区的牌（X初始为0，你与其体力值/体力上限/手牌数/装备区牌数每有一项相同，X便+1）。",
        xinxgeze: "格泽",
        ...
        xinxyongjie: "永劫",
        xinxyongjie_info: `准备阶段，你从游戏外创造存活人数张火【杀】，你获得其中一张，其余洗入牌堆。你使用这些牌时不计入次数限制且摸一张牌。当你处于濒死状态时，你退幻，重置${get.poptip('xinxfushi')}，然后增加1点体力上限并将体力回复至1点。`,
        xinxjueying: '攫英',
        ...
        xinxmingxinx: "明心",
        xinxmingxinx_info: `准备阶段，你令所有其他角色依次将随机一张手牌及牌堆顶的一张牌置入其装备区。`,
        xinxguichen: "归尘",
        xinxguichen_info: `其他角色不因使用失去除手牌区及判定区外的牌后，你获得之。你可以将其他角色非手牌区的非锦囊牌如手牌般使用或打出。`,
        xinxguichenx: "归尘",
        xinxguichenx_info: `其他角色不因使用失去除手牌区及判定区外的牌后，你获得之。你可以将其他角色非手牌区的牌如手牌般使用或打出。`,
        xinxlingxiao: "凌霄",
        xinxlingxiao_info: `你于出牌阶段使用${get.poptip('xinx_jishipai')}指定其他角色为唯一目标后，将此牌置入其装备区，若其非手牌区的牌数不小于4，你入幻。`,
        xinxlingxiaox: "凌霄",
        xinxlingxiaox_info: `每回合限X次，你于出牌阶段使用${get.poptip('xinx_jishipai')}指定其他角色为唯一目标后，将此牌置入其装备区，若其非手牌区的牌数不小于4，你可以弃置其中X张牌，对其造成等量伤害并退幻（X为你本局入幻次数）。`,
        xinxmosuo: "摩挲",
        xinxmosuo_info: `出牌阶段，你可以与一名其他角色同时重铸一张牌，因此获得的牌替换为【影】，然后本回合你仅能对其发动本技能且重铸牌数递增。若其中一方手牌【影】数大于非【影】数，此技能本回合失效。你/其他角色的【影】视为雷【杀】/【毒】。`,
        xinxbeichan: "悲颤",
        xinxbeichan_info: `每回合限一次，有角色失去体力或受到伤害后，你声明一种类型或颜色，以观看牌背方式选择获得${get.poptip('xinx_central')}一张牌并使用之。若此牌类型或颜色与你声明的相同，你摸一张牌并重置本技能。`,
        xinxnewxinzhui: "星坠",
        ...
        xinxsuyin: "溯音",
        xinxsuyin_info: `每回合限一次，一名未对你使用【杀】的角色失去一张牌后，若你使用过同名牌，你可以与其各获得一张同字数的牌，这些牌称为“音”（你的“音”不计入手牌上限、每回合每种字数限使用一次且不受本技能次数限制）。`,
        xinxsuyin_tag: "音",
        xinxxinshi: "星逝",
        ...
        visible_xinxxuanmo: '明置',
        xinxmiesui: '灭祟',
        xinxmiesui_info: `每轮结束时，你执行前X项：<br>①获得本轮最后一张失去的牌；<br>②视为使用你每个回合内你使用过的最后一张实体牌；<br>③获得本局你响应过的牌。（X为你的明置牌数）。`,
    ...
    dynamicTranslate: {
        ...
        xinxhongzhu(player) {
            let da = player.getStorage('xinxhongzhu').includes('damage');
            let re = player.getStorage('xinxhongzhu').includes('recover');
            let use = player.hasSkill('xinxhongzhu_use');
            // 基础时机
            let activeTimings = ["结束阶段"];
            // unshift 是加到最前面，push 是加到最后面
            if (use) activeTimings.unshift("出牌阶段限一次");
        ...
        xinxfenshen(player) {
            ...
            const map = {
                'xinx_qiong': '你与其各摸一张牌',
                'xinx_heitiane': '改为令其视为使用一张【洞烛先机】',
                'xinxnew_liuying': '其回复1点体力'
            };
            let eff1 = map[list[0]];
            let eff2 = map[list[1]];
            let eff3 = map[list[2]];
            return `每轮结束时，①你可以对一名角色造成1点火焰伤害。②此后其不因本技能回复体力时，你选择一项：1.[<span style="color:#00fa9a">${eff1}</span>]；2.[<span style="color:#00fa9a">${eff2}</span>]。③其造成伤害时，[<span style="color:#ff6347">${eff3}</span>]。`;
        },
        xinxangyang(player) {
            const steps = player.getStorage('xinxangyang');
            const map = {
                'use': '使用一张【杀】',
                'gain': '获得一张【杀】'
            };
            return `回合开始时，你可依次执行：①${map[steps[0]]}，②${map[steps[1]]}，③${map[steps[2]]}。若当前项无法执行，你受到1点无来源伤害将当前执行项改为：获得一张【杀】。`;
        },
        xinxwushe(player) {
    ...
    characterSubstitute: {//皮肤切换
        ...
        xinx_qianyeren: [
            ['xinx_qianyeren_shadow', ['ext:永夜之境/image/xinx_qianyeren_shadow.png']],
        ],
        xinx_feiying: [
    ...
    skill: {
        ...
        xinxqiusuo: {
            ...
            trigger: {
                player: ["useCardAfter", 'respondAfter']//useCardAfter
            },
            forced: true,
            locked: false,
        ...
        xinxlinghang: {
            ...
            subSkill: {
                ...
                init: {
                    ...
                    async content(event, trigger, player) {
                        const num = get.info("xinxlinghang_global").beginMarkCount;
                    ...
                    return {
                        ...
                        async precontent(event, trigger, player) {
                            ...
                            if (materialCard.name === viewAsCard.name) {
                                ...
                                const currentPhaseCn = phaseMap[currentPhase] || "出牌阶段";
                                ...
                                /* const skills = _status.xinxhuaqianyiSkills.filter(skill => {
                                    ...
                                    const trans = get.plainText(get.skillInfoTranslation(skill));
                                    // 匹配本阶段（当前是出牌阶段，就只认"出牌阶段"或 enable:"phaseUse"）
        ...
        xinxxinzhui: {
            ...
            subSkill: {
                ...
                skip: {
                    ...
                    filter(event, player) {
                        return !player.isTurnedOver() && !event.skill && player.countMark('xinxxinzhui_ins');
                    },
                    forced: true,
                    popup: false,
                    async content(event, trigger, player) {
        ...
        xinxshuohua: {
            ...
            async content(event, trigger, player) {
                ...
                const next = player.chooseToMove('朔华：替换其中任意张牌');
        ...
        xinxzhili: {
            ...
            async content(event, trigger, player) {
                if (event.getParent(2).name == 'chooseToUse') {
                    const result = await player
                        .chooseCard(get.prompt("xinxzhili"), "重铸任意张牌", [1, Infinity], "he", lib.filter.cardRecastable, true)
                        .set("ai", card => {
                            let val = get.value(card);
                            return 6 - val;
                        })
        ...
        xinxhuanling: {
            ...
            async content(event, trigger, player) {
                let target = game.findPlayer(current => current.name === 'xinx_mimi');
                if (target) {
                    ...
                    if (result?.bool) {
                        const target = result.targets[0];
                        //感谢暴暴龙，萌佬
                        const fellow = await game.addPlayerOL(target, 'xinx_mimi', null, true, { source: player });
                        game.broadcastAll((player, fellow) => {
                                ...
                                for (const match of matches) {
                                    ...
                                    if (src) {
                                        ...
                                        testImg.onload = function () {
                                            if (onload) return;
                                            onload = true;
                                            const node = fellow.node.identity.firstChild;
                                            node.innerHTML = "";
                                            node.style.width = "30px";
                                            node.style.height = "30px";
                                            node.style.backgroundImage = `url('${src}')`;
                                            node.style.backgroundSize = "cover"; // 图片铺满圆圈
                                            node.style.backgroundPosition = "center"; // 居中显示
                                            node.style.borderRadius = "50%";// 裁剪成圆形
                                            node.style.boxShadow = "0 0 5px #000";
                                        };
                                        testImg.src = src;
                                        if (onload) break;
                                    }
                            ...
                            /* const src = "extension/永夜之境/skin/xinx_qiong/二周年.png";
                            const node = fellow.node.identity.firstChild;
                            node.innerHTML = ""; // 清空原本的文字
                            */

                            // 同步阵营和 AI 明暗状态
                            if (fellow.ai) {
                                fellow.ai.identity_mark = "finished";
                                if (typeof player.ai?.shown === "number") {
                                    fellow.ai.shown = player.ai.shown;
                                }
                            }
                            if (typeof player.side == "boolean") {
                                fellow.side = player.side;
                            }
                            // 将 AI 的 modAttitude 移入 broadcastAll
                            fellow.ai.modAttitudeFrom = function (from, to) {
                                if (to == from.xinx_master) return 114514;
                                return get.attitude(from.xinx_master || from, to.xinx_master || to);
                            };
                            fellow.ai.modAttitudeTo = function (from, to, att) {
                                if (from == to.xinx_master) return 7;
                                return get.attitude(from.xinx_master || from, to.xinx_master || to);
                            };
                            if (!_status.xinx_mimi_mechanic_installed) {
                                _status.xinx_mimi_mechanic_installed = true;
                                ...
                                if (typeof game.checkResult === "function") {
                                    ...
                                    game.checkResult = function () {
                                        if (_status.event?.name === "die" && _status.event.player?.xinx_master) {
                                            return;
                                        }
                                        const me = game.me._trueMe || game.me;
                                        if (game.players.filter(i => i !== me).every(i => (i.xinx_master || i) === (me.xinx_master || me))) {
                                            game.over(true);
                                        }
                                ...
                                if (typeof game.checkOnlineResult === "function") {
                                    ...
                                    game.checkOnlineResult = function (targetPlayer) {
                                        if (_status.event?.name === "die" && _status.event.player?.xinx_master) {
                                            return;
                                        }
                                        if (game.players.filter(i => i !== targetPlayer).every(i => (i.xinx_master || i) === (targetPlayer.xinx_master || targetPlayer))) {
                                            return true;
                                        }
                                ...
                                if (typeof lib.element.player.getFriends === "function") {
                                    ...
                                    const getFriends = function (func, includeDie) {
                                        const current = this;
                                        return [...origin_getFriends.apply(this, arguments), ...game[includeDie ? "filterPlayer2" : "filterPlayer"](target => (target.xinx_master || target) === (current.xinx_master || current))]
                                            .filter(i => i !== current || func === true)
                                            .unique()
                                            .sortBySeat(current);
                                    };
                                ...
                                if (typeof lib.element.player.isFriendOf === "function") {
                                    ...
                                    const isFriendOf = function (target) {
                                ...
                                if (typeof lib.element.player.getEnemies === "function") {
                                    ...
                                    const getEnemies = function (func, includeDie) {
                                        if (this.xinx_master) {
                                            return this.xinx_master.getEnemies(func, includeDie);
                                        } else {
                                            const current = this;
                                            return [
                                                ...origin_getEnemies.apply(this, arguments),
                                                ...game[includeDie ? "filterPlayer2" : "filterPlayer"](target => {
                                                    return origin_getEnemies.apply(this, arguments).includes(target.xinx_master || target);
                                                }),
                                            ]
                                                .filter(i => current != (i.xinx_master || i))
                                                .unique()
                                                .sortBySeat(current);
                                        }
                                    };
            ...
            subSkill: {
                charge: {
                    ...
                    content() {
                        ...
                        player.addCharge(Math.abs(trigger.num));
                    },
                    sub: true,
        ...
        xinxjizou: {
            ...
            async content(event, trigger, player) {
                const target = event.targets[0];
                const rawList = get.addNewRowList(target.getCards("h"), "suit", target);
                //const list = rawList.flat().filter(item => item && (item.length > 0 || item.count > 0));
                const list = get.addNewRowList(target.getCards("h"), "suit", target);
                if (!list.length) return;
                const result = await player.chooseButton([
                    [
                        [[`即奏：用牌堆等量的红色牌替换${get.translation(target)}一种花色的所有手牌`], "addNewRow"],
                        [
                            (dialog) => {
                                dialog.classList.add("fullheight");
                    ...
                    .set("filterButton", button => {
                        return button.links && button.links.length > 0;
                    })
                    .set("ai", button => {
                        if (!button.links || !button.links.length) return 0;
                        return button.links.map(c => get.value(c)).reduce((p, c) => p + c, 0);
                    })
                    .forResult();
                if (result?.bool && result.links?.length) {
                    const cards22 = target.getCards("h").filter((card) => result?.links?.includes(get.suit(card, player)))
                    ...
                    if (cards22.length) {
                        ...
                        if (cards.length) {
                            await target.gain(cards, "draw").set('gaintag', ["xinxjizou"]);
                        }
                        player.logSkill("xinxjizou", target, null, null, [get.rand(3, 4)]);
                        await player.gain(cards22, "draw").set('gaintag', ["xinxjizou"]);
            ...
            subSkill: {
                draw: {
                    ...
                    filter(event, player) {
                        ...
                        return evt.cards.some(card => evt.gaintag_map?.[card.cardid]?.includes("xinxjizou"));
                    },
                    async content(event, trigger, player) {
                        /* 
                        ...
                        const evt = trigger.getl?.(player);
                        const lostTaggedCards = evt.cards.filter(card => {
                            return evt.gaintag_map?.[card.cardid]?.includes("xinxjizou");
                        });
                        const num = lostTaggedCards.length;

                        if (num === 0) return;
                        player.logSkill("xinxjizou", null, null, null, [get.rand(5, 6)]);
                        const redCards = Array.from(ui.discardPile.childNodes).filter(card => {
                            return get.color(card) === 'red';
                        });
                        if (redCards.length > 0) {
                            const getNum = Math.min(num, redCards.length);
                            const cardsToGain = redCards.slice(0, getNum);
                            await player.gain(cardsToGain, 'gain2');
                        }
        ...
        xinxhairu: {
            ...
            async content(event, trigger, player) {
                ...
                if (result.bool) {
                    const selectedMark = map[result.links[0]];
                        ...
                        if (target.getStockSkills(false, true).length > 0) {
                            ...
                            const result = await player.chooseButton(
                                [
                                    ...
                                    [loseList, "skill"],
                                    `<div class="text center">令${get.translation(target)}获得的技能</div>`,
                                    [gainList, "skill"]
                                ]
                            )
                                .set("selectButton", 2)
        ...
        xinxcanmeng: {
            ...
            hiddenCard(player, name) {
                const cards = get.info("xinxcanmeng").getCards(player);
            ...
            intro: {
                ...
                mark(dialog, storage, player) {
                    let cards = get.info("xinxcanmeng").getCards(player);
            ...
            group: ["xinxcanmeng_handler",],//"xinxcanmeng_handler"
            subSkill: {
                handler: {
                    mod: {
                        aiOrder(player, card, num) {
                    ...
                    onChooseToUse(event) {
                        ...
                        // 收集全场所有明置的手牌
                        let shownCards = get.info("xinxcanmeng").getCards(player);
                        if (shownCards.length) {
                            // 生成虚拟牌并直接给予玩家（带有特定标签）
                            const fakes = game.createFakeCards(shownCards);
                            fakes.forEach(card => card.classList.add('purple-flowing-card'));
                    ...
                    async content(event, trigger, player) {
                        if (["useCard", "respond"].includes(trigger.name)) {
                            ...
                            if (trigger.name == 'useCard') {
                                trigger.addCount = false; // 本次使用不计入次数
            ...
            subSkill: {
                handler: {
                    ...
                    init(player, skill) {
                        ...
                        if (shownCards.length) {
                            ...
                            fakes.forEach((fake, i) => {
                                fake.classList.add('purple-flowing-card');
                                const owner = get.owner(shownCards[i]);
                                if (fake.node && fake.node.gaintag && owner) {
                                    fake.node.gaintag.innerHTML = owner.getName();
                                }
                            });
                        }
                    ...
                    trigger: {
                        player: ["useCardBefore", "respondBefore"],
                        global: ["loseEnd", "loseAsyncEnd", "gainEnd", "cardsDiscardEnd", "showCardsEnd","addToExpansionEnd","equipEnd","addJudgeEnd", "showHandcardsEnd"],
                    },
                    forced: true,
                    popup: false,
                    silent: true,
                    filter(event, player) {
                        if (["useCard", "respond"].includes(event.name)) {
                            if (event.player !== player) return false;
                            const fakeCards = player.getCards("s", card => card.hasGaintag("xinxcanmeng"));
                            return event.cards && event.cards.some(card => fakeCards.includes(card));
                        }
                        return true;
                    },
                    async content(event, trigger, player) {
                        ...
                        if (["useCard", "respond"].includes(trigger.name)) {
                            ...
                            for (let i = 0; i < trigger.cards.length; i++) {
                                ...
                                if (fakeCard.hasGaintag("xinxcanmeng")) {
                                    const realCard = shownCards.find(sc => sc.cardid == fakeCard._cardid);
                                    if (realCard) {
                                        trigger.cards[i] = realCard;
                                        if (trigger.card && Array.isArray(trigger.card.cards)) {
                                            const idx = trigger.card.cards.indexOf(fakeCard);
                        ...
                        // 场上的牌动了 -> 同步刷新假牌
                            ...
                            if (realsToAdd.length) {
                                const fakes = game.createFakeCards(realsToAdd);
                                player.directgains(fakes, null, "xinxcanmeng");
                                fakes.forEach((fake, i) => {
                                    fake.classList.add('purple-flowing-card');
                                    const owner = get.owner(realsToAdd[i]);
                                    if (fake.node && fake.node.gaintag && owner) {
                                        fake.node.gaintag.innerHTML = owner.getName();
                                    }
                                });
        ...
        xinxleizhi: {
            ...
            audio: "ext:永夜之境/audio:5",
            logAudio: index => (typeof index === "number" ? `ext:永夜之境/audio/xinxleizhi${index}.mp3` : 2),
            trigger: {
                player: "useCardToPlayered",
            ...
            filter(event, player) {
                ...
                if (event.name == "useCardToTarget") {
                    ...
                    return event.player.countCards('h', card => !get.is.shownCard(card)) > 0;
                } else {
                    const parent = event.getParent();
                    if (parent.xinxleizhi_used) return false;
                    if (!parent.targets) return false;
                    const validTargets = parent.targets.filter(t => t !== player && t.countCards('h', card => !get.is.shownCard(card)) > 0);
                    return validTargets.length > 0 && event.isFirstTarget;
                }
            },
            /* logTarget: "target",
            ...
            async content(event, trigger, player) {
                // const targets = (trigger.name == "useCardToPlayered" ? trigger.targets : [trigger.player]);
                let targets;
                ...
                let result1;
                if (targets.length > 1) {
                    result1 = await player
                        .chooseTarget(get.prompt('xinxleizhi'), "选择一名目标角色令其明置一张牌", (card, player, target) => {
                            return _status.event.targets.includes(target);
                        })
                        .set("ai", target => {
                            const player = _status.event.player;
                ...
                if (result1?.bool && result1.targets?.length) {
                    const target = result1.targets[0];
                    player.logSkill("xinxleizhi", [target], null, null, trigger.name == "useCardToPlayer" ? [get.rand(1, 3)] : [get.rand(4, 5)]);
        ...
        xinxyunjiu: {
            ...
            async content(event, trigger, player) {
                ...
                if (result.bool) {
                    ...
                    game.log(player, '将', '#y' + get.cnNumber(cards.length), '张牌置入了牌堆');
            ...
            intro: {
                mark(dialog, storage, player) {
                    ...
                    dialog.addText('<div class="text center" style="font-size:18px; font-weight:bold; padding:5px; margin-top:15px; border-bottom:1px solid rgba(128,128,128,0.3)">🎴柩</div>');
                    if (storage.length && player.isUnderControl(true)) {
        ...
        xinxjiangxing: {
            ...
            async content(event, trigger, player) {
                ...
                for (let i = 0; i < game.dead.length; i++) {
                    list.add(game.dead[i].name);
                }
                const result = await player.chooseButton(ui.create.dialog('令一名已死亡的角色复活', [list, 'character']))
                    .set("ai", function (button) {
                        const deadPlayer = game.dead.find(p => p.name === button.link);
                        return deadPlayer ? _status.event.player.attitudeTo(deadPlayer) : 0;
                    })
                    .forResult();
                if (result?.bool && result.links?.length) {
                    const targetName = result.links[0];
                    const target = game.dead.find(p => p.name === targetName);
                    await game.delayx();
        ...
        xinxqiongguan: {
            ...
            async content(event, trigger, player) {
                ...
                if (num > 0 && cards.length) {
                    game.playAudio("../extension/永夜之境/audio/", 'xinxqiongguan' + [get.rand(1, 2)] + '.mp3');
                    let useCount = 0;
                    while (cards.some(card => player.hasUseTarget(card)) && useCount < num) {
                        ...
                        if (result?.bool) {
                            ...
                            player.addTempSkill('xinxqiongguan_add');
                            const card = result.links[0];
                            cards.remove(card);
                            player.$gain2(card, false);
                            await game.delayx();
                            player.logSkill("xinxqiongguan", null, null, null, [get.rand(3, 4)]);
                            //game.playAudio("../extension/永夜之境/audio/",'xinxqiongguan'+[get.rand(3, 4)]+'.mp3');
        ...
        xinxgeze: {
            ...
            async content(event, trigger, player) {
                ...
                if (link == "hp" && targets.length) {
                    ...
                    if (Math.abs(num) > 2) {
                        await player.changeHp(2 - player.getHp(true));
                    }
                }
        ...
        xinxzhuhuo: {
            ...
            async content(event, trigger, player) {
                ...
                if (count > hp) {
                    let num = count - hp;
                    const resultd = await target.chooseToDiscard(num, 'he', true, "allowChooseAll").forResult();
            ...
            subSkill: {
                ...
                recover: {
                    ...
                    async content(event, trigger, player) {
                        ...
                        /* if (player.node.avatar) {
                            player.node.avatar.classList.add('awakened-fire-aura');
                        } */
                        if (player.node.avatar) {
                            player.node.avatar.classList.add('xinxxinshi-awaken-effect');
                        }
                        await player.changeSkills(["xinxyongjie"], ["xinxfushi"]);
                        ui.backgroundMusic.src = `${lib.assetURL}extension/永夜之境/audio/music/日冕(Cut).mp3`;
                    },
                    sub: true,
                }
            }
        ...
        xinxyongjie: {
            ...
            async content(event, trigger, player) {
                ...
                const cardsToPile = [];
                for (let i = 0; i < num; i++) {
                    const card = game.createCard2('sha');
                    card.nature = 'fire';
                    card.classList.add('red-flowing-card');
            ...
            subSkill: {
                quit: {
                    ...
                    async content(event, trigger, player) {
                        ...
                        if (player.node.avatar) {
                            //player.node.avatar.classList.remove('awakened-fire-aura');
                            player.node.avatar.classList.remove('xinxxinshi-awaken-effect');
                        }
                        game.playBackgroundMusic();
                    },
        ...
        xinxjueying: {
            clickableFilter(player) {
                return player.hasSkill("xinxjueying");
            },
            clickable(player) {
                if (player.isUnderControl(true)) {
                    const cards = lib.skill.xinxjueying.getCards(player);
                    function createDialogWithControl(result) {
                ...
                aocai: {
                    ...
                    onChooseToUse(event) {
                        ...
                        if (ui.cardPile.hasChildNodes !== false) {
                            ...
                            if (topCards.length) {
                                const fakeTopCards = game.createFakeCards(topCards);
                                // 遍历这些生成的假牌节点，挨个加特效
                                fakeTopCards.forEach(card => card.classList.add('cyan-flowing-card'));
                                player.directgains(fakeTopCards, null, "xinxjueyingt");
                            }

                            if (bottomCards.length) {
                                const fakeBottomCards = game.createFakeCards(bottomCards);
                                fakeBottomCards.forEach(card => card.classList.add('silver-flowing-card'));
                                player.directgains(fakeBottomCards, null, "xinxjueyingx");
                            }
                        }
                    },
                    onChooseToRespond(event) {
                    ...
                    filter(event, player) {
                        if (["useCard", "respond"].includes(event.name)) {
                            ...
                            const num = Math.min(3, player.storage.xinxjueying || 1);
                            const pile = Array.from(ui.cardPile.childNodes);
                            /* let validCards = pile.slice(-num);
                            if (player.storage.xinxzhuoxiao) {
                                validCards = validCards.concat(pile.slice(0, num)); 
                            } */
        ...
        xinxzhanshu: {
            ...
            initPile(isReshuffle = false) {
                ...
                const deckConfig = [
                    ...
                    ['diamond', 12, 'shunshou'], ['spade', 12, 'guohe'], ['club', 12, 'xinxguiji'], ['heart', 4, 'xinxjiyibiaoben'], ['spade', 6, 'xinxyuejianbiyou'],
                    ['diamond', 7, 'xinxnilin'],
                    // --- 装备牌 ---
        ...
        xinxdashi: {
            ...
            async content(event, trigger, player) {
                ...
                const pool = [
                    ...
                    ['spade', 12, 'xinxxuanshi'], ['club', 11, 'xinxnalaibani'], ['diamond', 10, 'xinxchenghuihupo'],
                    ['heart', 7, 'juedou'], ['spade', 13, 'xinxjinshouzhi'], ['heart', 8, 'xinxruwosuoshu'],
                    //基本
        ...
        xinxxmingxi: {
            ...
            async content(event, trigger, player) {
                ...
                while (true && useCount < num) {
                    ...
                    game.cardsGotoOrdering(card1);
                    player.showCards(card1);
                    game.playAudio("../extension/永夜之境/audio/", 'xinxxmingxi' + [get.rand(4, 5)] + '.mp3');
                    if (player.hasUseTarget(card1[0])) {
                        player.$gain2(card1, false);
                        await game.delayx();
                        await player.chooseUseTarget(card1, true, false);
                    }
                    useCount++;
                    if (useCount == num) break;
                    let card2 = get.bottomCards();
                    game.cardsGotoOrdering(card2);
                    player.showCards(card2);
                    if (player.hasUseTarget(card2[0])) {
                    ...
                    ai: {
                        effect: {
                            player: (card, player, target) => {
                                //确认当前 AI 正在评估的是不是【闪】
                                if (typeof card !== 'object' || get.name(card, player) !== 'shan' || player.hp <= 1) return;
                                const shaEvent = _status.event.getParent('sha');
                                if (!shaEvent || !shaEvent.player) return;
                                const attacker = shaEvent.player;
                                if (attacker.hasSkill('xinxhuiyi')) {
                                    const att = get.attitude(player, attacker);
                                    if (att <= 0) {
                                        return -10;
                                    } else if (att > 0) {
                                        return 10;
        ...
        xinxjiegou: {
            ...
            filter(event, player) {
                return game.hasPlayer2(target => {
                    ...
                    return storage && storage.filterInD("dcxehsj").length > 0;
                });
            },
            forced: true,
            locked: false,
            ...
            async content(event, trigger, player) {
                ...
                //game.players.slice().concat(game.dead);
                let allCards = [];
                for (let target of targets) {
                    let cards = player.getStorage("xinxjiegou").filterInD("dcexhsj");
                    if (cards.length) {
                    ...
                    let next = await player.chooseButton(
                        ...
                        .set("filterButton", button => {
                            ...
                            if (isClickingVCard) {
                                ...
                                return _status.event.player.hasUseTarget(vCardObj, true, false);
                            } else {
                                // --- 点击实体牌逻辑 ---
            ...
            subSkill: {
                ...
                effect: {
                    ...
                    async cost(event, trigger, player) {
                        const result = await player.chooseTarget(get.prompt("xinxjiegou"),
                            `令一名目标角色获得${get.translation(trigger.card)}`, (card, player, target) => {
                    ...
                    async content(event, trigger, player) {
                        player.logSkill("xinxjiegou", event.targets[0], null, null, [get.rand(1, 4)]);
                        await event.targets[0].gain(trigger.cards, 'gain2');
                    },
                },
        ...
        xinxlinggan: {
            ...
            async content(event, trigger, player) {
                const storage = player.getStorage("xinxlinggan") || [];
                // let card = get.cardPile(card => {
                ...
                draw: {
                    ...
                    async content(event, trigger, player) {
                        ...
                        if (matches.length > 0) {
                            ...
                            player.unmarkAuto('xinxlinggan', toRemove)
        ...
        xinxyueding: {
            ...
            async content(event, trigger, player) {
                ...
                player.storage.xinxyueding_target = target;
                target.storage.xinxyueding_target = player;
                //互发共享技能和标记
                player.markAuto("xinxyueding_use", [target]);
                target.markAuto("xinxyueding_use", [player]);
                player.addAdditionalSkill(`xinxyueding_use_${target.playerid}`, "xinxyueding_use");
                target.addAdditionalSkill(`xinxyueding_use_${player.playerid}`, "xinxyueding_use");
                player.addTempSkill("xinxyueding_clear", { player: "phaseBegin" });
            ...
            subSkill: {
                clear: {
                    charlotte: true,
                    onremove(player, skill) {
                        const target = player.storage.xinxyueding_target;
                        if (target) {
                            target.removeAdditionalSkill(`xinxyueding_use_${player.playerid}`);
                            target.unmarkAuto("xinxyueding_use", [player]);
                            delete target.storage.xinxyueding_target;
                        }
                        player.removeAdditionalSkill(`xinxyueding_use_${target ? target.playerid : ""}`);
                        player.unmarkAuto("xinxyueding_use", [target]);
                        delete player.storage.xinxyueding_target;
                    }
                },
                use: {
                    mod: {
                    ...
                    init(player, skill) {
                        const target = player.storage.xinxyueding_target;
                        if (!target) return;
                        const toRemove = player.getCards("s", card => card.hasGaintag("xinxyueding_tag"));
                        game.deleteFakeCards(toRemove);

                        const fakeCards = target.isAlive() && target.countCards("h") ? game.createFakeCards(target.getCards("h")) : [];
                        if (fakeCards.length) {
                            player.directgains(fakeCards, null, "xinxyueding_tag");
                        }
                    },
                    onremove(player, skill) {
                        const toRemove = player.getCards("s", card => card.hasGaintag("xinxyueding_tag"));
                    ...
                    filter(event, player) {
                        ...
                        if (["useCard", "respond"].includes(event.name)) {
                            if (event.player !== player) return false;
                            const fakeCards = player.getCards("s", card => card.hasGaintag("xinxyueding_tag"));
                            return event.cards && event.cards.some(card => fakeCards.includes(card));
                        }
                        // 用 getl 和 getg 侦测目标是否物理掉牌，不管 event.player 是谁
                        const toAdd = event.getg?.(target);
                        const toRemove = event.getl?.(target)?.hs;
                        return (toAdd && toAdd.length > 0) || (toRemove && toRemove.length > 0);
                    },
                    async content(event, trigger, player) {
                        ...
                        if (!target) return;
                        if (["useCard", "respond"].includes(trigger.name)) {
                            //如果自己打出了假牌，在结算前一瞬间，把假牌换成对方手中真实的牌
                            trigger.xinxyueding_active = true;
                            game.log(player, "使用了", target, "的手牌");
                            const realCards = target.getCards("h");
                            for (let i = 0; i < trigger.cards.length; i++) {
                                const fakeCard = trigger.cards[i];
                                if (fakeCard.hasGaintag("xinxyueding_tag")) {
                                    // 假牌的 _cardid 记录了原牌的 cardid
                                    const realCard = realCards.find(c => c.cardid == fakeCard._cardid);
                                    if (realCard) {
                                        trigger.cards[i] = realCard;
                            ...
                            //如果对方的手牌物理上变多了或变少了，立刻同步更新自己身上的假牌
                            const toAdd = trigger.getg?.(target) || [];
                            const toRemove = trigger.getl?.(target)?.hs || [];
                            // 对方失去了牌，赶紧把身上对应的假牌销毁掉
                            if (toRemove.length > 0) {
                                const fakesToRemove = player.getCards("s", card =>
                                    card.hasGaintag("xinxyueding_tag") && toRemove.some(cardx => cardx.cardid == card._cardid)
                                );
                                if (fakesToRemove.length > 0) {
                                    game.deleteFakeCards(fakesToRemove);
                                }
                            ...
                            if (toAdd.length > 0) {
                                const newFakes = game.createFakeCards(toAdd);
                                player.directgains(newFakes, null, "xinxyueding_tag");
                            }
                        }
                    }
                },
        ...
        xinxhongzhu: {
            ...
            filter(event, player, name) {
                ...
                return player.getStorage('xinxhongzhu').includes(event.name);
            },
            async cost(event, trigger, player) {
                const list = [];
            ...
            intro: {
                ...
                mark(dialog, storage, player) {
                    ...
                    let str = arr.join("、");
                    // 如果 str 为空，显示默认文本
                    const statusContent = str ? str : "<span style='opacity:0.6'>暂无可用时机</span>";
                    // ---  infoHtml ---
                    const infoHtml = `<ul style="margin:10px 0; padding-left:20px; font-size:16px;">${statusContent}</ul>`;
                    // 将生成好的 HTML 添加到对话框
                    dialog.addText(infoHtml);
            ...
            subSkill: {
                ...
                record: {
                    ...
                    charlotte: true,
                    filter(event, player) {
                        if (player.getStorage('xinxhongzhu').length >= 2 && player.hasSkill("xinxhongzhu_use")) return false;
                        return event.source && event.source == player && event.player != player;
                    },
                    async content(event, trigger, player) {
                        const list = [];
                        if (!player.getStorage('xinxhongzhu').includes("damage")) {
                            list.push("受到伤害");
                        }
                        if (!player.getStorage('xinxhongzhu').includes("recover")) {
                            list.push("回复体力");
                        }
                        if (!player.hasSkill("xinxhongzhu_use")) {
                            list.push("出牌阶段");
                        }
                        ...
                        const result
                            = await player
                                ...
                                .set("ai", () => {
                                    ...
                                    if (!player.getStorage('xinxhongzhu').includes("damage")) return "受到伤害";
                                    return "回复体力";
                                }).forResult();
                        switch (result.control) {
                            case "受到伤害":
                                player.markAuto('xinxhongzhu', 'damage');
                                break;
                            case "回复体力":
                                //player.storage.xinxhongzhu_recover = true;
                                player.markAuto('xinxhongzhu', 'recover');
                                break;
                            case "出牌阶段":
                ...
                use: {
                    ...
                    usable: 1,
                    popup: false,
                    prompt: "发动【虹驻】？选择一个区域的牌与本回合进入弃牌堆的牌交换",
                    filter(event, player) {
                        return player.countCards('hej') > 0 && get.discarded().filterInD("od").length;
                    },
                    async content(event, trigger, player) {
                        const list = [];
                        if (player.countCards('j') > 0) list.push("判定区");
                    ...
                    ai: {
                        ...
                        result: {
                            player(player) {
                                ...
                                let gainValue = cards.reduce((sum, c) => sum + get.value(c, player), 0);
                                if (player.countCards("j") > 0) { return 1; }
                                if (player.countCards("h") > 0 && player.countCards("h") <= 2 && gainValue > 6) { return 1; }
                                if (player.countCards("e") === 1 && gainValue > 6) { return 1; }
                                return 0;
                            },
                        },
                    },
        ...
        xinxduoyi: {
            ...
            async content(event, trigger, player) {
                ...
                if (!list.length) {
                    ...
                    const num = Math.min(5, player.countMark('xinxbashi') || 1);
                    const result = await player
                        .chooseButton(
                            [
                    ...
                    if (result.bool) {
                        if (player.countMark('xinxbashi') > 1) {
                            player.setMark('xinxbashi', 1, false);
                        }
        ...
        xinxbashi: {
            ...
            async cost(event, trigger, player) {
                event.result = await player
                    .chooseCard(get.prompt2("xinxbashi"), "he", lib.filter.cardRecastable)
                    .set("ai", card => {
                        let player = get.player();
            ...
            async content(event, trigger, player) {
                ...
                await player.recast(event.cards);
                if (player.countMark('xinxbashi') < 5) {
                    player.addMark('xinxbashi', 1, false);
                }
            }
        ...
        xinxyiyu: {
            ...
            filter(event, player, name) {
                return player.hasUseTarget(event.result.card) && player.hasCard(card => get.color(card) == get.color(event.result.card), "hejs");
            },
            forced: true,
            locked: false,
            popup: false,
        ...
        xinxyilian_phase: {
            ...
            intro: {
                ...
                content(storage, player) {
                    ...
                    if (!list || list.length === 0) return "标准阶段顺序";
                    let str = list.map(name => {
                        let nameStr = get.translation(name).replace('阶段', '');
                        if (name === 'phaseUse') return '<span style="color:#ff6666">' + nameStr + '</span>';
                        if (name === 'phaseDraw') return '<span style="color:#66ccff">' + nameStr + '</span>';
                        return nameStr;
                    }).join(" → ");
                    return "当前阶段顺序：<br>" + str;
                }
                ...
                backup(links) {
                    return {
                        ...
                        async precontent(event, trigger, player) {
                            ...
                            if (result.bool) {
                                if (!player.storage?.xinxyilians) {
                                    ui.backgroundMusic.src = `${lib.assetURL}extension/永夜之境/audio/music/再度和你 With You Once More.mp3`;
                                    player.storage.xinxyilians = true;
                                }
                                const target = result.targets[0];
                                const handedPhase = result.links[0][2];

                                player.node.avatar.classList.add('water-ripple-effect');

                                /* target.node.avatar.classList.add('charm-infinity-effect');
                                setTimeout(() => {
                                    if (target.node.avatar) {
                                        target.node.avatar.classList.remove('charm-infinity-effect');
                                    }
                                }, 2000); */
                ...
                used: {
                    ...
                    intro: {
                        ...
                        mark(dialog, storage, player) {
                            ...
                            dialog.addText('<div class="text center" style="font-size:18px; font-weight:bold; padding:5px; margin-top:15px; border-bottom:1px solid rgba(128,128,128,0.3)">♾️已用牌名</div>');
        ...
        xinxxianji: {
            ...
            async content(event, trigger, player) {
                ...
                if (link == "use" && targets[0].hasCard(card => target.hasUseTarget(card, false, false), "hs")) {
                    ...
                    const gainList = _status.xinxxianjiSkills.filter(skill => !target.hasSkill(skill, null, null, false)).randomGets(3);
                    if (!gainList.length) return; */
                    let list = [], skills = [];
                    if (get.mode() === 'guozhan') {
                        list.addArray(Object.keys(lib.characterPack.mode_guozhan).filter(i => {
                    ...
                    for (const name of list) {
                        for (const skill of get.character(name)?.skills ?? []) {
                            ...
                            const info = get.info(skill);
                            if (!info || info.charlotte || info.init || (info.ai && (info.ai.combo || info.ai.notemp || info.ai.neg))) continue;
                            if (get.plainText(get.skillInfoTranslation(skill)).includes('当你使用')) skills.add(skill);
                        }
                    }

                    const result = await target.chooseButton(['请选择获得一个技能', [skills.randomGets(3), 'skill']])
                        .set('ai', button => get.priority(button.link))
                        .set('forced', true)
                        .forResult();
                    ...
                    if (result.links && result.links.length) {
                        const chosenSkill = result.links[0];
                        //target.addSkills(chosenSkill);
                        await target.addAdditionalSkills(event.name, chosenSkill, true);
                        //target.popup(chosenSkill);
                        //game.log(target, '获得了技能', `【${get.translation(chosenSkill)}】`);
                        target.when({ global: "roundStart" }).step(async () => {
                            await target.removeAdditionalSkills("xinxxianji");
                        });
                    }
            ...
            subSkill: {
                ...
                add: {
                    ...
                    content() {
                        ...
                        player.addTip('xinxangang_mark', `📔 ${player.getStorage('xinxangang_mark').reduce((str, suit) => str += get.translation(suit), "")}`);
                    },
                },
                mark: {
        ...
        xinxxunji: {
            ...
            async content(event, trigger, player) {
                ...
                if (suits.size >= 3 && cards.length > 3) {
                    ...
                    const autoControl = ui.create.control('AI代选', function () {
                        // 获取当前玩家，用于评估卡牌价值
                        const currentPlayer = _status.event.player || game.me;
                        // 将弃牌堆的牌按价值从低到高排序。
                        //优先把最没用的牌（比如没用的装备、废牌）扣下来凑那3个花色的底线。
                        ...
                        for (const card of sortedCards) {
                            ...
                            if (s && s !== 'none' && !suitsToKeep.has(s) && suitsToKeep.size < 3) {
                                suitsToKeep.add(s);
                        ...
                        if (dialog && dialog.buttons) {
                            for (const btn of dialog.buttons) {
                                if (cardsToSelect.includes(btn.link)) {
                                    btn.classList.add('selected');
                                    ui.selected.buttons.push(btn);
                                }
                            }
                        }
                        //唤醒引擎：更新“确定”按钮的亮暗状态
                ...
                switch (point) {
                    ...
                    case 8:
                        ...
                        const vCardList = sourceList
                            ...
                            .map(card => {
                                return [get.type(card), null || 0, card.name, card.nature || ""];
                            });
                        //检测是否可用
        ...
        xinxmingxin: {
            ...
            async content(event, trigger, player) {
                ...
                for (const target of targets) {
                    ...
                    //随机武将卡面
                    let availableChars = [];
                    if (lib.characterPack['xinx2']) {
                        availableChars = Object.keys(lib.characterPack['xinx2']);
                    }
                    if (availableChars.length === 0) {
                        availableChars = ['liubei', 'guanyu', 'zhangfei', 'zhaoyun', 'machao'];
                    }
                    const randomAvatars = availableChars.randomGets(cardsToProcess.length);

                    for (const card of cardsToProcess) {
                        const subtype = Array.from({ length: 5 }).map((_, i) => `equip${i + 1}`).filter(subtype => {
                            const vcard = get.autoViewAs({ name: 'xinxmingxin_equip' }, [card]);
                            vcard.subtypes = [subtype];
                            return target.canEquip(vcard);
                        }).randomGet();
                        const vcard = get.autoViewAs({ name: 'xinxmingxin_equip' }, [card]);
                        vcard.storage ??= {};
                        vcard.storage.xinxmingxin_source = player;
                        vcard.storage.xinxsaran_avatar = randomAvatars.shift();
                        vcard.subtypes = [subtype];
            ...
            init(player, skill) {
                /* if (!lib.card.xinxmingxin_equip) {
                    lib.card.xinxmingxin_equip = {
                        type: "equip",
                        subtype: "equip1",
                        name: "xinxmingxin_equip",
                        skills: [],
                        description: "由【明心】转化置入的虚拟装备",
                    };
                    lib.translate.xinxmingxin_equip = "明心";
                    lib.translate.xinxmingxin_equip_info = "由【明心】转化而来的装备。";
                } */
                if (!lib.card.xinxmingxin_equip) {
                    lib.card.xinxmingxin_equip = {
                        type: "equip",
                        ...
                        fullimage: true,
                        blankCard: true,
                        image: 'character:xinx_yeshunguang',
                        skills: [],
                        description: "由【明心】转化而来的装备。",
                        onEquip(card) {
                            const source = card.storage?.xinxmingxin_source;
                            const avatar = card.storage?.xinxsaran_avatar || source?.name;
                            if (get.itemtype(source) === 'player') {
                                game.broadcastAll((player, card, source, avatar) => {
                                    let cardx;
                                    ...
                                    if (cardx?.node?.name2 && (vcards.length !== 1 || vcards[0].name !== cardx.name)) {
                                        ...
                                        cardx.node.name2.innerHTML = `明心·${source.isUnderControl(true) ? typeStr : '未知'}`;
                                    }
                                    // 强制换皮为发动者头像
                                    ...
                                    if (cardx && avatar) {
                                        cardx.setBackground(avatar, 'character');
                                    }
                                }, player, card, source, avatar);
                            }
                        }
                    };
                    lib.translate.xinxmingxin_equip = "明心";
                    ...
                    game.broadcastAll(skill => {
                        ...
                        get.nodeintro = function (node, ...args) {
                            ...
                            if (node.classList.contains('card')) {
                                ...
                                if (vcard && vcard.name === 'xinxmingxin_equip' && (vcards.length !== 1 || vcards[0].name !== node.name)) {
                                    const source = vcard.storage?.xinxmingxin_source;
                                    if (get.itemtype(source) === 'player') {
        ...
        xinxguichen: {
            ...
            getCards(player) {
                ...
                game.countPlayer(current => {
                    if (current !== player) {
                        const rawCards = current.getCards("xesj");
                        for (const card of rawCards) {
                            let realCard = (card.cards && card.cards.length > 0) ? card.cards[0] : card;
                            if (realCard) {
                                realCard._guichen_owner = current;
                                cards.push(realCard);
                            }
                        }
                    }
            ...
            mod: {
                cardEnabled2(card, player) {
                    if (card?.hasGaintag?.("xinxguichen")) {
                        if (get.type2(card) == "trick" && !player.storage?.xinxmingxinx) { return false; }
                    }
                },
            },
            intro: {
                ...
                mark(dialog, storage, player) {
                    ...
                    const statusContent = str ? str : "<span style='opacity:0.6'>暂未切换形态</span>";
                    // --- 构建 infoHtml ---
            ...
            mark: true,
            marktext: "尘",
            group: ['xinxguichen_gain', "xinxguichen_handler",],
            subSkill: {
                /* handler: {
                    init(player, skill) {
                        ...
                        if (realCards.length) {
                            ...
                            fakes.forEach((fake, i) => {
                                fake.classList.add('red-flowing-card');
                                const owner = get.owner(realCards[i]);
                                if (fake.node && fake.node.gaintag && owner) {
                                    fake.node.gaintag.innerHTML = owner.getName();
                                }
                            });
                    ...
                    filter(event, player) {
                        if (["useCard", "respond"].includes(event.name)) {
                            if (event.player !== player) return false;
                            const fakeCards = player.getCards("s", card => card.hasGaintag("xinxguichen"));
                            return event.cards && event.cards.some(card => fakeCards.includes(card));
                        }
                        return true;
                    },
                    async content(event, trigger, player) {
                        ...
                        if (["useCard", "respond"].includes(trigger.name)) {
                            ...
                            for (let i = 0; i < trigger.cards.length; i++) {
                                const fakeCard = trigger.cards[i];
                                if (fakeCard.hasGaintag("xinxguichen")) {
                                    const realCard = realCards.find(sc => sc.cardid == fakeCard._cardid);
                                    if (realCard) {
                                        trigger.cards[i] = realCard;
                                        if (trigger.card && Array.isArray(trigger.card.cards)) {
                                            const idx = trigger.card.cards.indexOf(fakeCard);
                                        ...
                                        realCardsToMove.push(realCard);
                                    }
                                }
                            }
                            // 剥离：强制原主人失去这些牌（特别是装备区）
                            for (const rcard of realCardsToMove) {
                                const owner = get.owner(rcard);
                                if (owner) {
                                    const equips = owner.getCards('e');
                                    const targetEquip = equips.find(e => e === rcard || (e.cards && e.cards.includes(rcard)));
                                    if (targetEquip) {
                                        await owner.lose(targetEquip, ui.special, 'visible');
                                    } else {
                                        await game.cardsGotoSpecial([rcard]);
                                    }
                                }
                            }
                        }
                        // 场上的牌动了，增量更新同步假牌
                            ...
                            let realCards = get.info("xinxguichen").getCards(player);
                            const currentFakes = player.getCards("s", card => card.hasGaintag("xinxguichen"));
                            //场上已经没有了，销毁假牌
                            const fakesToRemove = currentFakes.filter(fake => !realCards.some(real => real.cardid == fake._cardid));
                            if (fakesToRemove.length) {
                                game.deleteFakeCards(fakesToRemove);
                            }
                            // 场上新上的装备/判定，印发假牌
                            const realsToAdd = realCards.filter(real => !currentFakes.some(fake => fake._cardid == real.cardid));
                            if (realsToAdd.length) {
                                const fakes = game.createFakeCards(realsToAdd);
                                player.directgains(fakes, null, "xinxguichen");
                                fakes.forEach((fake, i) => {
                ...
                handler: {
                    onChooseToUse(event) {
                        ...
                        if (shownCards.length) {
                            const fakes = game.createFakeCards(shownCards);
                            fakes.forEach(card => card.classList.add('red-flowing-card'));
                            player.directgains(fakes, null, "xinxguichen");
                            // 遍历生成的假牌，将右上角的标签改为原拥有者的名字
                            for (let i = 0; i < fakes.length; i++) {
                                const fake = fakes[i];
                ...
                gain: {
                    ...
                    filter(event, player, name, target) {
                        ...
                        /* if (event.getParent(e => e.skill === 'xinxguichen')) {
                            return false;
                        } */
                        /* const useEvt = event.getParent('useCard');
                        if (event.name === "lose" && useEvt) {
                            const lostInfo = event.getl(target);
                            const lostEquips = (lostInfo && lostInfo.es) || [];
                            // 如果失去的装备，是当前使用事件中被打出去的牌
                            if (useEvt.cards && useEvt.cards.some(c => lostEquips.includes(c))) {
                                return false;
                            }
                        } */
                    ...
                    async content(event, trigger, player) {
                        ...
                        await player.gain(equipCardsLost, 'gain2');
        ...
        xinxlingxiao: {
            ...
            usable(skill, player) {
                if (player.storage.xinxmingxinx) {
                    return Math.max(player.countMark('xinxguichen'), 1);
                }
                return 100;
            },
            async content(event, trigger, player) {
                ...
                const randomAvatars = availableChars.randomGets(cards.length);
                ...
                for (const card of cards) {
                    ...
                    if (subtype) {
                        ...
                        await target.lose(card, ui.discardPile, 'visible');
                    }
                }
                ...
                if (xcards.length >= 4) {
                    if (!player.storage.xinxmingxinx) {
                        ...
                        const result = await player.chooseCardButton(target, xcards, [1, num], `凌霄：你可以弃置${get.translation(target)}非手牌区至多${num}张牌，对其造成等量伤害并退幻`)
                            .set("ai", button => {
                                return get.value(button.link);
                            })
                            .forResult();
                        if (result?.bool && result?.links) {
                            ...
                            //const playEndVideo = lib.config['extension_永夜之境_yeshunguang_end_video'];
                            //if (playEndVideo !== false) {
                            await new Promise(resolve => {
                                lib.element.content.xinxplayVideo(
            ...
            subSkill: {
                ...
                ying: {
                    mod: {
                        ...
                        aiUseful(player, card, num) {
                            if (get.name(card, player) === "ying" && !player.hasSkill("xinxmosuo")) {
                                return 16;
                            }
                        },
                    }
        ...
        xinxnewxinzhui: {
            ...
            filter(event, player) {
                return game.hasPlayer(current => current.countCards("he") && current !== player) && player.hasUseTarget({ name: 'huogong', isCard: true });
            },
            xiandingji: true,
            check(event, player) {
                if (!player.hasCard(card => get.color(card) === 'red', 'h') || !player.hasCard(card => get.color(card) === 'black', 'h')) {
                    return false;
                }
                return game.hasPlayer(current => get.attitude(player, current) < 0 && player.canUse({ name: 'huogong' }, current));
            },
            async content(event, trigger, player) {
                await player.chooseUseTarget({ name: 'huogong', isCard: true, storage: { xinxnewxinzhui: true } }, true)
                    .set("ai", target => {
                        let player = get.player();
                        if (get.attitude(player, target) > 0) {
                            return 0;
                ...
                huogong
                    ...
                    async content(event, trigger, player) {
                        trigger.set("chooseToShow", async (event2, player2, target) => {
                            ...
                            const res = await target.chooseToDiscard("h", true, "选择【火攻】要弃置的牌")
                                .set("ai", card => {
                                    return 8 - get.value(card);
                                }).forResult();

                            if (res.bool && res.cards && res.cards.length) {

                                return { bool: true, cards: res.cards };
                            }
                        ...
                        trigger.set("chooseToDiscard", async (event2, player2, target) => {
                            ...
                            const { cards2 } = event2;
                            if (!cards2 || !cards2.length) return { bool: false };

                            const targetColor = get.color(cards2[0]);
                            const filterRecast = (card) => get.color(card) === targetColor;

                            const res2 = await player2.chooseCard("h", filterRecast)
                                //.set("prompt", `是否重铸一张${get.translation(targetColor)}手牌，令【火攻】对${get.translation(target)}造成伤害？`)
                                .set("prompt", false)
                                .set("ai", card => {

                                    if (get.damageEffect(target, player2, player2, "fire") > 0) {
                                        return 8 + Math.min(4, player2.hp) - get.value(card, player2);
                                    }
                                    return -1;
                                }).forResult();

                            if (res2.bool && res2.cards && res2.cards.length) {
                                await player2.recast(res2.cards);
                                return { bool: true };
                            }
                            return { bool: false };
                        });
                        /* trigger.setContent(async function (event) {
                            ...
                            if (target.node.avatar) {
                                target.node.avatar.classList.add('full-body-fire-effect');
                            }
                            ...
                            if (res1.bool && res1.cards && res1.cards.length) {
                                ...
                                if (res2.bool && res2.cards && res2.cards.length) {
                                    ...
                                    await target.damage("fire");
                                    target.node.avatar.classList.remove('full-body-fire-effect');
                                }
                            }
                        }); */
                    },
        ...
        xinxnewyingshi: {
            ...
            check(event, player) {
                ...
                return player.hp > 1 || (player.countCards("h", "tao") || player.countCards("h", "jiu"));
            },
            async content(event, trigger, player) {
        ...
        xinxxuanren: {
            ...
            async cost(event, trigger, player) {
                event.result =
                    await player.chooseToRespond((card, player) => { return get.name(card) == "sha" })
            ...
            async content(event, trigger, player) {
                ...
                game.log(trigger.card, "被", player, "抵消");
                trigger.neutralize();
                await player.draw();
