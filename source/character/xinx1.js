...
export let info = {
    ...
    characterSort: {
        xinx1: {
            ...
            //'xuandiesheji': ['xinx_hanzhuo', 'xinxzhuowenjun'],
    ...
    character: {
        ...
        xinx_simashi: ["male", "wei", 3, ['xinxqianlong', 'xinxyini', 'xinxchenlan'], ["border:qun", 'legend']],
    ...
    characterTitle: {
        ...
        xinxzhu_hanfu: '<font color=#C4B1FB>临晓却步</font>',
        xinxnew_zhonghui: '<font color=#A0B2DF>潜蛟觊天</font>',
        xinx_yanrou: '<font color=#F6D29C>度辽霜止</font>',
        xinxying_zhangliao: '<font color=#AEA5CA>醉刃同斟</font>',
    },
    characterSubstitute: {//皮肤切换
        ...
        xinxzhu_caocao: [
            ...
            //['xinxzhu_caocao_shadow',['ext:永夜之境/image/'+karimcop+'/xinxzhu_caocao_shadow.png']],
        ],
        xinx_caoxian: [
        ...
        xinxnew_zhonghui: [
            ['xinxnew_zhonghui_shadow', ['ext:永夜之境/image/xinx_zhonghui_shadow.png']],
        ],
    },
    //翻译
    translate: {
        ...
        xinx_duyu_prefix: '杏',
        xinxzhu_hanfu: '逐韩馥',
        xinxzhu_hanfu_prefix: '逐',
        xinxzhu_liubei: '逐刘备',
        xinxzhu_liubei_prefix: '逐',
        xinx_yanrou: '杏阎柔',
        ...
        xinxzhu_simashi: '逐司马师',
        xinxzhu_simashi_prefix: '逐',
        xinxnew_zhonghui: '杏钟会',
        xinxnew_zhonghui_prefix: '杏',
        xinxzhu_sunshangxiang: '逐孙尚香',
        xinxzhu_sunshangxiang_prefix: '逐',
        ...
        xinxyinghuanren: '焕刃',
        xinxyinghuanren_info: `①每轮开始时，你可以视为使用无距离限制的［【杀】］。②你造成伤害后，选择你与受伤角色的一张牌，若此牌有合法目标，你将之加入${get.poptip('xinxyinghuanren')}的[]中，否则你获得之并令本技能本回合失效。`,
        xinxcongfeng: '从风',
        xinxcongfeng_info: '锁定技，你于出牌阶段的可用牌名范围为你上家本轮使用过的牌名。你于本阶段使用牌无距离次数限制，每使用一张牌便摸两张牌，若无牌可用，你结束本回合。',
        xinxchouhuang: '踌惶',
        xinxchouhuang_info: `每轮限一次，当你成为其他角色使用牌的目标后，你可以将半数向上手牌交给一名其他角色并令此牌对你无效，然后交出牌的牌名不受${get.poptip('xinxcongfeng')}限制。`,
        xinxlianlin: '敛麟',
        ...
        xinxsaran: '飒然',
        xinxsaran_info: `准备阶段，你可以选择你与一名其他角色至多各五张牌，将之置入各自的装备区。然后你重铸因此被顶替或未置入装备区的牌。`,
        xinxnigong: '逆弓',
        xinxnigong_info: `你不因本技能使用牌指定其他角色为唯一目标或成为其他角色使用牌的目标时，你可以将你/其装备区的一张牌当【无中生有】/火【杀】使用（无距离限制）。`,
        dz_xing_yinxi: "吟兮",
        ...
        xing_xingyu_info: "锁定技。①准备阶段，你将牌堆顶X张牌（X为场上存活其他角色数）标记为“星落”，并令所有其他角色随机以一张非“星落”手牌交换。②“星落”仅你可使用或打出。当你获得牌时，将其标记为“星落”。",
        xing_ningshuang: "凝霜",
        xing_ningshuang_info: `转换技。一名角色的回合结束时，若你本回合使用过基本牌，则你可以：阳，观看一名角色的手牌并获得其区域一张牌，然后将其随机一张非“星落”手牌标记为“星落”；阴，令${get.poptip('xinx_ewaidepai')}+1且获得${get.poptip('xing_zhupo')}直到再次发动此技能。`,
        xing_zhupo: "铸魄",
        ...
        xxxzhenxi: "震袭",
        xxxzhenxi_info: "锁定技，每回合限一次。当你对其他角色造成伤害时，你可以获得其武将牌上的一个技能，然后其失去此技能。当其对你造成伤害后，你为其恢复一个以此法失去的技能。",
        xxxzhenxi1: "金焕刃",
        ...
        xinxshiren: "识人",
        xinxshiren_info: "锁定技。每回合限两次。每轮开始时或当你造成伤害后，若你以此法获得的技能数不大于3，你从五张武将牌中选择一个技能获得之。回合结束时，你可以失去任意个以此法获得的技能，然后摸等量的牌。",
        xinxqianqiu: "千秋",
        ...
        xinxquanmou: "权谋",
        xinxquanmou_info: "每轮限一次。其他角色的结束阶段，若其本回合于摸牌阶段外获得的牌不小于其体力值，你加1点体力上限，获得一个额外回合，并令手牌上限和额定摸牌数+1。",
        xinxwugui: "无归",
        xinxwugui_info: `觉醒技。当你令一名其他角色进入濒死状态时，你减1点体力上限，获得技能${get.poptip('xinxwuyi')}。`,
        xinxwuyi: "诬异",
        ...
        xinxrenshi: '任势',
        xinxrenshi_info: "每回合限一次。当你使用牌指定其他角色为唯一目标后，你观看其手牌，使用其中一张牌。若未使用牌，你弃置所有手牌。",
        xinxchushi: '出师',
        xinxchushi_info: `限定技。出牌阶段，你可以选择一名角色。你减1点体力上限，从${get.poptip('xinxchushid')}/${get.poptip('xinxchushi_draw')}/${get.poptip('xinxchushi_lose')}中选择未选择过的一项，然后其获得此技能。`,
        'xinxchushi_damage': '北定',
        'xinxchushi_damage_info': '当你每回合首次造成伤害时，此伤害+1。',
        'xinxchushi_draw': '整驽',
        'xinxchushi_draw_info': '准备阶段或结束阶段，你摸一张牌，然后重铸一张牌。',
        'xinxchushi_lose': '攘奸',
        'xinxchushi_lose_info': '每轮开始时，你失去1点体力。若为偶数次发动此技能，则减少1点体力上限。',
        'xinxchushid': '北定',
        'xinxchushid_info': '当你每回合首次造成伤害时，此伤害+1。当你受到大于1的伤害时，此伤害改为1。',
        xinxxzhaohan: '昭汉',
        xinxxzhaohan_info: "锁定技。牌堆顶的X张牌始终对你可见（X为你的体力值）。每轮限X次，你可以将牌堆顶的X张牌如手牌般使用或打出。",
        xinxyinshi_tag: '死士',
        xinxruilue_tag: '对方的牌',
        xinxruilue: '睿略',
        ...
        xinxyinshi: '阴士',
        xinxyinshi_info: '①每回合限一次。当你使用或打出基本牌和普通锦囊牌时，你可获得一张此牌的复制和一张【影】。②你以此获得的牌不计入手牌上限。当其离开你的手牌区时，将其移出游戏。',
        ...
        xinxqianyi_tag: '潜翼',
        xinxquanbian: '权变',
        xinxquanbian_info: "限定技，其他角色的回合开始时，若你手牌中因〖潜翼〗获得的牌不小于3张，你可以执行一个额外的出牌阶段，并获得场上一张牌。此后你使用“潜翼”牌指定其他角色为目标后，其弃置一张红色手牌。",
        ...
        xinxzengren: '赠刃',
        xinxzengren_info: `锁定技。①游戏开始时，你选择一项：1.令一名其他角色获得${get.poptip('xinxzengren_lose')}，然后你失去之；2.将${get.poptip('jinhuanren')}置入装备区。②当你失去装备区的武器牌时，若你的武器栏为空，你将一张${get.poptip('jinhuanren')}置入装备区。`,
        xinxzengren_lose: '赠刃',
        xinxzengren_lose_info: `锁定技。①游戏开始时，你将${get.poptip('jinhuanren')}置入装备区。②当你失去装备区的武器牌时，若你的武器栏为空，你将一张${get.poptip('jinhuanren')}置入装备区。`,
        '#ext:永夜之境/audio/xinxzengren1': '君携此焕刃，可解燃眉之危。',
        '#ext:永夜之境/audio/xinxzengren2': '灯火灼烁酒微映，与君同醉，此情可寄夜雨时。',
        xinxshunhua: '舜华',
        xinxshunhua_info: "每回合限一次。当有角色使用虚拟牌时，你可以选择一名其他角色，并从牌堆或弃牌堆中获得3-X张类型各不相同的牌（X为本局游戏此技能的已发动次数，至多为2），然后你选择一项：<br>1.令其执行与你同样的操作；<br>2.令其弃置一种类型的所有手牌。",
        ...
        xinxbugui: '不归',
        xinxbugui_info: `觉醒技。结束阶段，若场上有“伐”的角色数大于1，你减1点体力上限，获得技能${get.poptip('xinxpixing')}。`,
        ...
        xinxjishi: '犄势',
        xinxjishi_info: "锁定技，当一名角色不因本技能使用不为其手牌区的牌时，你视为使用一张同名牌（无距离限制）。",
        '#ext:永夜之境/audio/xinxjishi1': '筹谋部划，知天机，行人事。',
        '#ext:永夜之境/audio/xinxjishi2': '兵法谙熟于胸，今乃施为之时。',
        xinxxinlue: '心略',
        xinxxinlue_info: "每回合限一次，当你成为牌的目标时，你可以观看当前回合角色手牌并可以重铸其一张牌，然后你可以使用此牌（无距离限制）。",
        ...
        xinxweixi: '未息',
        xinxweixi_info: "锁定技。①回合开始前，你获得一张【影】，然后将任意张牌置于牌堆底并摸等量的牌。②每回合限一次。你可以展示手牌中的【影】，视为使用一张基本牌。",
        ...
        xinxquanpao_tag: '权',
        xinxquanpao: '权袍',
        xinxquanpao_info: "摸牌阶段结束时，你从游戏外创造X张【影】并置于牌堆顶（X为你的手牌上限），从牌堆或弃牌堆中获得X张牌名各不相同的牌，将其标记为“权”，然后获得位于弃牌堆/牌堆/一名角色区域内的所有“权”。",
        ...
        xinxzhenying: '砧影',
        xinxzhenying_info: "隐匿技。你于其他角色的回合登场时，你可对当前回合的角色造成1点伤害。若如此做，你下次受到来自其造成的伤害时，其摸两张牌。",
        '#ext:永夜之境/audio/xinxzhenying1': '佳燕并头语，不恋雕梁而归于万里。',
        '#ext:永夜之境/audio/xinxzhenying2': '灵禽非醴泉不饮，非积善之家不栖。',
        xinxzhebian: '蛰变',
        xinxzhebian_info: "锁定技。回合结束时，你进入隐匿状态。当你的武将牌状态变化时，你可以对一名角色造成1点伤害，然后其摸一张牌。",
        ...
        xinxyanhui: '雁徊',
        xinxyanhui_info: "锁定技。出牌阶段开始时，你可以重铸至多两张牌。若这些牌的牌名均不相同，你可以使用其中任意张牌。",
        xinxduanzhi: '断织',
        xinxduanzhi_info: "其他角色的结束阶段，你可以令一名角色使用当前回合角色本回合使用的且进入弃牌堆的牌（至多使用2张），然后当前回合角色选择获得剩余的一张牌。",
        xinxjinshu: '锦书',
        xinxjinshu_info: `锁定技。当你受到伤害后，你获得“念”。结束阶段，你可以移去“念”并发动${get.poptip('xinxduanzhi')}。`,
        xinxqueyi: '阙弈',
        xinxqueyi_info: "锁定技。当你成为其他角色使用实体牌的目标时，你将此牌扣置于武将牌上并与其各摸一张牌。若其本回合因此获得的牌数大于2，你观看其手牌，获得其一张牌。",
        xinxshexin: '摄衅',
        xinxshexin_info: "判定阶段开始时，你可以展示武将牌上任意张牌，然后令一名其他角色选择一项：<br>1.将展示的牌置入牌堆，然后交给你所有手牌；<br>2.令你弃置其等量张牌，并使用展示的牌。<br>执行完毕后，你将未展示的牌置入弃牌堆。",
        xinxjinmian: '晋冕',
        xinxjinmian_info: `出牌阶段开始时，若你本回合使用的牌数大于体力值或造成过伤害，你变更势力为晋，获得技能${get.poptip('xinxsukan')}和${get.poptip('xinxbingjun')}直到回合结束。`,
        xinxsukan: '肃戡',
        ...
        xinxbingjun: '秉钧',
        xinxbingjun_info: "你的回合内，当有角色死亡后，你摸两张牌，并令〖肃戡〗视为未发动过。",
        xinxzhiyi: '知懿',
        xinxzhiyi_info: "游戏开始时，你摸两张牌。当你失去牌时，若你的手牌区没有因本技能获得的牌，你摸两张牌。",
        xinxzhiyi_tag: '知懿',
        xinxshenai: '蜃霭',
        ...
        xinxjuyan: '踞兖',
        xinxjuyan_info: "每回合限一次。当你使用【杀】指定其他角色为目标后，你令其将两张非伤害牌置于你的武将牌上，称为“青州”。结束阶段或当你进入濒死状态时，你可以选择获得武将牌上的至多X张牌（X为你的体力上限）。",
        xinxqianjun_card: '千军',
        xinxqianjun_eff: '千军',
    ...
    dynamicTranslate: {
        xing_ningshuang(player) {
            ...
            let str = '转换技，一名角色的回合结束时，若你本回合使用过基本牌，则你可以：';
            if (!storage) str += '<span class="bluetext">';
            str += '阳，观看一名角色的手牌并获得其区域一张牌，将其随机一张非“星落”手牌标记为“星落”；';
            if (!storage) str += '</span>';
            if (storage) str += '<span class="bluetext">';
            str += `阴，令${get.poptip('xinx_ewaidepai')}+1且获得〖铸魄〗直到再次发动此技能。`;
            if (storage) str += '</span>';
            return str;
        },
        xinxshenai(player) {
            const storage = player.storage.xinxshenai;
            let str = '转换技，当你受到伤害后，你须：';
            if (!storage) str += '<span class="bluetext">';
            str += '阳，重铸一张牌；';
            if (!storage) str += '</span>';
            if (storage) str += '<span class="bluetext">';
        ...
        xinxnewquanmou(player) {
            if (player.storage.xinxnewwuguix) return lib.translate.xinxnewquanmoux_info;
            return lib.translate.xinxnewquanmou_info;
        },
        xinxpanzhi(player) {
        ...
        xinxyunjue(player) {
            ...
            return "锁定技。①你无法响应其他角色使用的牌。②其他角色A对你使用牌时，你可以选择一名不为A的角色一张牌并令A获得之，然后你摸一张牌。若此效果的发动次数大于3次，你修改〖韫决〗。";
        },
        ...
        xinxzisui(player) {
            let str = [
                "结束阶段，你可以选择一名其他角色并选择一项：",
                "1.令其摸X张牌；",
                "2.令其回复X点体力；",
                "3.令其将X张手牌当【决斗】对你使用，否则你与其各失去1点体力。",
                "然后你移除此选项。当所有选项移除后，你减4点体力上限（X为场上牌数）。"
            ]
        ...
        xinxyinghuanren(player) {
            const storage = player.getStorage('xinxyinghuanren');
            let cardNames = "无";
            if (storage && storage.length > 0) {
                cardNames = storage.map(item => {
                    let nameStr = get.translation(item.name);
                    if (item.nature) {
                        nameStr = get.translation(item.nature) + nameStr; // 变成 火杀
                    }
                    return '【' + nameStr + '】';
                }).join("、");
            }
    ...
    //武将替换
    characterReplace: {
        xinx_jiangwei: ['xinx_jiangwei', 'xinshu_jiangwei', 'xinxying_jiangwei'],
        xinx_zhonghui: ['xinx_zhonghui', 'xinxying_zhonghui'],
        xinx_simayi: ['xinx_simayi', 'xinxying_simayi'],
        xinx_simashi: ['xinx_simashi', 'xinxyin_simashi'],
        xinx_zhangliao: ['xinx_zhangliao', 'xinwei_zhangliao', 'xinxzhu_zhangliao'],
        xinx_zhugeliang: ['xinx_zhugeliang', 'xinxshu_zhugeliang'],
        xinx_caocao: ['xinx_caocao', 'xinxzhu_caocao'],
        xinx_zhaoyun: ['xinx_zhaoyun', 'xinxzhu_zhaoyun'],
    ...
    skill: {
        ...
        xinxyufu: {
            ...
            mod: {
                aiOrder(player, card, num) {
                    if (typeof card == "object") {
                        ...
                        if (evt?.card && get.color(evt.card) == "black" && !evt.xinxyufu && ['basic', 'trick'].includes(get.type(card))) {
                            return num + 10;
                        }
                        if (evt && get.color(evt.card) == "black" && get.info(card).filterTarget) {
                            return num + 10;
                        }
                    }
                },
            ...
            filter(event, player) {
                ...
                if (!player.countCards("he") && !game.hasPlayer(current => current.countCards("he") && event?.targets.includes(current))) {
                    return false;
                }
                const evt = lib.skill.dcjianying.getLastUsed(player, event);
                if (!evt || !evt.card || evt.xinxyufu) {
                    return false;
                }
                return get.color(evt.card) == "black" && event.targets?.length;
            },
            locked: false,
            ...
            async content(event, trigger, player) {
                ...
                const dialog =
                    ui.create.dialog(
                        `###${get.prompt(event.name)}###<div class="text center">选择你与${get.translation(target)}至多共${num}张牌，替换为【影】</div>`,
                        ...targets
                            .map(target => {
                                let list = [],
                ...
                const result2 = await player.chooseButton(dialog, [1, num])
                    .set('ai', button => {
                ...
                if (result2?.bool && result2.links?.length) {
                    ...
                    result2.links.forEach(card => {
                        if (get.owner(card) === target) tCards.push(card);
                        else pCards.push(card);
                    });
                    if (pCards.length) {
                        await player.loseToDiscardpile(pCards);
                        await player.gain(lib.card.ying.getYing(pCards.length), "gain2");
                    }
                    if (tCards.length) {
                        await target.loseToDiscardpile(tCards);
                        await target.gain(lib.card.ying.getYing(tCards.length), "gain2");
                    }
                }
            },
            init(player, skill) {
                player.addSkill(skill + "_mark");
                game.addGlobalSkill("xinxyufu_effect");
                game.broadcastAll(() => {
                    if (lib.card.ying.destroy) delete lib.card.ying.destroy;
                    lib.translate.ying_info = '';
                });
            },
            ...
            subSkill: {
                mark: {
                    init(player, skill) {
                        const evt = lib.skill.dcjianying.getLastUsed(player);
                        if (evt?.card && get.color(evt.card) == "black" && !evt.xinxyufu) {
                            player.addTip(skill, "迂覆 可连击");
                        }
                    },
                    onremove(player, skill) {
                    ...
                    async content(event, trigger, player) {
                        if (event.triggername == "useCard1") {
                            if (get.color(trigger.card) == "black") {
                                player.addTip(event.name, "迂覆 可连击");
                            } else {
                                player.removeTip(event.name);
                            }
                        } else if (trigger.xinxyufu) {
                            player.removeTip(event.name);
                        }
                    },
                },
                effect: {
                    mod: {
                        ...
                        aiOrder(player, card, num) {
                            if (player.hasSkill('xinxyufu') && get.name(card, player) == "ying") {
                                return 6;
                            }
                        },
        ...
        xinxliangye: {
            derivation: 'xinxyinghuanren',
            audio: "ext:永夜之境/audio:6",
            logAudio: index => (typeof index === "number" ? `ext:永夜之境/audio/xinxliangye${index}.mp3` : 2),
            enable: ["chooseToUse"],
            hiddenCard(player, name) {
                if (!lib.inpile.includes(name)) {
                    return false;
                }
                if (player.getStorage("xinxliangye_used").includes(name)) {
                    return false;
                }
                const type = get.type(name);
                if (type === "basic") {
                    return player.countCards("hse", card => get.name(card) == 'ying') > 1;
                }
                if (type === "trick") {
                    return player.countCards("hse", card => get.name(card) == 'ying') > 0;
                }
                return false;
            },
            popup: false,
            filter(event, player) {
                if (!player.countCards("hse", card => get.name(card) == 'ying')) {
                    return false;
                }
                const hasone = player.countCards("hse", card => get.name(card) == 'ying') > 0;
                const hastwo = player.countCards("hse", card => get.name(card) == 'ying') > 1;
                ...
                /* return get.inpileVCardList(info => ['basic', 'trick'].includes(get.type(info[2]))).some(card => {
                    ...
                    if (type === "basic" && !hastwo) return false;
                    if (type === "trick" && !hasone) return false;
                ...
                return get
                    .inpileVCardList(info => {
                        ...
                        if (type === "basic" && !hastwo) return false;
                        if (type === "trick" && !hasone) return false;
                        return !player.getStorage("xinxliangye_used").includes(name);
                    })
            ...
            chooseButton: {
                dialog(event, player) {
                    ...
                    const hastwo = player.countCards("hse", card => get.name(card) == 'ying') > 1;
                    const list = get.inpileVCardList(info => {
                        if (player.getStorage("xinxliangye_used").includes(info[2])) {
                            return false;
                        }
                        const type = get.type(info[2]);
                        if (type === "basic" && hastwo) return true;
                        if (type === "trick" && hasone) return true;
                        return false;
                    }).filter(card => {
                        return event.filterCard({ name: card[2], nature: card[3], isCard: true }, player, event);
                    });
                    return ui.create.dialog("良夜", [list, "vcard"]);
                },
                check(button) {
                ...
                backup(links, player) {
                    return {
                        ...
                        selectCard() {
                            const viewName = lib.skill.xinxliangye_backup.viewAs.name;
                            const type = get.type(viewName);
                            const player = get.player();
                            if (type === "basic") {
                                return [2, 2];
                            }
                        ...
                        async precontent(event, trigger, player) {
                            player.addTempSkill("xinxliangye_used");
                            player.markAuto("xinxliangye_used", [event.result.card.name]);
                            const type = get.type(event.result.card.name);

                            if (type === "basic") {
                                player.logSkill("xinxliangye", null, null, null, [get.rand(1, 3)]);
                            } else {
                                player.logSkill("xinxliangye", null, null, null, [get.rand(4, 6)]);
                                await player.removeSkills('xinxyinghuanren');
                                await player.addSkills('xinxyinghuanren');
                            }


                            player.when({ player: ["useCardAfter", "respondAfter"] })
                                .filter(evt => evt.getParent() == event.getParent())
                                .step(async (event, trigger, player) => {
                                    if (type === "basic") {
                                        player.addSkills('xinxyinghuanren');
                                        const next = game.createEvent("xinxyinghuanren" + event.name);
                                        next.player = player;
                                        next.setContent(lib.skill.xinxyinghuanren.content);
                                        await next;
                                    }
                                    /* else {
                                        await player.removeSkills('xinxyinghuanren');
                ...
                prompt(links, player) {
                    ...
                    const actionStr = type === "basic" ? "两张" : "一张";
                    return `将${actionStr}【影】，当作` + (get.translation(links[0][3]) || "") + "【" + get.translation(links[0][2]) + "】" + "使用";
                },
            },
            ai: {
                combo: "xinxyuxi",
        ...
        xinxyinghuanren: {
            ...
            logAudio: index => "ext:永夜之境/audio/xinxyinghuanren" + (typeof index === "number" ? index : get.rand(3, 4)) + ".mp3",
            init(player, skill) {
                player.markAuto(skill, { name: 'sha' });
            },
            onremove(player, skill) {
            ...
            forced: true,
            async content(event, trigger, player) {
                let cards = player.getStorage('xinxyinghuanren');
                if (cards.length > 1) {
                    let hcards = cards.map(item => game.createCard({
                        name: item.name,
                        nature: item.nature,
                        isCard: true
                    }));
                    while (hcards.some(card => player.hasUseTarget(card)) && hcards.length > 0) {
                        const result2 = await player.chooseButton([`焕刃：选择要视为使用的牌`, [hcards, 'vcard']])
                        ...
                        if (result2?.bool && result2.links?.length > 0) {
                            ...
                            await game.delayx();
                            await player.chooseUseTarget(cardx, true, false, "nodistance");
                        } else {
                            break;
                        }
                    }
                } else {
                    player.chooseUseTarget({ name: "sha" }, `###${get.prompt("jinhuanren")}###视为使用一张无距离限制的【杀】`, false, "nodistance");
                }
            },
            markimage: 'extension/永夜之境/image/card/jinhuanren.png',
            intro: {
                ...
                mark(dialog, storage, player) {
                    ...
                    dialog.addText('<div class="text center" style="font-size:18px; font-weight:bold; padding:5px; margin-top:15px; border-bottom:1px solid rgba(128,128,128,0.3)">🎴金焕刃</div>');
                    ...
                    for (let name of lib.inpile) {
                        ...
                        allCards.push({ name: name });
                        if (name === 'sha' && lib.inpile_nature) {
                            for (let nat of lib.inpile_nature) {
                                allCards.push({ name: name, nature: nat, isCard: true });
                            }
                        }
                        //}
                    }
                    //const recordedNames = (storage || []).map(item => item.name);
                    const recorded = storage || [];
                    if (allCards.length) {
                        dialog.addSmall([allCards, 'vcard']);
                        dialog.buttons.forEach(btn => {
                            let cardName = '';
                            let cardNature = undefined;
                            ...
                            if (typeof btn.link === 'string') {
                                ...
                                cardName = btn.link.name;
                                cardNature = btn.link.nature;
                            } else if (Array.isArray(btn.link)) {
                                cardName = btn.link[2];
                                cardNature = btn.link[3]; //数组牌格式: [花色, 点数, 牌名, 属性]
                            }
                            const isMatched = recorded.some(item => {
                                return item.name === cardName && item.nature === cardNature;
                            });
                            if (isMatched) {
                                btn.style.opacity = '1';
                                btn.style.filter = 'none';
            ...
            subSkill: {
                add: {
                    ...
                    filter(event, player) {
                        return event.player.countCards("he") || player.countCards('he');
                    },
                    forced: true,
                    popup: false,
                    async content(event, trigger, player) {
                        ...
                        const dialog =
                            ui.create.dialog(
                                `###${get.prompt(event.name)}###<div class="text center">选择你与${get.translation(target)}的一张牌，将之加入${get.poptip('xinxyinghuanren')}</div>`,
                                ...targets
                                    .map(target => {
                                        let list = [],
                                            cards = target.getCards("h"),
                        ...
                        const result2 = await player.chooseButton(dialog, 1, true)
                            .set('ai', button => {
                                const card = button.link;
                                const num = ui.selected.buttons.length;
                                const owner = get.owner(card) || target;
                                const val = get.value(card);
                                const use = player.getUseValue(card);
                                if (owner === target) {
                                    let count = 0;
                                    count += val;
                        ...
                        if (result2?.bool && result2.links?.length) {
                            const card = result2.links[0];
                            player.logSkill("xinxyinghuanren", [target], null, null, [get.rand(1, 2)]);
                            if (get.info(card).filterTarget) {
                                const vcard = {
                                    name: card.name,
                                    nature: card.nature,
                                    isCard: true,
                                };
                                await player.markAuto("xinxyinghuanren", vcard);
                            } else {
                                //await player.loseHp();
                                await player.gain(card, "gain2");
                                await player.tempBanSkill("xinxyinghuanren")
                            }
                        }
                    }
                }
        ...
        xinxcongfeng: {
            ...
            async content(event, trigger, player) {
                ...
                const num1 = Math.max(5, num);
                if (trigger.name == "phaseUse") {
                    player.addTempSkill("xinxcongfeng_use", 'phaseChange');
                } else {
                    await player.draw(2);
                }
            ...
            mod: {
                cardEnabled(card, player) {
                    let stroage = player.getStorage("xinxcongfeng");
                    let stroage1 = player.getStorage("xinxchouhuang");
                    if (player.isPhaseUsing()) {
                        if (!stroage.includes(card.name) && !stroage1.includes(card.name)) {
                            return false;
                        }
                    }
                },
            ...
            group: ['xinxcongfeng_record', 'xinxcongfeng_use'],
            subSkill: {
                use: {
                    charlotte: true,
                    mod: {
                ...
                record: {
                    ...
                    filter(event, player) {
                        if (player.getStorage("xinxcongfeng").includes(event.card.name)) {
                            return false;
                        }
                        return event.player == player.getPrevious();// || event.player == player.getNext()
                    },
                    silent: true,
                    async content(event, trigger, player) {
                        player.markAuto("xinxcongfeng", [trigger.card.name]);
                        player.when({ global: "roundStart" })
                            //player.when("phaseAfter")
                            .step(async (event, trigger, player) => {
                                player.removeStorage("xinxcongfeng");
                            });
                    },
                }
            },
            ...
            intro: {
                ...
                mark(dialog, storage, player) {
                    ...
                    dialog.addText('<div class="text center" style="font-size:18px; font-weight:bold; padding:5px; margin-top:15px; border-bottom:1px solid rgba(128,128,128,0.3)">🎴可用牌名</div>');
                    const allCards = lib.inpile.filter(name => {
                        return name;
                    });
                    const recorded = storage || [];
                    const recorded2 = player.getStorage("xinxchouhuang") || [];
                    if (allCards.length) {
                        dialog.addSmall([allCards, 'vcard']);
                        dialog.buttons.forEach(btn => {
                            let cardName = '';
                            ...
                            if (recorded.includes(cardName) || recorded2.includes(cardName)) {
                                btn.style.opacity = '1';
                                btn.style.filter = 'none';
                                btn.style.boxShadow = '0 0 8px rgba(255, 215, 0, 0.8)';
                            } else {
        ...
        xinxchouhuang: {
            ...
            round: 1,
            filter(event, player) {
                if (player.hasSkill("xinxchouhuang_used") || player == event.player) return false;
                return player.countCards('h');
            },
            async cost(event, trigger, player) {
                let num = Math.ceil(player.countCards('h') / 2);

                const aiButton = ui.create.control("AI代选", function () {
                    // 当玩家点击按钮时，游戏正暂停在 chooseCardTarget 事件里
                    let evt = _status.event;
                    // 如果玩家反复点击，先清空之前的选择，避免数据叠加
                    while (ui.selected.targets.length) {
                        ui.selected.targets[0].classList.remove('target');
                        ui.selected.targets.shift();
                    }
                    while (ui.selected.cards.length) {
                        ui.selected.cards[0].classList.remove('selected');
                        ui.selected.cards[0].updateTransform(false);
                        ui.selected.cards.shift();
                    }
                    // AI选牌选人
                    if (evt.ai1) ai.basic.chooseCard(evt.ai1);
                    if (evt.ai2) ai.basic.chooseTarget(evt.ai2);
                    // 强制刷新卡牌 UI（卡牌浮起特效）
                    if (ui.selected.cards) {
                        ui.selected.cards.forEach(c => c.updateTransform(true));
                    }
                    // 刷新人物 UI
                    if (ui.selected.targets) {
                        ui.selected.targets.forEach(t => t.classList.add('target'));
                    }
                });
                ...
                event.result =
                    await player
                        .chooseCardTarget({
                            ...
                            prompt2: `<div class="text center">将半数向上的手牌交给一名其他角色，令${get.translation(trigger.card)}对你无效</div>`,
                            filterCard: true,
                            ...
                            ai1(card) {
                                let stroage = player.getStorage("xinxcongfeng");
                                let stroage1 = player.getStorage("xinxchouhuang");
                                let combined = [...stroage, ...stroage1];
                                /* let isRecorded = stroage1.includes(card.name);
                                if (isRecorded) {
                                    return 0;
                                } else{
                                    if (card.name == 'sha') {
                                ...
                                if (ui.selected && ui.selected.cards && ui.selected.cards.length > 0) {
                                    const selectedNames = ui.selected.cards.map(c => c.name);
                                ...
                                let score = 0;
                                if (stroage1.includes(card.name)) {
                                } else if (card.name == 'sha') {
                                    score = 15;
                                } else {
                                    score = 10 - get.value(card);
                                }
                                if (ui.selected && ui.selected.cards && ui.selected.cards.length > 0) {
                                    const selectedNames = ui.selected.cards.map(c => c.name);
                                    if (selectedNames.includes(card.name)) {
            ...
            async content(event, trigger, player) {
                ...
                player.markAuto("xinxchouhuang", cards.map(c => c.name));
        ...
        xinxlianlin: {
            audio: "ext:永夜之境/audio:5",
            logAudio: index => (typeof index === "number" ? `ext:永夜之境/audio/xinxlianlin${index}.mp3` : "ext:永夜之境/audio/xinxlianlin" + get.rand(1, 2) + ".mp3"),
            trigger: {
            ...
            getCards() {
                ...
                game.countPlayer(current => {
                    cards.push(...current.getCards('he'));
                });
                return cards;
            },
            updateMarks(player) {
            ...
            async cost(event, trigger, player) {
                ...
                for (let target of allPlayers) {
                    ...
                    for (let card of cards) {
                        ...
                        else if (target !== player && !get.is.shownCard(card) && get.position(card) === 'h') {
                            hidden.add(card);
                        } else {
                            shown.add(card);
                        }
                    ...
                    // 添加玩家名字分隔横幅
                    let ownerName = (target === player) ? "你" : get.translation(target);
                    dialog.add(`<div class="text center" style="color:#FFD700">${ownerName}的牌</div>`);
                    if (shown.length) dialog.add(shown);
                    if (hidden.length) dialog.add([hidden.slice().randomSort(), 'blank']);
                }
                if (!hasCard) {
                ...
                for (let button of dialog.buttons) {
                    ...
                    // 动态创建一个定位标签，盖在按钮正下方
                    let mark = ui.create.div('.fyrh-mark', button);
                    mark.innerHTML = `${age} 回合`;
                ...
                const result = await player.chooseButton(dialog).set('ai', button => {
                    ...
                    else if (target === player) { return age - get.value(card); }
                    return age;
                }).forResult();
            ...
            async content(event, trigger, player) {
                ...
                if (target && card) {
                    ...
                    if (age > 0) {
                        await player.addMark("xinxlianlin_effect", age, false);
                    }
                }
            },
            mod: {
            ...
            subSkill: {
                effect: {
                    ...
                    onremove: true,
                    filter(event, player) {
                        return player.countMark("xinxlianlin_effect") > 0;
                    },
                    marktext: '🍶',
                    intro: {
                        content: "下次摸牌数+$",
                    ...
                    async content(event, trigger, player) {
                        game.playAudio("../extension/永夜之境/audio/", 'xinxlianlin' + [get.rand(3, 5)] + '.mp3');
                        let addNum = player.countMark("xinxlianlin_effect");
                        trigger.num += addNum;
                ...
                ui: {
                    ...
                    charlotte: true,
                    async content(event, trigger, player) {
                        get.info("xinxlianlin").updateMarks(player);
                        if (trigger.cards) {
        ...
        xinxshibei: {
            ...
            logAudio: index => (typeof index === "number" ? `ext:永夜之境/audio/xinxshibei${index}.mp3` : 2),
            trigger: {
            ...
            async cost(event, trigger, player) {
                ...
                if (hs > num) {
                     event.result = await player
                         ...
                         .set("prompt2", "将手牌数弃至" + get.cnNumber(num) + "张")
                         .set("chooseonly", true)
                         .forResult();
                 } else {
                     let str = ``;
                     if (hs < num) {
                         str = `将手牌摸至${get.cnNumber(num)}张`;
                     }
                     event.result = await player
                         .chooseBool(prompt, str)
                         .set(
            ...
            async content(event, trigger, player) {
                ...
                if (trigger.name == "useCardToPlayer") {
                    player.logSkill("xinxshibei", [target], null, null, [get.rand(1, 2)]);
                } else {
                ...
                const pdiscards = player.getCards('h').filter(card => {
                    const isLess = get.number(card) < num;
                    const canDiscard = lib.filter.cardDiscardable(card, player, 'xinxshibei');
                    return isLess && canDiscard;
                });
                const tdiscards = target.getCards('h').filter(card => {
                    const isress = get.number(card) > num;
                    const canDiscard = lib.filter.cardDiscardable(card, target, 'xinxshibei');
                    return isress && canDiscard;
                });
                const nousecards = player.getCards('h').filter(card => {
                    return !player.hasUseTarget(card);
                });
                const choiceInfo = [
                    `${get.translation(player)}弃置点数小于${num}的手牌，${get.translation(target)}弃置点数大于${num}的手牌`,
                    `此阶段结束时可将${num}张牌当额外亮出${num}张牌的【兵临城下】对${get.translation(target)}使用`,
                ];
                const result = await player.chooseControl("弃牌", "兵临城下")
                    .set('prompt', get.skillTranslation(event.name) + ':请选择一项')
                    .set("choiceList", choiceInfo)
                    .set(
                        "resultx",
                        (() => {
                            if (pdiscards.length <= 2 && !player.countCards("h", { name: "zhuge" }) && nousecards.length <= 3 && get.attitude(player, target) <= 0) {
                                return '弃牌';
                            }
                            if (pdiscards.length > 3 || nousecards.length >= 4) {
                                return '兵临城下';
                            }
                            return '兵临城下';
                        })()
                    ...
                    .forResult();
                if (result.index == 0) {
                    game.playAudio("../extension/永夜之境/audio/", 'xinxshibei' + [get.rand(5, 6)] + '.mp3');
                    if (pdiscards.length) {
                        await player.discard(pdiscards);
                    }
                    if (tdiscards.length) {
                        await target.discard(tdiscards);
                    }
                } else {
                    game.playAudio("../extension/永夜之境/audio/", 'xinxshibei' + [get.rand(7, 8)] + '.mp3');
                    await player.addTempSkill("xinxshibei_use", 'phaseChange');
                    await player.addTempSkill("xinxshibei_tar", 'phaseChange');
                    player.setStorage('xinxshibei_use', num);
                    player.setStorage('xinxshibei_tar', [target]);
                }
            },
            subSkill: {
                tar: {
                ...
                use: {
                    ...
                    filter(event, player) {
                        let starget = player.getStorage("xinxshibei_tar");
                        return player.countCards("he") && starget[0]?.isIn();
                    },
                    forced: true,
                    async content(event, trigger, player) {
                        const num = Math.min(player.countCards('he'), player.getStorage("xinxshibei_use"));
                        let starget = player.getStorage("xinxshibei_tar");
                        if (num < 1) { return; }
                        game.broadcastAll(num => {
                            lib.skill.xinxshibei_backup.selectCard = num;
                        }, num);
                        player.addTempSkill("xinxshibei_binglin");
                        const next = player.chooseToUse();
                        next.set("openskilldialog", `誓北：是否将${num}张牌当作【兵临城下】对${get.translation(starget)}使用`);
                        next.set("norestore", true);
                        next.set("_backupevent", "xinxshibei_backup");
                        next.set("custom", {
                            add: {},
                            replace: { window() { } },
                        });
                        next.backup("xinxshibei_backup");
                        ...
                        next.set("filterTarget", function (card, player, target) {
                            if (!player.getStorage("xinxshibei_tar").includes(target) && !ui.selected.targets.includes(player.getStorage("xinxshibei_tar"))) {
                                return false;
                            }
                        ...
                        const aiBtn = ui.create.control("AI代选", function () {
                            ...
                            //抓取合法的牌
                            let available = player.getCards('he').filter(c => lib.skill.xinxshibei_backup.filterCard(c, player));
                            //available.sort((a, b) => get.number(a) - get.number(b));
                            available.sort((a, b) => {
                                return lib.skill.xinxshibei_backup.ai1(b) - lib.skill.xinxshibei_backup.ai1(a);
                            });
                            const cardsToSelect = available.slice(0, num);
                            //将牌塞入已选数组
                            ui.selected.cards.push(...cardsToSelect);
                            for (const card of ui.selected.cards) {
                                card.classList.add("selected");
                                card.updateTransform(true, 0); // true让卡牌翘起来
                            }
                            game.check();
                        ...
                        //清空按钮
                        next.promptdiscard = aiBtn;
                        const cleaner = setInterval(() => {
                            if (_status.event !== next) {
                                if (aiBtn && typeof aiBtn.close === "function") {
                                    aiBtn.close();
                                }
                        ...
                        /* if (next.promptdiscard && typeof next.promptdiscard.close === "function") {
                            next.promptdiscard.close();
                            delete next.promptdiscard;
                        } */
                        /* player.when("useCardAfter").filter((evt) => evt.getParent() == event.getParent())
                            .step(async (event, trigger, player) => {
                                delete player.storage.xinxshibei_use;
                                delete player.storage.xinxshibei_tar;
                            }); */
                ...
                backup: {
                    ...
                    ai1(card) {
                        let keepValue = get.useful(card) || get.value(card) || 0;
                        // 点数越小，保留价值越低
                        keepValue += get.number(card) / 10;
                ...
                binglin: {
                    trigger: {
                        player: "binglinchengxiaxBegin",
                    },
                    silent: true,
                    charlotte: true,
                    filter(event, player) {
                        return event.card.name === 'binglinchengxiax' && event.card?.storage.xinxshibei;
                    },
                    async content(event, trigger, player) {
                        trigger.setContent(async (event) => {
                            ...
                            const num = player.getStorage("xinxshibei_use");
                            delete player.storage.xinxshibei_use;
                            delete player.storage.xinxshibei_tar;
                            event.showCards = get.cards(4 + num, true);
                            ...
                            player.removeSkill("xinxshibei_binglin");
                        });
                    },
                    sub: true,
                    forced: true,
        ...
        xinxsaran: {
            ...
            async content(event, trigger, player) {
                ...
                const result2 = await player.chooseButton(dialog, [1, 10])
                    .set('filterButton', button => {
                        const card = button.link;
                        if (card.name === 'xinxsaran_equip' && card.cards && card.cards.length) {
                            return false;
                        }
                        // 判断这张牌是谁的
                        const owner = get.owner(card) || target;
                ...
                if (result2?.bool && result2.links?.length) {
                    ...
                    const toRecast = []; // 收集需要重铸的牌
                    if (pCards.length > 0) {
                        // 放入ui.special强制刷新 UI
                        await player.lose(pCards, ui.special, 'visible');
                    }
                    if (tCards.length > 0) {
                        await target.lose(tCards, ui.special, 'visible');
                    }
                    const doEquip = async (p, cards) => {
                        if (!p.isIn()) {
                            toRecast.addArray(cards);
                            return;
                        }

                        //随机武将卡面
                        let availableChars = [];
                        if (lib.characterPack['xinx1']) {
                            availableChars = Object.keys(lib.characterPack['xinx1']);
                        }
                        ...
                        for (const card of cards) {
                            ...
                            /* // 优先找空装备栏
                            for (let i = 1; i <= 5; i++) {
                                if (p.hasEmptySlot(i)) { targetSlot = i; break; }
                            }
                            // 如果没有空栏，找可以被替换的装备栏（排除废除栏）
                            if (!targetSlot) {
                                for (let i = 1; i <= 5; i++) {
                                    if (p.hasEquipableSlot(i)) { targetSlot = i; break; }
                                }
                            } */
                            /* const emptySlots = [1, 2, 3, 4, 5].filter(i => p.hasEmptySlot(i));
                            if (emptySlots.length > 0) {
                                targetSlot = emptySlots.randomGet();
                            }
                            else {
                                const equipableSlots = [1, 2, 3, 4, 5].filter(i => p.hasEquipableSlot(i));
                                if (equipableSlots.length > 0) {
                                    targetSlot = equipableSlots.randomGet();
                                }
                            } */

                            const vcard = get.autoViewAs({ name: 'xinxsaran_equip' }, [card]);
                            const ghostSlots = [];
                            if (p.extraEquip && p.extraEquip.length) {
                                p.extraEquip.forEach(info => {
                                    const subtype = get.subtype(info[1]);
                                    if (subtype && subtype.startsWith('equip')) {// 获取视为装备的位置，比如 "equip2"
                                        const num = parseInt(subtype.replace('equip', ''));
                                        if (!isNaN(num)) ghostSlots.push(num); // 记录下被占用的槽位号
                                    }
                                });
                            }
                            const validSlots = [1, 2, 3, 4, 5].filter(i => {
                                if (ghostSlots.includes(i)) return false;
                                if (!p.hasEquipableSlot(i)) return false;
                                vcard.subtypes = ['equip' + i];
                                return p.canEquip(vcard);
                            });
                            if (validSlots.length > 0) {
                                const emptySlots = validSlots.filter(i => p.getEquips(i).length === 0);
                                if (emptySlots.length > 0) {
                                    targetSlot = emptySlots.randomGet();
                                }
                                else {
                                    targetSlot = validSlots.randomGet();
                                }
                            }

                            if (targetSlot) {
                                // 将被顶替的原装备放入ui.special
                                const oldEquips = p.getEquips(targetSlot);
                                if (oldEquips && oldEquips.length) {
                                    await p.lose(oldEquips, ui.special, 'visible');
                                    toRecast.addArray(oldEquips);
                                }
                                const vcard = get.autoViewAs({ name: 'xinxsaran_equip' }, [card]);
                                vcard.subtypes = ['equip' + targetSlot];
                                // 打上信标，用于渲染立绘
                                vcard.storage ??= {};
                                vcard.storage.xinxsaran_source = player;
                    ...
                    // 执行置入
                    if (pCards.length) await doEquip(player, pCards);
                    if (tCards.length) await doEquip(target, tCards);
                    if (toRecast.length > 0) {
                        await player.$throw(toRecast);
                        await player.recast(toRecast);
                    }
                }
            },
            init(player, skill) {
                /* if (!lib.card.xinxsaran_equip) {
                    lib.card.xinxsaran_equip = {
                        type: "equip",
                        subtype: "equip1",
                        name: "xinxsaran_equip",
                        skills: [], //装备自带技能
                        description: "由【飒然】转化置入的虚拟装备",
                    };
                    lib.translate.xinxsaran_equip = "飒然";
                    lib.translate.xinxsaran_equip_info = "由【飒然】转化而来的装备。";
                } */
                if (!lib.card.xinxsaran_equip) {
                    lib.card.xinxsaran_equip = {
                        type: "equip",
                        ...
                        fullimage: true,
                        blankCard: true,
                        image: 'character:xinxzhu_sunshangxiang',
                        skills: [],
                        description: "由【飒然】转化而来的装备。",
                        onEquip(card) {
                            const source = card.storage?.xinxsaran_source;
                            ...
                            if (get.itemtype(source) === 'player') {
                                game.broadcastAll((player, card, source, avatar) => {
                                    ...
                                    if (cardx?.node?.name2 && (vcards.length !== 1 || vcards[0].name !== cardx.name)) {
                                        ...
                                        cardx.node.name2.innerHTML = `飒然·${source.isUnderControl(true) ? typeStr : '未知'}`;
                                    }
                                    // 换皮为发动者头像
                    ...
                    game.broadcastAll(skill => {
                        ...
                        get.nodeintro = function (node, ...args) {
                            ...
                            if (node.classList.contains('card')) {
                                ...
                                if (vcard && vcard.name === 'xinxsaran_equip' && (vcards.length !== 1 || vcards[0].name !== node.name)) {
                                    const source = vcard.storage?.xinxsaran_source;
                                    if (get.itemtype(source) === 'player') {
        ...
        xinxnigong: {
            audio: "ext:永夜之境/audio:4",
            logAudio: index => (typeof index === "number" ? `ext:永夜之境/audio/xinxnigong${index}.mp3` : 2),
            trigger: {
                player: "useCardToPlayer",
                target: "useCardToTarget",
            },
            /* filter(event, player) {
                if (event.card.storage.xinxnigong) { return false; }
                if (event.targets.length !== 1 || player === event.target) return false;
                const target = event.target;
                return player.countCards("e") > 0 || target.countCards("e") > 0;
            }, */
            filter(event, player) {
                if (event.card.storage.xinxnigong) { return false; }
                let target;
            ...
            async cost(event, trigger, player) {
                ...
                const target = (trigger.name == "useCardToPlayer" ? trigger.targets[0] : trigger.player);
                const pCards = player.getCards("e");
                const tCards = target.getCards("e");
                const dialog = ui.create.dialog('逆弓:选择一张装备区的牌');
                if (pCards.length) {
                    dialog.add('<div class="text center">你的装备（当作【无中生有】）</div>');
                    dialog.add(pCards);
                }
                if (tCards.length) {
                    dialog.add(`<div class="text center">${get.translation(target)}的装备（当作【火杀】）</div>`);
                    dialog.add(tCards);
                }
                let result = await player.chooseButton(dialog).set("ai", button => {
                    const player = get.player();
                    const card = button.link;
                    const owner = get.owner(card);
                    if (owner === player) {
            ...
            async content(event, trigger, player) {
                ...
                const owner = get.owner(card);
                if (owner === player) {
                    player.logSkill("xinxnigong", null, null, null, [get.rand(3, 4)]);
                    await player.chooseUseTarget(cards, {
                        name: 'wuzhong',
                        isCard: true,
                        storage: { xinxnigong: true }
                    }, false)
                } else {
                    player.logSkill("xinxnigong", null, null, null, [get.rand(1, 2)]);
                    await player.chooseUseTarget(cards, {
                        name: 'sha',
                        nature: 'fire',
                        isCard: true,
        ...
        xinxnewquanmou: {
            ...
            intro: {
                ...
                mark(dialog, storage, player) {
                    ...
                    const cards = player.getExpansions("xinxnewquanmou");
                    let hs = player.getCards("h");
                    let minCount = 0;
                    let minPoint = 0;
                    if (hs.length > 0) {
                        // 取出所有手牌的点数，剔除没有点数的牌
                        let nums = hs.map(c => get.number(c)).filter(n => n > 0);
                        if (nums.length > 0) {
                            minPoint = Math.min(...nums); // 最小点数
                            minCount = nums.filter(n => n === minPoint).length; // 统计最小点数的牌数
                        }
                    }
                    let x = cards.filter(c => get.number(c) > minPoint).length;
                    /* let ewai = !player.storage.xinxnewwuguix ? `<div>额定摸牌数：<span style="color:#00BFFF">${x}</span></div>` :
                        `<div>额外摸牌数：<span style="color:#00BFFF">${x}</span></div>`; */
                    let ewai = `<div>额定摸牌数：<span style="color:#00BFFF">${x}</span></div>`;
            ...
            subSkill: {
                ...
                draw: {
                    ...
                    charlotte: true,
                    filter(event, player) {
                        return !event.numFixed && player.getExpansions("xinxnewquanmou").length > 0;
                    },
                    async content(event, trigger, player) {
                        const cards = player.getExpansions("xinxnewquanmou");
                        ...
                        if (hs.length > 0) {
                            let nums = hs.map(c => get.number(c)).filter(n => n > 0);
                            if (nums.length > 0) {
                                minPoint = Math.min(...nums);
                                minCount = nums.filter(n => n === minPoint).length;
                            }
                        }
                        let x = cards.filter(c => get.number(c) > minPoint).length;
                        if (x > 0) {
                            if (!player.storage?.xinxnewwuguix) {
                                game.playAudio("../extension/永夜之境/audio/", 'xinxnewquanmou' + [get.rand(5, 6)] + '.mp3');
                            } else {
                                game.playAudio("../extension/永夜之境/audio/", 'xinxnewquanmou' + [get.rand(20, 22)] + '.mp3');
                            }
                            trigger.num += x;
                        }
                    },
                ...
                add: {
                    ...
                    charlotte: true,
                    filter(event, player) {
                        return player.getExpansions("xinxnewquanmou").length > 0;
                    },
                    async content(event, trigger, player) {
                        const cards = player.getExpansions("xinxnewquanmou");
                        const hs = player.getCards("h");
                        ...
                        let x = cards.filter(c => get.number(c) > minPoint).length;
                        if (x > 0) {
                            game.playAudio("../extension/永夜之境/audio/", 'xinxnewquanmou' + [get.rand(18, 20)] + '.mp3');
                            trigger.num += x;
                        }
                    },
                }
        ...
        xinxnewquanmoux: {
            audio: "ext:永夜之境/audio:22",
            "audioname2": {
                xinxnew_zhonghui: "xinxnewquanmou",
            },
        },
        xinxnewwugui: {
            audio: "ext:永夜之境/audio:5",
            logAudio: index => (typeof index === "number" ? `ext:永夜之境/audio/xinxnewwugui${index}.mp3` : 2),
            trigger: {
                player: ["dying", "addToExpansionAfter"],
            },
            derivation: "xinxnewquanmoux",
            juexingji: true,
            forced: true,
            popup: false,
            skillAnimation: true,
            ...
            filter(event, player) {
                if (event.name = 'addToExpansion' && player.countExpansions("xinxnewquanmou") < 13 && player.hp > 0) {
                    return false;
                }
                return player.getExpansions("xinxnewquanmou").length;
            },
            async content(event, trigger, player) {
                player.logSkill("xinxnewwugui", null, null, null, [get.rand(3, 5)]);
                player.changeSkin({ characterName: "xinxnew_zhonghui" }, "xinxnew_zhonghui_shadow");
                player.storage.xinxnewwuguix = true;
                player.awakenSkill(event.name);
                //await player.addSkill('xinxnewquanmou_add');
                //player.removeSkill("xinxnewquanmou_draw");
                //await player.gainMaxHp();
                await player.recover();
                if (player.countExpansions("xinxnewquanmou")) {
                    const num = Math.max(1, Math.floor(player.countExpansions("xinxnewquanmou") / 2));
                    const cards = player.getExpansions("xinxnewquanmou");
                    let result = await player
                        .chooseButtonTarget({
                            createDialog: [
                                `###${get.prompt('xinxnewwugui')}###<div class="text center">将${num}张移出牌交给一名其他角色</div>`,
                                cards],
                            cards: cards,
                            //forced: true,
                            selectButton: num,
                            ...
                            ai1(button) {
                                let point = get.number(button.link);
                                if (point > 0) {
                                    return 2 + (14 - point);
                                }
                                return point;
                    ...
                    if (result?.bool && result.links?.length) {
                        const target = result.targets[0],
                            cards = result.links;
                        player.line(target);
                        game.playAudio("../extension/永夜之境/audio/", 'xinxnewwugui' + [get.rand(1, 2)] + '.mp3');
        ...
        xing_sizhu: {
            ...
            async cost(event, trigger, player) {
                ...
                const choice = list.length > 1 ? await player.chooseButton([
                    ...
                    const player = get.player();
                    return player.getUseValue({ name: button.link[2], nature: button.link[3] }, false, false);
        ...
        xing_mengran: {
            ...
            chooseButton: {
                dialog: function (event, player) {
                    ...
                    return ui.create.dialog("梦染", [list, "vcard"], "hidden");
                },
                check(button) {
        ...
        dz_xing_yinxi: {
            ...
            priority: 10,
            async content(event, trigger, player) {
                const result = await player.chooseTarget(get.prompt("dz_xing_yinxi"), "令一名其他角色获得一枚“吟”标记", lib.filter.notMe)
        ...
        xing_ningshuang: {
            ...
            filter(event, player) {
                ...
                return bool; */
                return player.hasHistory('useCard', evt => ['basic'].includes(get.type2(evt.card)));
            },
            async cost(event, trigger, player) {
            ...
            subSkill:
            {
                draw: {
                    ...
                    onremove: function (player) {
                        player.clearMark('xing_ningshuang_draw');
                    },
                    trigger: {
                        player: "gainBegin",
                    },
        ...
        xinxsongqu: {
            ...
            async content(event, trigger, player) {
                const result = await player.chooseButtonTarget({
                    createDialog: [
                        ...
                        player.getCards("he"),
                        [["basic", "trick", "equip"].map(type => [type, get.translation(type)]), "tdnodes"],
                        [["red", "black"].map(color => [color, get.translation(color)]), "tdnodes"]
                    ],
                    selectButton: 3,
                    selectTarget: 1,
                    filterButton(button) {
                        const selectedLinks = ui.selected.buttons.map(btn => btn.link);
                        const hasCard = selectedLinks.some(link => typeof link === 'object' && link.name);
                        const hasType = selectedLinks.some(link => ['basic', 'trick', 'equip'].includes(link));
                        const hasColor = selectedLinks.some(link => ['red', 'black'].includes(link));
                        // 获取当前正在进行可选性判定的这个按钮的类别
                        const link = button.link;
                        const isCard = get.itemtype(link) === 'card';
                        const isType = ['basic', 'trick', 'equip'].includes(link);
                        const isColor = ['red', 'black'].includes(link);
                        // 如果当前判定的按钮是实体牌，且已经选过实体牌了，则不可选
                        if (isCard && hasCard) return false;
                        if (isType && hasType) return false;
                        if (isColor && hasColor) return false;
                        // 都不冲突，则该按钮可选
                        return true;
                    },
                    filterTarget(card, player, target) {
                    ...
                    complexSelect: true,
                    ai1(button) {
                        if (button.link && button.link.name === 'shan') return 10;
                        if (['basic', 'red'].includes(button.link)) return 10;
                        return Math.random();
                    },
                    ai2(target) {
                ...
                if (result?.bool) {
                    const target = result.targets[0];
                    const cards = result.links.filter(link => typeof link === 'object' && link.name);
            ...
            subSkill: {
                ...
                draw: {
                    ...
                    async cost(event, trigger, player) {
                        let choiceList = ["1.令其对自己造成1点伤害", "2.令此牌无效", "3.令其回复1点体力", "4.令其获得此牌"];
                        const result =
                            await player
                                ...
                                .set("ai", button => {
                                    ...
                                    if (button.link === "1.令其对自己造成1点伤害" && attitude < 0) return 3;
                                    if (button.link === "2.令此牌无效") return 2;
                                    if (button.link === "3.令其回复1点体力" && attitude >= 0 && target.hp <= 2) return 3;
                                    if (button.link === "4.令其获得此牌" && attitude >= 0) return 3;
                                    return 0;
                                })
                                .forResult();
                        event.result = {
        ...
        xinxshiren: {
            ...
            async content(event, trigger, player) {
                ...
                player.removeSkill = function (skill, ...args) {
                    if (this.additionalSkills.xinxshiren) {
                        this.additionalSkills.xinxshiren.remove(skill);
                    }
                    return _removeSkill.apply(this, [skill, ...args]);
                }; */
                let list = [];
                ...
                //list = list.filter(name => !xinx1Characters.includes(name) && !xinx2Characters.includes(name)); 
                list = list.filter(name => {
                    const isXinx1 = lib.characterPack['xinx1'] && lib.characterPack['xinx1'][name];
                    const isXinx2 = lib.characterPack['xinx2'] && lib.characterPack['xinx2'][name];
                ...
                if (Object.keys(skillList).length) {
                    ...
                    await player.addAdditionalSkills(event.name, links, true);
            ...
            group: ["xinxshiren_lose", "xinxshiren_ch"],
            subSkill: {
                lose: {
                    audio: "xinxshiren",
                    ...
                    async cost(event, trigger, player) {
                        const skills = player.additionalSkills.xinxshiren;
                        if (skills.length === 0) {
                        ...
                        const next = player.chooseButton(["识人：你可以失去任意个技能", [list, "textbutton"]], [1, Infinity]);
                        next.set("ai", button => {
                        ...
                        console.log("Cost method result:", result);
                        if (result.bool && result.links?.length) {
                            event.result = {
                                bool: result.bool,
                                cost_data: result.links,
                    ...
                    async content(event, trigger, player) {
                        player.changeSkills([], event.cost_data).set("$handle", (player, addSkills, removeSkills) => {
                            ...
                            player.draw(removeSkills.length);
                            const additionalSkills = player.additionalSkills.xinxshiren;
                            additionalSkills.removeArray(removeSkills);
                            if (!additionalSkills.length) { delete player.additionalSkills.xinxshiren; }
                        });
                    }
                },
                ch: {
                    ...
                    popup: false,
                    filter: function (event, player) {
                        return event.removeSkills && event.removeSkills.length > 0 && player.additionalSkills.xinxshiren.length;
                    },
                    async content(event, trigger, player) {
                        const storageSkills = player.additionalSkills.xinxshiren;
                        const removedSkills = trigger.removeSkills;

                        let hasChanged = false;
                        for (const skill of removedSkills) {
                            if (storageSkills.includes(skill)) {
                                storageSkills.remove(skill);
                                hasChanged = true;
                                game.log(player, '的识人记录中移除了技能', '#g【' + get.translation(skill) + '】');
                            }
                        }
                        if (hasChanged && storageSkills.length === 0) {
                            delete player.additionalSkills.xinxshiren;
                        }
                    },
                },
            }
        ...
        xinxzhuoshao: {
            ...
            async content(event, trigger, player) {
                ...
                const result = await player.chooseControl(list).set('prompt', get.skillTranslation(event.name) + ':请选择一项')
                    .set('ai', () => choiceIndex)
                    .set('choiceList', ["令" + get.translation(target.name) + "受到1点火焰伤害", "令" + get.translation(target.name) + "摸一张牌"])
                    .forResult();
                switch (result.control) {
                    case '令其受伤':
        ...
        xinxtianzhi: {
            ...
            intro: {
                ...
                mark(dialog, storage, player) {
                    ...
                    if (allCards.length) {
                        ...
                        dialog.buttons.forEach(btn => {
                            // 生成 vcard 时，牌名信息通常存放在 btn.link 中
                            let cardName = '';
                            if (typeof btn.link === 'string') {
                                cardName = btn.link;
                            } else if (btn.link && btn.link.name) {
                            ...
                            if (recorded.includes(cardName)) {
                                ...
                                // 【未解锁】：半透明、全黑白滤镜、降低亮度
                                btn.style.opacity = '0.5';
                                //btn.style.filter = 'grayscale(100%) brightness(0.6)'; 
                                btn.style.boxShadow = 'none';
                            }
                        });
                    }
            ...
            subSkill: {
                use: {
                    ...
                    filter(event, player) {
                        return player.hasUseTarget(event.card.name) && player.getStorage('xinxtianzhi').contains(event.card.name) && event.player != player;
                    },
                    forced: true,
                    usable: 1,
                    content() {
                        ...
                        player.chooseUseTarget
                            (get.prompt('xinxtianzhi'), "视为使用一张【" + get.translation(trigger.card.name) + "】",
                                { name: trigger.card.name, nature: trigger.card.nature, isCard: true }, false, 'nodistance');
                        "step 1"
        ...
        xinxwansha2: {
            mod: {
                cardSavable(card, player) {
                    ...
                    if ((target.hasSkill('xinxwansha')) && target != player) {
        ...
        xinxlinyou: {
            ...
            logAudio: index => (typeof index === "number" ? "ext:永夜之境/audio/xinxlinyou" + index + ".mp3" : 2),
            trigger: {
                player: ["useCard", "respond"],
            },
            usable: 1,
            ...
            async cost(event, trigger, player) {
                event.result = await player.chooseTarget('麟佑：是否对一名其他角色造成1点伤害', function (card, player, target) {
                    return player !== target;
                })
                    .set("ai", target => {
                        const player = get.player();
            ...
            async content(event, trigger, player) {
                ...
                player.logSkill("xinxlinyou", target, null, null, [get.rand(1, 2)]);
                await target.damage();
            },
            ...
            subSkill: {
                ...
                sha: {
                    ...
                    async cost(event, trigger, player) {
                        ...
                        for (let n of natures) {
                            let cn = get.translation(n) + '属性';
                            map[cn] = n; //{"火属性": "fire"}
                            choose.push(cn);
                        }
                        const result = await player.chooseButton([
                            `###${get.prompt(event.skill)}###<div class="text center">更改${get.translation(trigger.card)}的属性</div>`,
                            [choose, 'tdnodes']
                        ], 1)
                            .set('ai', () => {
                                return Math.random();
                        ...
                        if (result.bool) {
                            trigger._xinxlinyou_nature = map[result.links[0]];
                    ...
                    async content(event, trigger, player) {
                        const nature = trigger._xinxlinyou_nature;
                        delete trigger._xinxlinyou_nature;
                        if (nature) {
                            player.logSkill("xinxlinyou", null, null, null, [get.rand(5, 6)]);
                            trigger.nature = nature;
                            if (trigger.card) {
                                trigger.card.nature = nature;
                            }
                            player.popup(get.translation(nature) + '杀', nature);
                            game.log(trigger.card, '被改为了', '#y' + get.translation(nature), '属性');
                        }
                    },
                },
                sg: {
                    ...
                    async cost(event, trigger, player) {
                        event.result = await player.chooseBool("麟佑：是否令" + get.translation(trigger.card) + "额外结算一次").set("choice")
                            .set("ai", () => {
                ...
                da: {
                    ...
                    async cost(event, trigger, player) {
                        event.result = await player.chooseBool("麟佑：是否令" + get.translation(trigger.card) + "造成的伤害+1").set("choice")
                            .set("ai", () => {
                                let evt = _status.event.getParent();
                                return get.attitude(evt.player, evt.target) <= 0;
                            }).forResult();
                ...
                wt: {
                    ...
                    content: function () {
                        "step 0"
                        player.chooseTarget(get.prompt('xinxlinyou'), "令" + get.translation(trigger.card) + "对任意目标无效",
                        ...
                        "step 1"
                        if (result.bool) {
                            player.logSkill("xinxlinyou", result.targets, null, null, [get.rand(11, 12)]);
                            trigger.getParent().excluded.addArray(result.targets);
                            game.delay();
                            game.log(player, '令', trigger.card, '对', result.targets, '无效');
                        }
                ...
                push: {
                    ...
                    content: function () {
                        ...
                        player
                            ...
                            .set("ai", function () {
                                const player = get.player();
                                if (player.getExpansions("xinxyingfu").length > 4 && get.attitude(player, _status.currentPhase) <= 0) return 5;
                                return 0;
                            })
                        "step 1";
                        if (result.bool) {
            ...
            async content(event, trigger, player) {
                ...
                if (player.countMark('xinxchenlan') > 3) {
                    ...
                    if (cards.length) {
                        player.$gain2(cards, false);
                        game.log(player, "将", cards, "作为“死士”置于了武将牌上");
                        await player.loseToSpecial(cards, "xinxqianlong_tag").visible == true;
                        //player.loseToSpecial(get.cards(3),'xinxqianlong_tag');
                        player.markSkill("xinxqianlong");
                        await game.delayx();
                    }
        ...
        xinxjianxiong: {
            audio: "ext:永夜之境/audio:4",
            logAudio: index => (typeof index === "number" ? "ext:永夜之境/audio/xinxjianxiong" + index + ".mp3" : 2),
            trigger: {
                player: "damageBefore",
            },
            popup: false,
            ...
            animationColor: "thunder",
            filter(event, player) {
                return lib.skill.xinxjianxiong.getNum(event).length;
            },
            check(event, player) {
            ...
            async content(event, trigger, player) {
                ...
                if (
                    game.getGlobalHistory("everything", evt => {
                        if (evt.name != "die" || evt.player != trigger.source) return false;
                        return evt.reason?.getParent() == event;
                    }).length > 0
                ) {
                    player.logSkill("xinxjianxiong", null, null, null, [get.rand(3, 4)]);
                    player.restoreSkill('xinxjianxiong');
                    game.log(player, "重置了技能", "#g【奸雄】");
                }
            },
            getNum(event) {
                return game
                    ...
                    .reduce((list, evt) => list.addArray(evt.cards.filter(i => get.is.damageCard(i))), []);
            },
            subSkill: {
                die: {
                    audio: "xinxjianxiong",
                ...
                init: {
                    ...
                    async content(event, trigger, player) {
                        const result = await player.chooseTarget('藏刃：令一名其他角色获得“藏”标记', (card, player, target) => {
                            ...
                            return attitude * (target === self ? 1 : -5);
                        }).forResult();
                        if (result?.bool && result.targets?.length) {
                            const [target] = result.targets;
                            player.line(target);
        ...
        xinxfenglu: {
            ...
            filter(event, player) {
                return event.player.hasMark("xinxcangren") && event.player.hp < player.hp;
            },
            forced: true,
            locked: true,
            logTarget: "player",
        ...
        xinxquanmou: {
            ...
            subSkill: {
                ...
                Draw: {
                    ...
                    audio: "ext:永夜之境/audio:2",
                    filter: function (event, player) {
                        return !event.numFixed && player.hasMark("xinxquanmou_Draw");
                    },
                    content() {
        ...
        xinxwuyi: {
            ...
            subSkill: {
                norecover: {
                    ...
                    async content(event, trigger, player) {
                        trigger.cancel();
                        await trigger.player.removeSkill('xinxwuyi_norecover');
                    }
                },
            }
        },
        ...
        xinxhuoji: {
            ...
            filter(event, player) {
                // if (!event.targets || event.targets.length != 1) return false;
                return !get.tag(event.card, 'damage') && !player.hasSkill('xinxhuoji_used');
            },
            forced: true,
            direct: true,
            async content(event, trigger, player) {
                ...
                if (result.bool) {
                    ...
                    player.addTempSkill('xinxhuoji_used', "roundStart");
            ...
            subSkill: {
                ...
                gian: {
                    ...
                    filter: function (event, player) {
                        if (player == event.player || event.targets.length != 1 || event.target == player || player.hasSkill('xinxhuoji_gianused')) return false;
                    ...
                    async content(event, trigger, player) {
                        player.addTempSkill("xinxhuoji_gianused", "roundStart");
                        trigger.player.draw();
                        trigger.targets.length = 0;
                        trigger.all_excluded = true;
                        // var evt = event.getParent("phaseUse");
        ...
        xinxsanku: {
            audio: "ext:永夜之境/audio:4",
            logAudio: index => (typeof index === "number" ? "ext:永夜之境/audio/xinxsanku" + index + ".mp3" : 2),
            trigger: {
                global: "roundStart",
            },
            popup: false,
            ...
            content: function () {
                "step 0";
                player.logSkill("xinxsanku", null, null, null, [get.rand(1, 3)]);
            ...
            subSkill: {
                ...
                re:
                {
                    ...
                    popup: false,
                    filter: function (event, player) {
                        return player.countCards("h", "ying") > 1;
                    },
                    filterCard: {
                        name: "ying",
                    },
                    content() {
                        "step 0";
                        var next = player.chooseToDiscard("三窟：是否弃置两张影将体力回复至一点？", { name: "ying" }, 2);
                        next.set("ai", function (card) {
                            return 9 - get.value(card);
                        });
                        "step 1";
                        if (result.bool) {
                            player.logSkill("xinxsanku", null, null, null, [get.rand(3, 4)]);
                            player.recoverTo(1);
                        }
                    },
                }
        ...
        xinxluexin: {
            ...
            intro: {
                mark(dialog, storage, player) {
                    ...
                    dialog.addText('<div class="text center" style="font-size:18px; font-weight:bold; padding:5px; margin-top:15px; border-bottom:1px solid rgba(128,128,128,0.3)">🎴可使用的牌</div>');
            ...
            async content(event, trigger, player) {
                ...
                const cards = usedCards.filter(i => {
        ...
        xinxyangjian: {
            ...
            priority: -1,
            filter(event, player) {
                if (event.from_xinxluexin) return false;
                return get.type(event.card) == 'basic';
                //&& event.getParent(2).name != "xinxluexin"
            },
            async content(event, trigger, player) {
            ...
            subSkill: {
                draw: {
                    ...
                    content() {
                        ...
                        if (cards.length) {
                            player.gain(cards, trigger.target, "giveAuto", "bySelf").gaintag = ['xinxwusheng_tag'];
        ...
        xinxqizhen: {
            ...
            async cost(event, trigger, player) {
                event.result = await player
                    .chooseTarget(get.prompt("xinxqizhen"), `<div class="text center">获得一名其他角色一张牌</div>`, lib.filter.notMe, function (card, player, target) {
                        return target.countCards('he');
                    })
                    .set("ai", target => {
                        if (get.player().hp < 2) { return false };
        ...
        xinxlihuo: {
            ...
            async cost(event, trigger, player) {
                event.result = await player.chooseCardTarget({
                    prompt: get.prompt("xinxlihuo"),
                    prompt2: `<div class="text center">弃置两张“奇”，并对一名其他角色造成一点火焰伤害。</div>`,
                    position: "s",
            ...
            async content(event, trigger, player) {
                await player.discard(event.cards);
                player.logSkill('xinxlihuo', event.targets[0]);
                await event.targets[0].damage('fire', player);
            },
        },
        xinxzhaohan: {
            audio: "ext:永夜之境/audio:4",
        ...
        xinxchushi: {
            ...
            subSkill: {
                ...
                draw: {
                    ...
                    marktext: "整驽",
                    intro: {
                        content: "<li>来自$杏诸葛亮<br><li>准备阶段或结束阶段，你摸一张牌，然后重铸一张牌。",
                    },
                    "_priority": 10,
                },
        ...
        xinxyinshi: {
            ...
            async content(event, trigger, player) {
                ...
                player.gain(lib.card.ying.getYing(1), "gain2").gaintag = ['xinxyinshi_tag'];
        ...
        xinxruilue: {
            ...
            content() {
                ...
                if (ts.length < 1) event.finish();
                    ...
                    var next = player.chooseToMove("睿略：交换任意张牌");
                    next.set("list", [
                    ...
                    next.set("max", Math.min(hs.length, ts.length, Infinity));
                    next.set('processAI', list => {
        ...
        xinxbainei: {
            ...
            async content(event, trigger, player) {
                ...
                //     else break;
                // }
                // if (cards.length) await player.gain(cards, "gain2"); 从牌堆或弃牌堆中获得X张牌名各不相同的基本牌（X为你已损失的体力值）
                if (get.itemtype(trigger.cards) == "cards" && get.position(trigger.cards[0], true) == "o") {
                    await player.chooseUseTarget(trigger.cards, false);
        ...
        xinxfenkui: {
            ...
            async content(event, trigger, player) {
                ...
                const enemies = game.filterPlayer(current => current != player && !current.isLinked() && -get.attitude(player, current));
                const result = await player.chooseControl(list).set('prompt', get.skillTranslation(event.name) + ':请选择一项')
                    .set('ai', () => {
                        if (enemies.length > 0) {
                            return '横置角色';
                ...
                switch (result.control) {
                    ...
                    case '造成伤害':
                        const result1 = await player
                            .chooseTarget("选择一名其他角色，对其造成" + (num) + "点伤害", (card, player, target) => {
                                return target !== player;
                            })
                        ...
                        if (result1.bool) {
                            ...
                            player.line(target);
                            await target.damage('fire', player, num);
                            await player.removeMark(("xinxfenkui"), player.countMark("xinxfenkui"));
                        }
                        break;
                }
        ...
        xinxqianyi: {
            ...
            async content(event, trigger, player) {
                ...
                const history = player.getHistory('useCard', evt => evt.card && !get.is.damageCard(evt.card)).length || 1;
            ...
            subSkill: {
                add: {
                    ...
                    "_priority": -10,
                    filter: function (event, player) {
                        return !get.is.damageCard(event.card) && player.countMark("xinxqianyi") < 3;
                    },
                    async content(event, trigger, player) {
        ...
        xinxquanbian: {
            ...
            animationColor: "thunder",
            filter: function (event, player) {
                return player.countCards("h", card => card.hasGaintag("xinxqianyi")) >= 3 && event.player != player;
            },
            //async content(event, trigger, player) {
            content: function () {
                "step 0";
                ...
                player.addSkill('xinxquanbian_buff');
            ...
            subSkill: {
                buff: {
                    ...
                    charlotte: true,
                    filter(event, player) {
                        if (event.target == player || !event.target.countCards("h")) { return false; }
                        if (event.cards && event.cards.some(c => c.hasGaintag('xinxqianyi'))) return true;
                        var parent = event.getParent();
                        var history = player.getHistory('lose', function (evt) {
                            return evt.getParent() === parent;
                        });
                        for (var i = 0; i < history.length; i++) {
                            var evt = history[i];
                            if (evt.gaintag_map) {
                                for (var key in evt.gaintag_map) {
                                    if (evt.gaintag_map[key].includes("xinxqianyi")) {
                                        return true;
                                    }
                                }
                            }
                            if (evt.cards && evt.cards.some(c => c.hasGaintag('xinxqianyi'))) {
                                return true;
                            }
                        }
                        return false;
        ...
        xinxshunhua: {
            ...
            async content(event, trigger, player) {
                ...
                const result = await player.chooseControl(list).set('prompt', get.skillTranslation(event.name) + ':请选择一项').set('ai', () => choiceIndex)
                    .set('choiceList', ["令其从牌堆或弃牌堆中获得" + num + "张类型各不相同的牌", "令其弃置一种类型的所有手牌"])
                    .forResult();
                switch (result.control) {
                    case '令其摸牌':
                        var cards = [];
                    ...
                    case '令其弃牌':
                        ...
                        if (types.length) {
                            const {
                                ...
                                .set("prompt", "弃置一种类别的所有手牌").forResult();
                            if (control) {
                ...
                if (result?.bool) {
                    switch (result.links[0]) {
                        ...
                        case "draw":
                            ...
                            const {
                                cards
                            } = await player.choosePlayerCard(target, "hej", num, "将一半牌置于其武将牌上", true).forResult();
                            if (result.cards) {
        ...
        xinxbugui: {
            ...
            async content(event, trigger, player) {
                await player.awakenSkill('xinxbugui');
                await player.loseMaxHp();
                player.addSkills('xinxpixing');
            }
        },
        xinxfeiyan: {
            audio: "ext:永夜之境/audio:4",
        ...
        xinxciyou: {
            ...
            async content(event, trigger, player) {
                ...
                if (card) {
                    event.card = card;
                    await player.gain(card, "gain2").gaintag.add("xinxciyou_tag");
                    player.markAuto("xinxciyou", card);
                }
            },
            mod: {
                aiOrder(player, card, num) {
                    if (card?.hasGaintag?.("xinxciyou_tag")) {
                        return num + 10;
                    }
                },
            },
            ...
            subSkill: {
                gain: {
                    ...
                    async content(event, trigger, player) {
                        ...
                        await player.gain(cards, "gain2").gaintag.add("xinxciyou_tag");
                    },
                    sub: true,
                ...
                effect: {
                    ...
                    async content(event, trigger, player) {
                        ...
                        await player.recover();
                        player.addMark('xinxciyou_cancel', 1, false);
                    },
                    sub: true,
                    sourceSkill: "xinxciyou",
                    "_priority": 100,
                ...
                cancel: {
                    ...
                    async content(event, trigger, player) {
                        trigger.cancel();
                        await player.clearMark(("xinxciyou_cancel"));
                    },
                    intro: {
                        markcount: () => 0,
                        content: "跳过下个弃牌阶段",
        ...
        xinxxinlue: {
            ...
            async cost(event, trigger, player) {
                ...
                const result = await player
                    ...
                    .set("ai", button => {
                        ...
                        if (get.type(card) === 'trick' && get.is.damageCard(card)) return 4;
            ...
            async content(event, trigger, player) {
                ...
                if (player.hasUseTarget(cards[0], false, false)) {
                    await player.chooseUseTarget(cards, false, 'nodistance');
                }
            },
        },
        ...
        xinxhemou: {//合谋：准备阶段，你可以选择一名其他角色并展示牌堆底X张牌（X为场上存活人数，至多为5），其依次使用其中的伤害牌。若其以此法使用的牌造成过伤害，你摸X张牌，否则其失去2点体力。
            ...
            async cost(event, trigger, player) {
                event.result = await player
                    .chooseTarget(get.prompt2("xinxhemou"), (card, player, target) => {
                        return target != player;
                    })
                    .set("ai", target => {
                        const player = get.player(),
            ...
            async content(event, trigger, player) {
                ...
                if (target.hasHistory('sourceDamage', (evt) => evt.getParent(4) == event)) {
                    ...
                    if (cards2.length) {
                        const result1 =
                            await target.chooseCard("选择交给" + get.translation(player) + "一张♠牌", 'he', true)
        ...
        xinxquanpao: {
            ...
            async content(event, trigger, player) {
                ...
                const cards1 = [];
                for (let i = 0; i < num; i++) {
                    const card = game.createCard('ying');
                    cards1.push(card);
                }
                ...
                if (cards1.length) {
                    ...
                    game.log(player, "将 " + cards1.length + "张【影】置于牌堆顶");
                }
                await game.delayx();
                let cards = [];
                ...
                if (cards.length) {
                    await player.gain(cards, "gain2").gaintag.add("xinxquanpao_tag");
        ...
        xinxqingqiang: {
            ...
            async content(event, trigger, player) {
                ...
                if (cards.length) {
                    ...
                    const target = trigger.player;
                    const result = await player
                        .chooseTarget("选择" + get.translation(target) + "使用【杀】的目标", function (card, player, target) {
        ...
        xinxxzhaohan: {
            ...
            /* clickable(player) {
                if (player.isUnderControl(true)) {
                    const cards = lib.skill.xinxxzhaohan.getCards(player);
                    function createDialogWithControl(result) {
                        const dialog = ui.create.dialog("昭汉", "peaceDialog");
                        ...
                        if (_status.xinxxzhaohan_clickable) {
                            _status.xinxxzhaohan_clickable.close();
                        }
                        _status.xinxxzhaohan_clickable = dialog;
                        dialog.open();
                    }
            ...
            hiddenCard(player, name) {
                ...
                const info = lib.skill.xinxxzhaohan.getLimitInfo(player);
                if (info.used >= info.limit) return false;
                if (name && ui.cardPile.hasChildNodes !== false) {
                    const pile = Array.from(ui.cardPile.childNodes).slice(0, info.limit);
            ...
            getCards(player) {
                let cards = [];
                const count = Math.max(0, player.hp);
                if (count === 0) return [];

                if (game.online) {
                    return game.requestSkillData("xinxxzhaohan", "getTopCards", 10000);
                } else {
            ...
            sync: {
                getTopCards(client) {
                    const count = Math.max(0, player.hp);
                    if (ui.cardPile.hasChildNodes !== false && count > 0) {
            ...
            intro: {
                ...
                content(storage, player) {
                    const info = lib.skill.xinxxzhaohan.getLimitInfo(player);
                    return `牌堆顶的${info.limit}张牌对你可见。<br>每轮限${info.limit}次，你可以使用其中的牌。<br>当前本轮剩余次数：${info.limit - info.used}`;
                },
                mark(dialog, storage, player) {
            ...
            getLimitInfo(player) {
                let data = player.storage.xinxxzhaohan_data || { round: 0, used: 0 };
                // 如果记录的轮数不是当前游戏轮数，重置计数
                if (data.round != game.roundNumber) {
                    data.round = game.roundNumber;
                    data.used = 0;
                    player.storage.xinxxzhaohan_data = data;
                }
                return {
                    used: data.used,
                    limit: Math.max(0, player.hp)
                };
            },
            group: "xinxxzhaohan_aocai",
            subSkill: {
                aocai: {
                    mod: {
                        aiOrder(player, card, num) {
                            if (card?.hasGaintag?.("xinxxzhaohan")) {
                                return num + 0.1;
                            }
                        },
                    },
                    onChooseToUse(event) {
                        ...
                        // 检查限制：如果本轮已用次数 >= 体力值，则不发动
                        const info = lib.skill.xinxxzhaohan.getLimitInfo(player);
                        if (info.used >= info.limit) return;

                        let cards = player.getCards("s", card => card.hasGaintag("xinxxzhaohan"));
                        if (cards.length) {
                            game.deleteFakeCards(cards);
                        }
                        if (ui.cardPile.hasChildNodes !== false) {
                            cards = Array.from(ui.cardPile.childNodes).slice(0, info.limit);
                            player.directgains(game.createFakeCards(cards), null, "xinxxzhaohan");
                        }
                    },
                    onChooseToRespond(event) {
                        if (game.online) return;
                    ...
                    filter(event, player) {
                        if (["useCard", "respond"].includes(event.name)) {
                            // 判断使用的牌是否确实来源于牌堆顶的合法范围内
                            const info = lib.skill.xinxxzhaohan.getLimitInfo(player);
                            // 如果已经超限，理论上不会走到这里，但双重保险
                            if (info.used >= info.limit) return false;
                    ...
                    async content(event, trigger, player) {
                        if (["useCard", "respond"].includes(trigger.name)) {
                            // 记录发动
                            if (!trigger.skill) {
                                trigger.skill = "xinxxzhaohan";
                            } else {
                                await player.logSkill("xinxxzhaohan");
                            }

                            // 增加使用计数
                            let data = player.storage.xinxxzhaohan_data;
                            data.used++;
                            player.updateMark("xinxxzhaohan"); // 更新标记显示的剩余次数

                            // 处理牌的数据交换（将虚拟牌替换为真牌）
                            const cards = await get.info("xinxxzhaohan").getCards(player);
                            for (let i = 0; i < trigger.cards.length; i++) {
        ...
        xinxduanwan: {//锁定技。每回合限一次。一名角色的体力值变化时，若其体力值不大于2，你选择一项：1.获得一名角色等同其体力值张牌；2.弃置装备区一张牌，令一名角色弃置所有基本牌，然后你与其距离视为1直到下轮开始。
            ...
            locked: true,
            //     check(event, player) {
            // return  get.attitude(player, event.player) <= 0 && event.player.countCards("he") > 1;
            //     },
            async content(event, trigger, player) {
                const cards1 = player.getCards("e");
                if (cards1.length) { await player.discard(cards1); }
                const list = ['获得牌', '弃置牌']
        ...
        xinxzhenying: {
            ...
            async content(event, trigger, player) {
                ...
                const {
                    bool
                } = await player.chooseBool("砧影：是否对" + get.translation(target) + "造成1点伤害？").set("choice", get.damageEffect(target, player, player) > 0).forResult();
                if (bool) {
                    player.line(target);
                    player.logSkill('xinxzhenying', target);
                    await target.damage();
                    player.addSkill("xinxzhenying_debuff");
            ...
            subSkill: {
                debuff: {
                    ...
                    usable: 1,
                    filter(event, player) {
                        return player.getStorage("xinxzhenying_debuff").includes(event.source);
                        // return _status.currentPhase && _status.currentPhase != player;
                        // const markedTargets = player.getStorage("xinxzhenying_debuff") || [];
                    ...
                    async content(event, trigger, player) {
                        ...
                        const target = trigger.source;
                        await target.draw(2);
                        player.unmarkAuto("xinxzhenying_debuff", [target]);
        ...
        xinxjiaojue: {
            ...
            async content(event, trigger, player) {
                ...
                const { control: choice } =
                    choices.length > 1
                        ? await player
                            ...
                            .set("prompt", "狡谲：请选择一项执行，执行后该项数值-1，其余项数值+1")
                            .forResult()
                        : choices[0];
                ...
                for (let i = 0; i < 3; i++) {
                    storage[i] = Math.max(0, Math.min(storage[i], 2));
                }
        ...
        xinxyingqi: {
            ...
            filter(event, player) {
                let storage = player.getStorage('xinxyingqi_use');
                return player.getStorage('xinxyingqi_use').length < 6;
            },
            async cost(event, trigger, player) {
            ...
            async content(event, trigger, player) {
                ...
                const result = await player.chooseButton(['〖' + get.skillTranslation(event.name) + '〗:选择执行的阶段', [choose, 'tdnodes']], 1, true).set('ai', (button) => {
                    ...
                    if (get.attitude(player, target) < 0) {
                        ...
                        if (button.link == '弃牌阶段') return 2;
                        if (button.link == '判定阶段' && target.countCards('j') > 0) { return 2; }
                        else {
                            return 1;
                        }
                    }
                    ...
                    //return button.link != player.storage[event.name + '_lastPhase'];
                    return !player.getStorage(event.name + '_use').includes(button.link);
                }).forResult();
                if (result.bool) {
                    player.addSkill(event.name + '_use');
                    player.markAuto(event.name + '_use', [result.links[0]]);
                    ...
                    player
                        ...
                        .step(async (event, trigger, player) => {
                            if (player.isAlive()) {
                                player.insertPhase('xinxyingqi').set('phaseList', ['phaseZhunbei', 'phaseJudge', 'phaseUse', 'phaseJieshu', 'phaseDiscard']);
                            };
                        });
                }
            },
        ...
        xinxduanzhi: {
            ...
            async cost(event, trigger, player) {
                event.result = await player
                    .chooseTarget(get.prompt("xinxduanzhi"), "令一名角色使用当前回合角色本回合因使用的且进入弃牌堆的牌")
                    .set("ai", target =>
            ...
            async content(event, trigger, player) {
                ...
                let useCount = 0;
                while (list.length > 0 && useCount < 2) {
                    const useResult = await target.chooseButton([
                        "断织：是否使用一张牌？（还可使用" + get.cnNumber(2 - useCount) + "张）",
                        list
                    ]).set('filterButton', button => {
                        return get.player().hasUseTarget(button.link);
                    }).set('ai', button => {
                ...
                if (list.length > 1) {
                    ...
                    const result1 = await trigger.player.chooseButton(['断织：选择获得其中一张牌', list], 1, true)
                        .forResult();
                    if (result1.bool) {
                        await trigger.player.gain(result1.links, 'gain2');
                    }
                } else {
                    await trigger.player.gain(list, 'gain2');
                }
        ...
        xinxqueyi: {
            ...
            intro: {
                markcount: "expansion",
                mark(dialog, storage, player) {
                    let cards = player.getExpansions('xinxqueyi');
                    if (player.isUnderControl(true)) dialog.addAuto(cards);
                    else return '共有' + get.cnNumber(cards.length) + '张牌';
                },
            },
        ...
        xinxshexin: {//判定阶段开始时，你可以展示判定区任意张牌，然后令一名其他角色选择一项：1.将所有手牌置入牌堆，然后获得展示的牌；2.令你弃置其等量张牌，并使用展示的牌。
            ...
            async content(event, trigger, player) {
                ...
                // await   delete player.storage.xumou_jsrg;
                //player.unmarkAuto("xumou_jsrg", judgeCards);

                const judgeCards = player.getCards("xs", card => !card._cardid);
                const cardCountMap = {};
                ...
                player.logSkill("xinxshexin", null, null, null, [get.rand(1, 2)]);
                const result = await player
                    .chooseButtonTarget({
                        createDialog: [
                            //`###${get.prompt2('xinxshexin')}###<div class="text center">展示任意张牌，并选择一名其他角色执行</div>`,
                            get.prompt2('xinxshexin'),
                            judgeCards],
                        cards: judgeCards,
                ...
                if (result?.bool && result.links?.length) {
                    ...
                    if (cards.length) { await player.showCards(cards); }
                    const cards2 = target1.countCards('h');
                    const choiceList = [];
                    if (cards2 > 0) {
                    ...
                    const choice = await target1.chooseControl(...choiceList)
                        .set('prompt', '请选择一项:')
                        .set('choiceList', [
                        ...
                        .set('ai', () => {
                            if (choiceList.length === 1) return '选项二';
                            const ths = target1.countCards('h');
                            let handValueTotal = 0;
                            target1.getCards('h').forEach(c => {
                                handValueTotal += get.value(c, target1);
                            });
                            const handAvgValue = handValueTotal / ths;
                            //计算展示牌的总价值与平均值
                            let cardsValueTotal = 0;
                            let usecardsCount = 0;
                            cards.forEach(c => {
                                cardsValueTotal += get.value(c, player);
                                if (player.hasUseTarget(c)) usecardsCount++;
                            });
                            const cardsAvgValue = cards.length > 0 ? (cardsValueTotal / cards.length) : 0;
                            if (
                                (handAvgValue * ths <= cards.length * cardsAvgValue) &&
                                (usecardsCount >= cards.length / 2)
                            ) {
                                return '选项一';
                            }
                            return '选项二';
                ...
                /* if (player.getCards("xs", card => !card._cardid).length) {
                    let list = player.getCards("xs", card => !card._cardid).slice(); 
                    while (list.some(card => player.hasUseTarget(card))) {
                        const result = await player.chooseButton(['是否使用其中的一张牌？', list]).set('filterButton', button => {
                            return get.player().hasUseTarget(button.link);
                        }).set('ai', button => {
                ...
                await player.loseToDiscardpile(player.getCards("xs", card => !card._cardid));
            },
        },
        xinxjinmian: {
            audio: "ext:永夜之境/audio:4",
                ...
                use: {
                    ...
                    async content(event, trigger, player) {
                        ...
                        if (result.color === 'black') {
                            player.logSkill("xinxsukan", [target], null, null, [get.rand(3, 5)]);
                            target.damage("thunder", 'nosource');

                        }
                        if (result.color === 'red') {
                            // const skills = target.getStockSkills(true, true);角色固有 / 库存的技能
                            // const skills = target.getSkills(null, false, false).filter(skill => {当前实时生效的技能
                            //     const info = get.info(skill);
                            ...
                            //     return;
                            // }
                            const skills = target.getSkills(null, false, false).filter(s => {
                                if (player.getSkills().includes(s)) return false;
                            ...
                            switch (result.control) {
                                case '获得其技能':
                                    if (skills.length) {
                                        ...
                                        const result = await player.chooseButton([`请选择获得${get.translation(target)}一个技能`, [skills, 'skill']])
                                            .set('ai', button => get.priority(button.link))
                                            .set('forced', true)
                                            .forResult();
                                        if (result.links && result.links.length) {
                                            const chosenSkill = result.links[0];
                                            player.addTempSkills(chosenSkill);
                                            player.popup(chosenSkill);
                                            game.log(player, '获得了临时技能', `【${get.translation(chosenSkill)}】`);
                                        }
                                    }
                                    break;
                                case '获得魏晋技能':
        ...
        xinxhaopo: {
            ...
            async content(event, trigger, player) {
                const result = await player
                    .chooseTarget(get.prompt2("xinxhaopo"), '选择一名其他角色，其将手牌摸至体力上限，你将体力回复至2点', lib.filter.notMe, true)
                    .set("ai", target => {
                        const player = get.player(),
                            hs = game.countPlayer();
            ...
            subSkill: {
                gain: {
                    ...
                    async content(event, trigger, player) {
                        ...
                        const result = await player.chooseButton(['踞兖：选择获得至多' + get.cnNumber(num) + '张牌', cards], [1, num]).set('ai', button => {
                            return get.value(button.link, get.event().player);
                        }).forResult();
                        if (result.bool) { await player.gain(result.links, 'gain2'); }
        ...
        xinxqiansi: {
            ...
            async content(event, trigger, player) {
                ...
                if (cards.length) {
                    ...
                    const result = await player.chooseButton(["选择" + get.translation(target) + "一张手牌标记为“嗣”", cards], 1, true)
                        .set('filterButton', button => {
                            const card = button.link;
                            const selected = ui.selected.buttons;
                            if (card.hasGaintag('xinxqiansi_tag')) {
                                return false;
                            }
                            return true;
                        })
                ...
                backup(links, player) {
                    return {
                        ...
                        async precontent(event, trigger, player) {
                            ...
                            player.when({ source: "damageSource" }).step(async () => { player.addTempSkill('xinxxiaoling_used') });
                            ...
                            if (result.bool) {
                                ...
                                const { cards } = await player.gainPlayerCard(result.targets[0], 'ej', true).forResult();
                ...
                if (
                    ...
                    if (cards.length > 0) {
                        ...
                        if (result?.bool) {
                            ...
                            await target.gain(lib.card.ying.getYing(1), "gain2");
                        }
                    }
                }
            },
        ...
        xinxchengshu: {
                ...
                if (cards.length && player.countCards("h")) {
                    ...
                    if (result?.bool) {
                        ...
                        if (pushs.length && pushs.length == gains.length) {
                            ...
                            const cardsx = game.createFakeCards(cards);
                            player.directgains(cardsx, null, "xinxchengshu");
                            const result = await player
                                .chooseToUse({
                                    filterCard(card) {
            ...
            subSkill: {
                    ...
                    trigger: {
                        player: ["useCardBefore", "respondBefore", 'gainBefore', 'loseBefore'],
                    },
                    forced: true,
                    popup: false,
                    charlotte: true,
                    filter(event, player) {
                        return event.cards && event.cards.some(c => c.hasGaintag("xinxchengshu"));
                    },
                    async content(event, trigger, player) {
                        const cards = player.getExpansions("xinxyuanyan");
                        let hasSwapped = false;
                        for (let i = 0; i < trigger.cards.length; i++) {
                            const fakeCard = trigger.cards[i];
                            if (fakeCard.hasGaintag("xinxchengshu")) {
                                const realCard = cards.find(c => c.cardid === fakeCard._cardid);
                                if (realCard) {
                                    cards.remove(realCard);
                                    trigger.cards[i] = realCard;
        ...
        xinxlongxiang: {
            ...
            async cost(event, trigger, player) {
                ...
                if (list.length === 0) {
                    ...
                    if (list1.length) {
                        const next = player.chooseButton(["是否视为使用一张基本牌？", [list1, "vcard"]]).forResult();
                        next.set("ai", button => {
                            const card = {
                                name: button.link[2],
                                nature: button.link[3],
                ...
                const { bool, links } = await player.chooseButton(dialog)
                    .set("ai", button => {
            ...
            async content(event, trigger, player) {
                ...
                //const basicCards = get.inpileVCardList(info => ["basic", "trick", "delay"].includes(info[0]));
        ...
        xinxcangnuo: {
            ...
            direct: true,
            async content(event, trigger, player) {
                let num = player.getHistory("useSkill", evt => evt.skill == "xinxcangnuo").length + 1;
                game.broadcastAll(num => {
                ...
                // next.set("logSkill", event.name);
                player.logSkill("xinxcangnuo", null, null, null, [get.rand(3, 4)]);
                    ...
                    if (cards && cards.length > 0 && targets && targets.length > 0) {
                        for (const target of targets) {
                            if (target.countCards('he')) {
                                game.playAudio("../extension/永夜之境/audio/", 'xinxcangnuo' + [get.rand(1, 2)] + '.mp3');
        ...
        xinxzisui: {
            ...
            forced: true,
            async content(event, trigger, player) {
                const num = Math.max(1, game.countPlayer(current => current.countCards('ej')));
                const storage = player.getStorage("xinxzisui") || [];
                let btnList = [];
                if (!storage.includes("摸牌")) btnList.push(["摸牌", `令其摸${get.cnNumber(num)}张牌`]);
                if (!storage.includes("回复")) btnList.push(["回复", `令其回复${get.cnNumber(num)}点体力`]);
                if (!storage.includes("决斗")) btnList.push(["决斗", `令其将${get.cnNumber(num)}张牌当决斗对你使用，否则你与其各失去1点体力。`])
                const result = await player.chooseButtonTarget({
                    createDialog: [
                        `###恣睢###<div class="text center">选择一名其他角色并选择一项执行（执行后将移除该选项）：<br>X当前为${num}</div>`,
                        [
                            btnList,
                            "textbutton",
                        ],
                    ...
                    ai2(target) {
                        ...
                        if (ui.selected.buttons && ui.selected.buttons.length > 0) {
                            ...
                            if (link === "回复") {
                                return (att > 0 && target.isDamaged()) ? att + (target.maxHp - target.hp) * 2 : 0;
                            }
                            if (link === "决斗") {
                                if (att >= 0) return 0;
                ...
                if (result.bool && result.links?.length && result.targets?.length) {
                    ...
                    const target = result.targets[0];
                    player.popup(choice);
                    game.log(player, "对", target, "选择了", "#y" + choice);
                    ...
                    switch (choice) {
                        ...
                        case "决斗":
                            ...
                            if (count >= num) {
                                game.broadcastAll(n => {
                                    lib.skill.xinxzisui_backup.selectCard = n;
                                }, num);
                                ...
                                next.set("targetRequired", true);
                                next.set("complexSelect", true);
                                next.set("filterTarget", function (card, p, t) {
                                    if (t != _status.event.sourcex && !ui.selected.targets.includes(_status.event.sourcex)) return false;
                                    return lib.filter.targetEnabled.apply(this, arguments);
                                });
            ...
            intro: {
                ...
                content: storage => ((storage || []).length ? `已移去了${storage}` : "暂未移去任何项"),
            },
            subSkill: {
                backup: {
                    filterCard: (card, player) => get.itemtype(card) == "card",
        ...
        xinxqiyi: {
            ...
            async content(event, trigger, player) {
                const target = event.targets[0];
                player.storage.xinxqiyi_target = target;
                target.storage.xinxqiyi_target = player;
                player.markAuto("xinxqiyi_use", [target]);
                target.markAuto("xinxqiyi_use", [player]);
                player.addAdditionalSkill(`xinxqiyi_use_${target.playerid}`, "xinxqiyi_use");
                target.addAdditionalSkill(`xinxqiyi_use_${player.playerid}`, "xinxqiyi_use");
                player.addTempSkill("xinxqiyi_clear", { player: "phaseBegin" });
            ...
            subSkill: {
                ...
                clear: {
                    charlotte: true,
                    onremove(player, skill) {
                        const target = player.storage.xinxqiyi_target;
                        if (target) {
                            target.removeAdditionalSkill(`xinxqiyi_use_${player.playerid}`);
                            target.unmarkAuto("xinxqiyi_use", [player]);
                            delete target.storage.xinxqiyi_target;
                        }
                        player.removeAdditionalSkill(`xinxqiyi_use_${target ? target.playerid : ""}`);
                        player.unmarkAuto("xinxqiyi_use", [target]);
                        delete player.storage.xinxqiyi_target;
                    }
                },
                use: {
                    mod: {
                        aiOrder(player, card, num) {
                            if (card.hasGaintag && card.hasGaintag('xinxqiyi_tag')) {
                                let boost = 10;
                                return num + boost;
                            }
                        }
                    ...
                    intro: {
                        ...
                        content: `与<font color=#FFD700>$</font>琴剑同鸣`,
                    },
                    init(player, skill) {
                        // 技能刚获得时，克隆对方现在的全部手牌
                        const target = player.storage.xinxqiyi_target;
                        if (!target) return;
                        const toRemove = player.getCards("s", card => card.hasGaintag("xinxqiyi_tag"));
                        game.deleteFakeCards(toRemove);

                        const fakeCards = target.isAlive() && target.countCards("h") ? game.createFakeCards(target.getCards("h")) : [];
                        if (fakeCards.length) {
                            player.directgains(fakeCards, null, "xinxqiyi_tag");
                        }
                    },
                    onremove(player, skill) {
                        // 技能失去时，销毁身上所有的假牌
                    ...
                    filter(event, player) {
                        ...
                        if (["useCard", "respond"].includes(event.name)) {
                            if (event.player !== player) return false;
                            const fakeCards = player.getCards("s", card => card.hasGaintag("xinxqiyi_tag"));
                            // 判断打出的牌里有没有假牌
                            return event.cards && event.cards.some(card => fakeCards.includes(card));
                        }
                        // 检测对方（宿主）的手牌是否发生了增减
                        // 用 getl 和 getg 侦测目标是否物理掉牌，不去管 event.player 是谁
                    ...
                    async content(event, trigger, player) {
                        ...
                        if (!target) return;
                        if (["useCard", "respond"].includes(trigger.name)) {
                            // 如果自己打出了假牌，在结算前一瞬间，把假牌“掉包”成对方手中真实的牌
                            const realCards = target.getCards("h");
                            for (let i = 0; i < trigger.cards.length; i++) {
                                const fakeCard = trigger.cards[i];
                                if (fakeCard.hasGaintag("xinxqiyi_tag")) {
                            ...
                            if (toRemove.length > 0) {
                                const fakesToRemove = player.getCards("s", card =>
                                    card.hasGaintag("xinxqiyi_tag") && toRemove.some(cardx => cardx.cardid == card._cardid)
                                );
                            ...
                            if (toAdd.length > 0) {
                                ...
                                player.directgains(newFakes, null, "xinxqiyi_tag");
                            }
                        }
                    }
                }
        ...
        xinxfanjian: {
            ...
            async content(event, trigger, player) {
                ...
                const result = await player.chooseCard('反间：选择一张牌，并标记一张牌堆中与之相同花色的牌', 'h', true)
                    .set('filterCard', (card, player) => {
                        return !player.getStorage('xinxfanjian').includes(card);
                    })
                    .set("ai", card => {
                    ...
                    /* .set("filterButton", button => {
                        return !player.getStorage('xinxfanjian').includes(button.link);
                    })
                    .set("ai", button => {
                        let card = button.link;
                        if (get.type(card) === 'equip') return 5;
                ...
                if (result?.bool) {
                    ...
                    const selectedCard = result.cards[0];
        ...
        xinxjinjie: {
            ...
            subSkill: {
                mark: {
                    ...
                    filter(event, player) {
                        return !player.getStorage("xinxjinjie_mark").includes(event.card.name) && ['basic', 'trick'].includes(get.type(event.card));
                    },
                    frequent: true,
                    popup: false,
                    charlotte: true,
                ...
                if (result.bool) {
                    ...
                    if (player.storage.xinxyunjue_count > 3) {
                        ...
                        if (list.length) {
                            ...
                            const result = await player.chooseButton(["是否将一张牌当做一张本轮未使用的牌使用？", [list, "vcard"]])
        ...
        xinxjieshuo: {
            ...
            async content(event, trigger, player) {
                ...
                // 确定实体牌来源（区域牌 或 牌堆顶）
                if (target.countCards("xsej") > 0) {
                    cards = target.getCards("xsej").filter(card => !card._cardid);
                } else {
                    cards = get.cards(num1);
                    isFromDeck = true;
                }
                ...
                const vcards = get.inpileVCardList(info => {
                    const name = info[2];
                    const len = get.cardNameLength(name);
                    // 筛选条件：基本牌或锦囊，且名字长度在可选范围内
                ...
                if (!vcards.length) {
                    if (isFromDeck) {
                        // 如果是从牌堆拿了牌但无法转化，按规则应当处理这些牌（此处简单处理为放入弃牌堆，防止卡死）
                ...
                // 循环选择直到合法（One Window Logic）
                let selectedPhys = [];
                let selectedVCardInfo = null;
                let validSelection = false;

                while (!validSelection) {
                    const dialogPrompt = isFromDeck
                        ? `###截槊：选择牌堆顶至多${get.cnNumber(num1)}张牌###<div class="text center">请选择实体牌（1-${maxLen}张），然后选择使用一张字数相同的转化牌，并获得剩余与之名字数不同的牌</div>`
                        : `###截槊：选择其区域内至多${get.cnNumber(num1)}张牌###<div class="text center">请选择实体牌（1-${maxLen}张），然后选择使用一张字数相同的转化牌</div>`;
                    ...
                    const result = await player.chooseButton(
                        [
                            dialogPrompt,
                            cards,
                            '<div class="text center">——— 转化目标 ———</div>',
                            [vcards, 'vcard']
                        ],
                        ...
                        // 分离当前已选中的实体牌和转化牌
                        const selected = ui.selected.buttons;
                        const phys = selected.filter(b => !Array.isArray(b.link));
                        const virt = selected.filter(b => Array.isArray(b.link));
                        // 如果当前按钮是转化牌（link是数组）
                        if (Array.isArray(button.link)) {
                            // 只能选1张转化牌，如果已经选了别的，禁止此按钮
                            if (virt.length && virt[0] !== button) return false;
                            // 如果已经选了实体牌，只能选字数匹配的转化牌
                            if (phys.length) {
                                return get.cardNameLength(button.link[2]) === phys.length;
                            }
                            return true;
                        }
                        // 如果当前按钮是实体牌
                        else {
                            // 如果已经选了转化牌，实体牌数量不能超过转化牌字数
                            if (virt.length) {
                                const reqLen = get.cardNameLength(virt[0].link[2]);
                                if (phys.length >= reqLen && !phys.includes(button)) return false;
                            }
                            return true;
                        }
                    }).set('ai', button => {
                        ...
                        return isFromDeck ? 1 : get.value(link, get.event().player);
                    }).forResult();
                    ...
                    const virt = links.filter(l => Array.isArray(l));  // 转化牌是数组
                    // 必须有且仅有1张转化牌，且实体牌数量等于转化牌名字长度
                    if (virt.length === 1 && phys.length === get.cardNameLength(virt[0][2])) {
                        selectedPhys = phys;
        ...
        xinxhuolu: {
            ...
            subSkill: {
                mark: {
                    ...
                    async content(event, trigger, player) {
                        trigger.player.addTempSkill("xinxhuolu_marked");
                    }
                },
                marked: {
                    trigger: {
                ...
                use: {
                    ...
                    filter(event, player) {
                        return get.is.damageCard(event.card) && player.countCards("xs") > 0 && !game.hasPlayer2(current => {
                        ...
                        const result = await player
                            ...
                            [
                                [
                                    ...
                                    ["discard", `令${get.translation(player)}弃置武将牌上的任意张牌，然后摸等量的牌`],
                                ],
                                "textbutton",
                            ],
                            ])
                    ...
                    async content(event, trigger, player) {
                        ...
                        if (result == "usecard") {
                            ...
                            const result2
                                = await player
                                    .chooseButton(["镬戮：是否弃置其中任意张牌并摸等量张牌？", cards], [1, Infinity])
                                    .set("ai", button => {
                                        return get.event().player.getUseValue(button.link);
                                        // return 2 - get.value(button.link);
                                    }).forResult();
                ...
                use: {
                    ...
                    async content(event, trigger, player) {
                        ...
                        let name = allCards
                            ...
                            .flat()
                            .unique();
                        if (allCards.some(card => get.is.damageCard(card))) {
                            const shaCards = allCards.filter(card => get.is.damageCard(card));
                        ...
                        for (const markedTarget of markedTargets) {
                            ...
                            if (discard) {
                                ...
                                //const list1 = list.filter(function (i) { return player.canUse({ name: i, isCard: true, }, target2) });
                                const { links } = await player.chooseButton([`视为对${get.translation(markedTarget)}使用一张伤害锦囊牌`, [list, "vcard"]], true)
                                    .set("ai", button => {
                                        return get.event().player.getUseValue({
                                            name: button.link[2],
                                            nature: button.link[3],
                                ...
                                let name = links[0][2],
                                    nature = links[0][3];
                                for (const markedTarget of markedTargets) {
                                    await player.chooseUseTarget(true, false, { name, nature, isCard: true }, markedTarget, 'nodistance');
                ...
                lose: {
                    ...
                    filter: function (event, player) {
                        ...
                        return game.hasGlobalHistory("everything", evt => {
                            return ["gainMaxHp", "loseMaxHp"].includes(evt.getParent().name) && event.player == player;
                        });
                    },
                    async content(event, trigger, player) {
        ...
        xinxsanshi: {
            ...
            trigger: {
                player: "loseAfter",
                global: ["loseAsyncAfter", "addJudgeAfter", "gainAfter", "addToExpansionAfter"],
                //"equipAfter", 
            },
            forced: true,
            locked: false,
            ...
            filter(event, player) {
                ...
                return event.getl(player)?.cards?.some(card => !get.owner(card));
                // // return event.getl(player)?.cards?.length > 0;
            },
            async content(event, trigger, player) {
                const card = trigger
                    .getl(player)
                ...
                //  player.logSkill("xinxsanshi", null, null, null,[get.rand(4,5)]);
                await player.addToExpansion(card, "gain2").set("gaintag", ["xinxsanshi"]);
            },
            marktext: "士",
            intro: {
                mark(dialog, storage, player) {
                    const cards = player.getExpansions("xinxsanshi");
                    if (player.isUnderControl(true)) {
                        dialog.addAuto(cards);
                    } else {
            ...
            subSkill: {
                use: {
                    ...
                    filter(event, player) {
                        return game.hasPlayer(function (current) {
                            return current.countCards("xs") > 0;
                        }) && event.cards.length;
                    },
                    popup: false,
                    forced: true,
                    ...
                    async content(event, trigger, player) {
                        ...
                        game.countPlayer(function (current) {
                            cards.addArray(current.getCards("xs", card => !card._cardid));
        ...
        xinxchenlue: {
            audio: "ext:永夜之境/audio:4",
            logAudio: index => (typeof index === "number" ? "ext:永夜之境/audio/xinxchenlue" + index + ".mp3" : 2),
            trigger: {
                global: "roundStart",
            },
            filter(event, player) {
            ...
            async cost(event, trigger, player) {
                event.result = await player.chooseTarget(
                    ...
                    .set("ai", function (target) {
                        ...
                        let att = get.attitude(player, target);
                        if (att > 0) return 0;
                        return target.countCards('h') - att;
                    }).forResult();
            },
            async content(event, trigger, player) {
                const target = event.targets[0];
                player.line(target, "fire");
                player.logSkill("xinxchenlue", null, null, null, [get.rand(1, 2)]);

                const getCardType = function (card) {
                    const type = get.type2(card);
                    if (type == 'delay') return 'trick';
                    return type;
                };
                //获取玩家手牌中存在的类型列表
                const getExistTypes = (p) => {
                    const cards = p.getDiscardableCards(p, 'he');
                    const list = [];
                    for (let i = 0; i < cards.length; i++) {
                        const t = getCardType(cards[i]);
                        list.add(t);
                    }
                    const sortMap = { basic: 0, trick: 1, equip: 2 };
                    list.sort((a, b) => (sortMap[a] || 3) - (sortMap[b] || 3));
                    return list;
                };

                const typeTranslate = { basic: "基本牌", trick: "锦囊牌", equip: "装备牌" };

                const myTypes = getExistTypes(player);
                const targetTypes = getExistTypes(target);

                let myType;
                if (myTypes.length == 1) {
                    myType = myTypes[0];
                } else {
                    const choice1 = await player.chooseControl(myTypes)
                        .set("prompt", "沉略：请选择一种类型的牌进行重铸")
                        .set("ai", () => {
                            return myTypes.sort((typeA, typeB) => {
                                const cardsA = player.getCards('he', { type: typeA });
                                const cardsB = player.getCards('he', { type: typeB });
                                const isUsableA = cardsA.some(card => player.hasUseTarget(card));
                                const isUsableB = cardsB.some(card => player.hasUseTarget(card));
                                // 优先选不可用的
                                // if (isUsableA !== isUsableB) return isUsableA ? 1 : -1;
                                // 次选数量最多的
                                return cardsB.length - cardsA.length;
                            })[0];
                        })
                        /* .set("ai", () => {
                            return myTypes.sort((a, b) => {
                                return player.countCards('he', {type: a}) - player.countCards('he', {type: b});
                            })[0];
                        }) */
                        .forResult();
                    myType = choice1.control;
                }
                ...
                if (targetTypes.length == 1) {
                    ...
                    const choice2 = await target.chooseControl(targetTypes)
                        .set("prompt", "沉略：请选择一种类型的牌进行弃置")
                        /* .set("ai", () => {
                            return targetTypes.sort((typeA, typeB) => {
                                const cardsA = target.getCards('he', { type: typeA });
                                const cardsB = target.getCards('he', { type: typeB });

                                const isUsableA = cardsA.some(card => target.hasUseTarget(card));
                                const isUsableB = cardsB.some(card => target.hasUseTarget(card));
                        ...
                        .set("ai", () => {
                            return targetTypes.sort((a, b) => {
                                return target.countCards('he', { type: a }) - target.countCards('he', { type: b });
                            })[0];
                        })
                        .forResult();
                    targetType = choice2.control;
                }
                game.log(player, "选择了", typeTranslate[myType]);
                game.log(target, "选择了", typeTranslate[targetType]);
                const cards1 = player.getCards("he", card => get.type2(card) == myType);
                const cards2 = target.getCards("he", card => get.type2(card) == targetType);
                const discardTasks = [];
                if (cards1.length) discardTasks.push(player.recast(cards1));
                if (cards2.length) discardTasks.push(target.discard(cards2));
                if (discardTasks.length > 0) {
                    await Promise.all(discardTasks);
                }
                if (myType == targetType) {
                    ...
                    let passive = target;
                    while (true) {
                        if (!active.isAlive() || !passive.isAlive()) break;
                        const canFight = active.hasCard(function (card) {
                            return get.type(card) != 'equip' && active.canUse(card, passive);
                        }, "h");

                        let next = { bool: false };
                        if (canFight) {
                            next = await active.chooseToUse(
                        ...
                        if (next.bool) {
                            ...
                            game.log(active, "未使用牌，受到伤害");
                            const damageEvt = await active.damage(1, passive);
                            if (active === player && damageEvt && damageEvt.num > 0 && !damageEvt.cancelled && active.isAlive()) {
                                await active.logSkill("xinxchenlue", null, null, null, [get.rand(3, 4)]);
                            }
                            break;
                        }
                    }
