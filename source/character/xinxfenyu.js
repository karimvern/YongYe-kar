...
export let info = {
    ...
    translate: {
        ...
        fyrhyinzhi: '引治',
        fyrhyinzhi_info: `每回合各限一次，当一名角色因摸牌/弃牌手牌数超过手牌上限后，你可以令其弃置/摸三张牌。`,
        fyrhquanxin: '全心',
                ...
                tip: {
                    ...
                    async content(event, trigger, player) {
                        ...
                        if (last) {
                            ...
                            //if (get.color(last) == 'black') tags.push("黑");
        ...
        fyrhyinzhi: {
            ...
            async content(event, trigger, player) {
                ...
                if (trigger.name == "draw") {
                    ...
                    player.markAuto("fyrhyinzhi_used", trigger.name);
                } else {
